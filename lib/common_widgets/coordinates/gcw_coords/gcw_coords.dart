...
part 'package:gc_wizard/common_widgets/coordinates/gcw_coords/coord_format_inputs/gcw_coords_mapcode.dart';
  ...
  Widget build(BuildContext context) {
    final List<_GCWCoordWidget> _coordsWidgets = [
      ...
      _GCWCoordWidget(
        ...
        _GCWCoordsMapCode(
          initialize: _resetCoords,
          coordinates: _currentCoords is MapCode
              ? _currentCoords as MapCode
              : buildUninitializedCoordinateByFormat(CoordinateFormat(CoordinateFormatKey.MAPCODE)) as MapCode,
          onChanged: (newValue) {
            setState(() {
              _setCurrentValueAndEmitOnChange(newValue);
            });
