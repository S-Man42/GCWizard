...
final AREA_SQUAREMETER = Area (
  name: 'common_unit_area_m2_name',
  symbol: 'm\u00B2',
  isReference: true
);

final AREA_SQUAREKILOMETER = Area (
    name: 'common_unit_area_km2_name',
    symbol: 'km\u00B2',
...
final AREA_SQUARECENTIMETER = Area (
  ...
  symbol: 'cm\u00B2',
  inSquareMeters: 0.01 * 0.01
);

final AREA_SQUAREMILLIMETER = Area (
  name: 'common_unit_area_mm2_name',
  symbol: 'mm\u00B2',
  inSquareMeters: 0.001 * 0.001
);

final AREA_HECTARE = Area (
  name: 'common_unit_area_ha_name',
  symbol: 'ha',
  inSquareMeters: 10000.0
);

final AREA_DECARE = Area (
  name: 'common_unit_area_daa_name',
  symbol: 'daa',
  inSquareMeters: 1000.0
);

final AREA_ARE = Area (
  name: 'common_unit_area_a_name',
  symbol: 'a',
  inSquareMeters: 100.0
);

final AREA_DECIARE = Area (
  name: 'common_unit_area_da_name',
  symbol: 'da',
  inSquareMeters: 10.0
);

final AREA_CENTIARE = Area (
  name: 'common_unit_area_ca_name',
  symbol: 'ca',
  inSquareMeters: 1.0
);

final AREA_SQUAREFOOT = Area (
  name: 'common_unit_area_sqft_name',
  symbol: 'sq ft',
  inSquareMeters: 0.3048 * 0.3048
);

final AREA_SQUAREINCH = Area (
    name: 'common_unit_area_sqin_name',
    symbol: 'sq in',
    inSquareMeters: 0.3048 * 0.3048 / 144.0
);

final AREA_SQUAREYARD = Area (
  name: 'common_unit_area_sqyd_name',
  symbol: 'sq yd',
