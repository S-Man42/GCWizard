...
final TYPOGRAPHY_DTPPOINT = Typography(
...
final TYPOGRAPHY_DTPPICA = Typography(
...
final TYPOGRAPHY_PICA = Typography(
    name: 'common_unit_typography_p_name',
    symbol: 'p',
    inDTPPt: 12.0
);

final TYPOGRAPHY_INCH = Typography(
    name: 'common_unit_typography_in_name',
    symbol: 'in',
    inDTPPt: 72.0
);

final TYPOGRAPHY_CENTIMETER = Typography(
    name: 'common_unit_typography_cm_name',
    symbol: 'cm',
    inDTPPt: 10.0 / 0.3528
);

final TYPOGRAPHY_MILLIMETER = Typography(
    name: 'common_unit_typography_mm_name',
    symbol: 'mm',
    inDTPPt: 1.0 / 0.3528
);
