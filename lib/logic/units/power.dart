...
final POWER_HORSEPOWER = Power(
  name: 'common_unit_power_hp_name',
  symbol: 'hp',
  inWatt: 745.699871515585
);

final POWER_METRICHORSEPOWER = Power(
  name: 'common_unit_power_ps_name',
  symbol: 'PS',
  inWatt: 735.49875
);

//According to Randall Munroe, What If? ISBN 978-1-84854-958-6
final POWER_YODA = Power(
  name: 'common_unit_power_yoda_name',
  symbol: null,
  inWatt: 19200
);
