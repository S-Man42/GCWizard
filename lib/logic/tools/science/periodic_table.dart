...
final iupacGroupNameToString = {
  IUPACGroupName.ALKALI_METALS : 'periodictable_category_iupacgroupname_alkalimetals',
  IUPACGroupName.ALKALINE_EARTH_METALS : 'periodictable_category_iupacgroupname_alkalineearthmetals',
  IUPACGroupName.EARTH_METALS : 'periodictable_category_iupacgroupname_earthmetals',
  IUPACGroupName.TETRELS : 'periodictable_category_iupacgroupname_tetrels',
  IUPACGroupName.PNICTOGENS : 'periodictable_category_iupacgroupname_pnictogens',
  IUPACGroupName.CHALCOGENS : 'periodictable_category_iupacgroupname_chalcogens',
  IUPACGroupName.HALOGENS : 'periodictable_category_iupacgroupname_halogens',
  IUPACGroupName.NOBLE_GASES : 'periodictable_category_iupacgroupname_noblegases',
  IUPACGroupName.LANTHANIDES : 'periodictable_category_iupacgroupname_lanthanides',
  IUPACGroupName.ACTINIDES : 'periodictable_category_iupacgroupname_actinides',
};

final stateOfMatterToString = {
  StateOfMatter.SOLID: 'periodictable_category_stateofmatter_solid',
  StateOfMatter.LIQUID: 'periodictable_category_stateofmatter_liquid',
  StateOfMatter.GAS: 'periodictable_category_stateofmatter_gas'
};
...
class PeriodicTableElement {
  ...
  get formattedHalfLife {
    ...
    if (this.halfLife >= 365 * 1000000)
      return format.format(halfLife / (365 * 1000000)) + ' Mio. a';
    if (this.halfLife >= 365)
      return format.format(halfLife / 365) + ' a';
    if (this.halfLife >= 1)
      return format.format(halfLife) + ' d';
    if (this.halfLife >= 1 / 24)
      return format.format(halfLife / (1 / 24)) + ' h';
    if (this.halfLife >= 1 / 24 / 60)
      return format.format(halfLife / (1 / 24 / 60)) + ' min';
    if (this.halfLife >= 1 / 24 / 60 / 60)
      return format.format(halfLife / (1 / 24 / 60 / 60)) + ' s';

    return format.format(halfLife / (1 / 24 / 60 / 60 / 1000)) + ' ms';
  }
...
final List<PeriodicTableElement> allPeriodicTableElements = [
  ...
  PeriodicTableElement('periodictable_element_helium', 'He', 2, 4.0026, -1, -272.2, -268.93, false, false, 1, 18, 0.0001785, 4, double.infinity, comments: ['periodictable_comment_edelgase']),
  ...
  PeriodicTableElement('periodictable_element_neon', 'Ne', 10, 20.18, -1, -248.59, -246.08, false, false, 2, 18, 0.0008999, 20, double.infinity, comments: ['periodictable_comment_edelgase']),
  ...
  PeriodicTableElement('periodictable_element_argon', 'Ar', 18, 39.948, -1, -189.3, -185.8, false, false, 3, 18, 0.0017837, 40, double.infinity, comments: ['periodictable_comment_edelgase']),
  ...
  PeriodicTableElement('periodictable_element_krypton', 'Kr', 36, 83.798, 3.0, -157.36, -153.22, false, false, 4, 18, 0.00374, 84, double.infinity, comments: ['periodictable_comment_egreak', 'periodictable_comment_kr']),
  ...
  PeriodicTableElement('periodictable_element_technetium', 'Tc', 43, 97.91, 1.9, 2157, 4265, true, true, 5, 7, 11.5, 98, 1.533e9, comments: ['periodictable_comment_tc', 'periodictable_comment_atommasse']),
  ...
  PeriodicTableElement('periodictable_element_xenon', 'Xe', 54, 131.29, 2.6, -111.7, -108.0, false, false, 5, 18, 0.005898, 132, double.infinity, comments: ['periodictable_comment_egreak' + 'periodictable_comment_xe']),
  ...
  PeriodicTableElement('periodictable_element_promethium', 'Pm', 61, 144.9, 1.13, 1100, 3000, true, true, 6, 3, 7.2, 145, 365*17.7, comments: ['periodictable_comment_atommasse', 'periodictable_comment_mci']),
  ...
  PeriodicTableElement('periodictable_element_polonium', 'Po', 84, 209, 2.0, 254, 962, true, false, 6, 16, 9.196, 209, (365 * 103).toDouble(), comments: ['periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_astatine', 'At', 85, 210, 2.2, 302, 337, true, false, 6, 17, 8.75, 210, (8.1/24), comments: ['periodictable_comment_at', 'periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_radon', 'Rn', 86, 222, -1, -71, -61.8, true, false, 6, 18, 0.00973, 222, 3.82, comments: ['periodictable_comment_edelgase', 'periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_francium', 'Fr', 87, 223, 0.7, 27, 677, true, false, 7, 1, 1.87, 223, (22.0/60/24), comments: ['periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_radium', 'Ra', 88, 226, 0.9, 700, 1737, true, false, 7, 2, 5.5, 226, 584.73, comments: ['periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_actinium', 'Ac', 89, 227, 1.1, 1050, 3300, true, false, 7, 3, 10.07, 227, 7946.05, comments: ['periodictable_comment_ac', 'periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_thorium', 'Th', 90, 232.04, 1.3, 1755, 4788, true, false, 7, 3, 11.724, 232, 5.12825e12),
  PeriodicTableElement('periodictable_element_protactinium', 'Pa', 91, 231.04, 1.5, 1568, 4027, true, false, 7, 3, 15.37, 231, 365*32.760, comments: ['periodictable_comment_pa', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_uranium', 'U', 92, 238.03, 1.38, 1133, 3930, true, false, 7, 3, 19.16, 238, 365*4.468e9),
  PeriodicTableElement('periodictable_element_neptunium', 'Np', 93, 237.05, 1.36, 639, 3902, true, false, 7, 3, 20.45, 237, 782.56e6, comments: ['periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_plutonium', 'Pu', 94, 244.05, 1.28, 639.4, 3230, true, false, 7, 3, 19.816, 244, 365*8e7, comments: ['periodictable_comment_atommasse']),
  PeriodicTableElement('periodictable_element_americum', 'Am', 95, 243.05, 1.3, 1176, 2607, true, true, 7, 3, 13.67, 243, 2690.05, comments: ['periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_curium', 'Cm', 96, 247.05, 1.3, 1340, 3110, true, true, 7, 3, 13.51, 247, 569.4e7, comments: ['periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_berkelium', 'Bk', 97, 247.05, 1.30, 986, -300, true, true, 7, 3, 14.78, 247, 503.7, comments: ['periodictable_comment_bk', 'periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_californium', 'Cf', 98, 251.05, 1.3, 900, 1470, true, true, 7, 3, 15.1, 251, (365 * 898).toDouble(), comments: ['periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_einsteinium', 'Es', 99, 253, 1.3, 860, 996, true, true, 7, 3, 8.84, 252, 470.85, comments: ['periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_fermium', 'Fm', 100, 257, 1.3, 1527, -300, true, true, 7, 3, 0, 257, 100.5, comments: ['periodictable_comment_dsdmp', 'periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_mendelevium', 'Md', 101, 258, 1.3, 827, -300, true, true, 7, 3, 0, 258, 51.5, comments: ['periodictable_comment_dsdmp', 'periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_nobelium', 'No', 102, 259, 1.3, 1521, -300, true, true, 7, 3, 0, 259, (58.0/60/24), comments: ['periodictable_comment_dsdmp' , 'periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_lawrencium', 'Lr', 103, 262, 1.3, 1627, -300, true, true, 7, 3, 9.84, 264, (10.0/24), comments: ['periodictable_comment_dsdmp' , 'periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_rutherfordium', 'Rf', 104, 261.1, 0, -300, -300, true, true, 7, 4, 18.1, 265, (1.3/24), comments: ['periodictable_comment_dsdmp', 'periodictable_comment_atommasse']),
  PeriodicTableElement('periodictable_element_dubnium', 'Db', 105, 262.1, 0, -300, -300, true, true, 7, 5, 39, 268, 1.3, comments: ['periodictable_comment_dsdmp', 'periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_seaborgium', 'Sg', 106, 266.1, 0, -300, -300, true, true, 7, 6, 35, 272, 1.0/24, comments: ['periodictable_comment_dsdmp', 'periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_bohrium', 'Bh', 107, 264.1, 0, -300, -300, true, true, 7, 7, 37, 273, 1.5/24, comments: ['periodictable_comment_dsdmp', 'periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_hassium', 'Hs', 108, 269.1, 0, -300, -300, true, true, 7, 8, 41, 276, 1.0/24, comments: ['periodictable_comment_dsdmp', 'periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_meitnerium', 'Mt', 109, 268.1, 0, -300, -300, true, true, 7, 9, 35, 279, 6.0/60/24, comments: ['periodictable_comment_dsdmp', 'periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_darmstadtium', 'Ds', 110, 272.1, 0, -300, -300, true, true, 7, 10, 21.46, 278, 10.0/60/60/24, comments: ['periodictable_comment_dsdmp', 'periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_roentgenium', 'Rg', 111, 272.1, 0, -300, -300, true, true, 7, 11, 19.282, 283, 10.0/60/24, comments: ['periodictable_comment_rg', 'periodictable_comment_dsdmp', 'periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_copernicium', 'Cn', 112, 277, 0, -300, -300, true, true, 7, 12, 13.53, 285, 34.0/60/60/24, comments: ['periodictable_comment_cn_1', 'periodictable_comment_cn_2', 'periodictable_comment_dsdmp', 'periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_ununtrium', 'Uut', 113, 286, 0, -300, -300, true, true, 7, 13, 11.85, 287, 20.0/60/24, comments: ['periodictable_comment_dsdmp', 'periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_ununquadium', 'Fl', 114, 289, 0, -300, -300, true, true, 7, 14, 11.3, 289, 2.7/60/60/24, comments: ['periodictable_comment_fl', 'periodictable_comment_dsdmp', 'periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_ununpentium', 'Uup', 115, 288, 0, -300, -300, true, true, 7, 15, 9.8, 291, 1.0/60/24, comments: ['periodictable_comment_dsdmp', 'periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_ununhexium', 'Lv', 116, 292, 0, -300, -300, true, true, 7, 16, 9.32, 293, 5.3e-2/60/60/24, comments: ['periodictable_comment_lv', 'periodictable_comment_dsdmp', 'periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_ununseptium', 'Uus', 117, 292, 0, -300, -300, true, true, 7, 17, 0, 294, 7.8e-2/60/60/24, comments: ['periodictable_comment_dsdmp', 'periodictable_comment_atommasse', 'periodictable_comment_mci']),
  PeriodicTableElement('periodictable_element_ununoctium', 'Uuo', 118, 294, 0, -23.15, -300, true, true, 7, 7, 0, 294, 8.9e-4/60/60/24, comments: ['periodictable_comment_edelgase', 'periodictable_comment_dsdmp', 'periodictable_comment_atommasse', 'periodictable_comment_mci']),
];