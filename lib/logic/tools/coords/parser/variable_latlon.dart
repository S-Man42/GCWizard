    ...
    if (withProjection) {
      ...
      parsedCoord.entries.forEach((entry) {
        ...
        if (projectionData['reverseBearing'] != null && projectionData['reverseBearing']) {
          ...
          var revProjected = reverseProjection(entry.value, parsedBearing, projectionData['lengthUnit'].toReference(parsedDistance), projectionData['ellipsoid']);
          ...
          var projected = {
            'coordinate' : projection(entry.value, parsedBearing, projectionData['lengthUnit'].toReference(parsedDistance), projectionData['ellipsoid']),
