...
final List<PeriodicTableElement> allPeriodicTableElements = [
  ...
  PeriodicTableElement('periodictable_element_oganesson', 'Og', 118, 294, -double.infinity, 50, 80, true, true, 7, 18, 5, 294, 8.9e-4/60/60/24, comments: ['periodictable_comment_og', 'periodictable_comment_noblegases', 'periodictable_comment_densityvaries', 'periodictable_comment_massnotexact', 'periodictable_comment_mostcommonisotop']),
];