...
const Map<String, Map<String, dynamic>> PHYSICAL_CONSTANTS = {
  ...
  'physical_constants_josephson': {'symbol': 'K_j', 'value': '483 597.8484', 'exponent': 9, 'unit': 'Hz/V'},
  ...
  'physical_constants_std_acceleration_gravity': {'symbol': 'g_n', 'value': '9.806 65', 'unit': 'm/s\u00B2'},
  ...
  'physical_constants_von_klitzing': {'symbol': 'R_k', 'value': '25 812.807 45', 'unit': 'Ω'}
};
