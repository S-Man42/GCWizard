...
class JulianDate {
  ...
  JulianDate(DateTime datetime, Duration timezone) {
    ...
    julianDate = julianDateUTCNoon + (datetime.hour - timezone.inMinutes / 60.0 + datetime.minute / 60.0 + datetime.second  / 3600.0) / 24.0;
  ...
  double _deltaT (int year, int month) {
    ...
    if ((year >= -500) && (year < 500)) {
      u = y/100;
      return 10583.6 - 1014.41 * u + 33.78311 * u * u - 5.952053 * pow(u, 3) -  0.1798452 * pow(u, 4) + 0.022174192 * pow(u, 5) + 0.0090316521 * pow(u, 6);
    }
    ...
    if ((year >= 1800) && (year < 1860)) {
      u = (y - 1800);
      return 13.72 - 0.332447 * u + 0.0068612 * u*u + 0.0041116 * pow(u, 3) - 0.00037436 * pow(u, 4)
          + 0.0000121272 * pow(u, 5) - 0.0000001699 * pow(u, 6) + 0.000000000875 * pow(u, 7);
    }

    if ((year >= 1860) && (year < 1900)) {
      u = (y - 1860);
      return 7.62 + 0.5737 * u - 0.251754 * u*u + 0.01680668 * pow(u, 3)
          -0.0004473624 * pow(u, 4) + pow(u, 5) / 233174;
    }
    ...
    if ((year >= 1986) && (year < 2005)) {
      u = (y - 2000);
      return 63.86 + 0.3345 * u - 0.060374 * u*u + 0.0017275 * pow(u, 3) + 0.000651814 * pow(u, 4)
