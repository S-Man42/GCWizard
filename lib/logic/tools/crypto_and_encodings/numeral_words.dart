...
Map<NumeralWordsLanguage, String> NUMERALWORDS_LANGUAGES = {
  ...
  NumeralWordsLanguage.BULKYR: 'numeralwords_language_bulkyr',
  NumeralWordsLanguage.JAP: 'numeralwords_language_jap',
  NumeralWordsLanguage.JAPHIRAGANA: 'numeralwords_language_japhiragana',
  NumeralWordsLanguage.CHI: 'numeralwords_language_chi',
  NumeralWordsLanguage.CHISYMBOL: 'numeralwords_language_chisymbol',
  NumeralWordsLanguage.CHIZHUYIN: 'numeralwords_language_chizhuyin',
  NumeralWordsLanguage.CHIFINANCE: 'numeralwords_language_chifinance',
  ...
  NumeralWordsLanguage.VIECHUNOM: 'numeralwords_language_viechunom',
  ...
  if (NAVIWordToNum[element] != null)
    ...
    if (element.contains('kivol') ||
      ...
      if (element.contains('kivo') ||
          element.contains('puvo') ||
          element.contains('mrrvo') ||
          element.contains('tsivo') ||
          element.contains('pxevo') ||
          element.contains('mevo') ||
          element.contains('vo')) {
        if (element.contains('kivo')) {
          octal = octal + '7';
...
OutputConvertToNumeralWord encodeNumberToNumeralWord(NumeralWordsLanguage _currentLanguage, int currentNumber) {
  ...
  if (_currentLanguage == NumeralWordsLanguage.NAVI) {
    if (0 <= currentNumber && currentNumber <= 7) {
      ...
      while (octal.length < 5) octal = '0' + octal;
      switch (octal[0]) {
        //  4096
        case '0':
          numeralWord = '';
    ...
    return OutputConvertToNumeralWord(numeralWord.replaceAll('mm', 'm'), convertBase(currentNumber.toString(), 10, 8),
