...
String decodeNavajo(String cipherText) {
  ...
  NAVAJO_DECODE_ALPHABET['SHUSH'] = 'B';
  ...
  NAVAJO_DECODE_ALPHABET['DIBEH'] = 'S';
  NAVAJO_DECODE_ALPHABET['A-WOH'] = 'T';
  NAVAJO_DECODE_ALPHABET['THAN-ZIE'] = 'T';
