...
class PhoneModel {
  ...
  PhoneModel(this.name, String defaultCaseStateModelPath, Map<PhoneInputLanguage, String> specificCaseStateModelPaths, this.characterMap, this.languages) {
    this.defaultCaseStateModel = _initializeCaseStateModel(defaultCaseStateModelPath);
    if (specificCaseStateModelPaths != null && specificCaseStateModelPaths.length > 0) {
      this.specificCaseStateModels = specificCaseStateModelPaths.map((key, value) {
...
Map<String, Map<String, String>> _initializeCaseStateModel(String assetPath) {
  File file = File(Directory.current.path + '/' +  assetPath);

  Map<String, Map<String, String>> stateModel = {};

  file.readAsLinesSync().forEach((line) {
    line = line.trim();
    if (line.isEmpty || line.startsWith(RegExp(r"['@]")))
      return;
    ...
    if (!_isStartState(line))
      transitionCharacters = match.group(3);
...
const PHONEMODEL_MOTOROLA_CD930 = 'Motorola CD930';
const PHONEMODEL_MOTOROLA_RAZRV3 = 'Motorola RAZR V3';
const PHONEMODEL_MOTOROLA_V600 = 'Motorola V600';
const PHONEMODEL_NOKIA_1650 = 'Nokia 1650';
const PHONEMODEL_NOKIA_3210 = 'Nokia 3210';
const PHONEMODEL_NOKIA_3330 = 'Nokia 3330';
const PHONEMODEL_NOKIA_6230 = 'Nokia 6230';
const PHONEMODEL_SAGEM_MYX3 = 'Sagem My X-3';
const PHONEMODEL_SAMSUNG_E1120 = 'Samsung E1120';
const PHONEMODEL_SAMSUNG_GTE1170 = 'Samsung GT-E1170';
const PHONEMODEL_SIEMENS_A65 = 'Siemens A65';
const PHONEMODEL_SIEMENS_C75 = 'Siemens C75';
const PHONEMODEL_SIEMENS_ME45 = 'Siemens ME45';
const PHONEMODEL_SIEMENS_S35 = 'Siemens S35';
const PHONEMODEL_SIEMENS_S55 = 'Siemens S55';
const PHONEMODEL_SONYERICSSON_K700I = 'Sony Ericsson K700i';
const PHONEMODEL_SONYERICSSON_T300 = 'Sony Ericsson T300';

PhoneModel phoneModelByName(String name) {
  return phoneModels.firstWhere((element) => element.name == name, orElse: () => null);
}

final List<PhoneModel> phoneModels = [
  PhoneModel(
      PHONEMODEL_MOTOROLA_CD930, 'assets/vanity_multitap_workflows/motorola_cd930.puml', null,
      [
  ...
  PhoneModel(
      PHONEMODEL_MOTOROLA_RAZRV3, 'assets/vanity_multitap_workflows/motorola_razr_v3.puml', null,
      [
        {
  ...
  PhoneModel(PHONEMODEL_NOKIA_1650, 'assets/vanity_multitap_workflows/nokia_1650.puml', null,
      [
        {
          PhoneCaseMode.LOWER_CASE : {
            "0": " 0\n",
  ...
  PhoneModel(PHONEMODEL_NOKIA_3210, 'assets/vanity_multitap_workflows/nokia_3210.puml', null,
      [
        {
          PhoneCaseMode.LOWER_CASE : {
            "0": " 0",
  ...
  PhoneModel(PHONEMODEL_NOKIA_3330, 'assets/vanity_multitap_workflows/nokia_3330.puml', null,
    [
      {
        PhoneCaseMode.LOWER_CASE : {
          "0": " 0",
  ...
  PhoneModel(PHONEMODEL_NOKIA_6230, 'assets/vanity_multitap_workflows/nokia_6230.puml', null,
      [
        {
          PhoneCaseMode.LOWER_CASE : {
            "0": " 0\n",
  ...
  PhoneModel(PHONEMODEL_SAGEM_MYX3, 'assets/vanity_multitap_workflows/sagem_my_x-3.puml', null,
      [
  ...
  PhoneModel(PHONEMODEL_SAMSUNG_E1120, 'assets/vanity_multitap_workflows/samsung_e1120.puml', null,
      [
        {
          PhoneCaseMode.LOWER_CASE : {
            "0": "+=<>€£\$%&¥¤0",
  ...
  PhoneModel(PHONEMODEL_SAMSUNG_GTE1170, 'assets/vanity_multitap_workflows/samsung_gt-e1170.puml', null,
      [
        {
          PhoneCaseMode.LOWER_CASE : {
            "0": " 0\n",
  ...
  PhoneModel(PHONEMODEL_SIEMENS_A65, 'assets/vanity_multitap_workflows/siemens_a65.puml',
      {
  ...
  PhoneModel(PHONEMODEL_SIEMENS_C75, 'assets/vanity_multitap_workflows/siemens_c75.puml',
      {
  ...
  PhoneModel(PHONEMODEL_SIEMENS_ME45, 'assets/vanity_multitap_workflows/siemens_me45.puml',
      {
  ...
  PhoneModel(PHONEMODEL_SIEMENS_S35, 'assets/vanity_multitap_workflows/siemens_s35.puml', null,
      [
  ...
  PhoneModel(PHONEMODEL_SIEMENS_S55, 'assets/vanity_multitap_workflows/siemens_s55.puml',
      {
  ...
  PhoneModel(PHONEMODEL_SONYERICSSON_K700I, 'assets/vanity_multitap_workflows/sony_ericsson_k700i.puml', null,
      [
  ...
  PhoneModel(PHONEMODEL_SONYERICSSON_T300, 'assets/vanity_multitap_workflows/sony_ericsson_t300.puml', null,
      [
        //The weird cases are correct, e.g. the Ç in the lower case 2 or the è in upper case 3
        {
          PhoneCaseMode.LOWER_CASE : {
