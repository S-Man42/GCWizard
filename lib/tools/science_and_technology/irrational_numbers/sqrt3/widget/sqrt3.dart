...
class SQRT3NthDecimal extends IrrationalNumbersNthDecimal {
  SQRT3NthDecimal({Key? key}) : super(key: key, irrationalNumber: SQRT_3);
}

class SQRT3DecimalRange extends IrrationalNumbersDecimalRange {
  SQRT3DecimalRange({Key? key}) : super(key: key, irrationalNumber: SQRT_3);
}

class SQRT3Search extends IrrationalNumbersSearch {
  SQRT3Search({Key? key}) : super(key: key, irrationalNumber: SQRT_3);
}
