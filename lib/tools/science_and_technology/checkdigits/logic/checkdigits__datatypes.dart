...
final Map<CheckDigitsMode, String> INPUTFORMATTERS_HINT = {
  CheckDigitsMode.ISBN : "?????????????",
  CheckDigitsMode.IBAN : "?????????????????????????????????",
  CheckDigitsMode.EURO : "????????????",
  CheckDigitsMode.UIC : "?? ?? ??? ? ???-?",
  CheckDigitsMode.EAN_GTIN : "??????????????",
  CheckDigitsMode.IMEI : "??????????????",
  CheckDigitsMode.CREDITCARD : "???? ???? ???? ???? ???",
  CheckDigitsMode.DETAXID : "???????????",
};
