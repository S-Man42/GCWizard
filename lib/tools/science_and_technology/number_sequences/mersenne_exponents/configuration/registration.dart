...
class NumberSequenceMersenneExponentsCheckNumberRegistration implements AbstractToolRegistration
{
  @override
  List<ToolCategory>  = [
  ...
  @override
  Widget tool = NumberSequenceMersenneExponentsCheckNumber();
}