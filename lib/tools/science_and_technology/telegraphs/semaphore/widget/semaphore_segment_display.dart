...
class _SemaphoreSegmentDisplay extends NSegmentDisplay {
  ...
  _SemaphoreSegmentDisplay({Key? key, required this.segments, this.readOnly = false, this.onChanged, this.tapeStyle = false})
      : super(
            key: key,
            ...
            customPaint: (GCWTouchCanvas canvas, Size size, Map<String, bool> currentSegments, Function setSegmentState,
              ...
              pathL1.lineTo(size.width / _SEMAPHORE_RELATIVE_DISPLAY_WIDTH * 90,
                  size.width / _SEMAPHORE_RELATIVE_DISPLAY_HEIGHT * 60);
              pathL1.close();
              if (size.height < 180) if (currentSegments['l1']!)
