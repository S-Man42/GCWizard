...
final _FORCE_POUNDAL = Force(name: 'common_unit_force_pdl_name', symbol: 'pdl', inNewton: 0.138254954376);

final _FORCE_POND = Force(name: 'common_unit_force_p_name', symbol: 'p', inNewton: 0.00980665);

final _FORCE_DYNE = Force(name: 'common_unit_force_dyn_name', symbol: 'dyn', inNewton: 1e-5);

// https://webmadness.net/blog/?post=knuth
final _FORCE_BLINTZAL = Force(name: 'common_unit_force_blintzal_name', symbol: 'b-al', inNewton: 1.104380691060943e-5);
