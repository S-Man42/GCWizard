    ...
    if (language == 'ENG') {
      ...
      if (matchers[0].hasMatch(line)) {
        ...
        switch (matchers[3].firstMatch(line).group(1)) {
          case 'add':
            type = CHEF_Method.Add;
            break;
          case 'remove':
            type = CHEF_Method.Remove;
            break;
          case 'combine':
            type = CHEF_Method.Combine;
            break;
          case 'divide':
            type = CHEF_Method.Divide;
            break;
        }
        ...
        // set aside
        type = CHEF_Method.SetAside;
      } else if (matchers[12].hasMatch(line)) {
        // refridgerate
        type = CHEF_Method.Refrigerate;
      ...
      if (matchers[0].hasMatch(line)) {
        ...
        type = CHEF_Method.FestesHinzugeben;
        mixingbowl =
            (matchers[3].firstMatch(line).group(8) == null ? 1 : int.parse(matchers[3].firstMatch(line).group(8))) - 1;
      } else if (matchers[4].hasMatch(line)) {
        ...
        switch (matchers[4].firstMatch(line).group(12)) {
          case 'hinzufügen':
          case 'dazugeben':
            type = CHEF_Method.Dazugeben;
            break;
          case 'entfernen':
          case 'abschoepfen':
            type = CHEF_Method.Abschoepfen;
            break;
          case 'kombinieren':
            type = CHEF_Method.Kombinieren;
            break;
          case 'teilen':
            type = CHEF_Method.Teilen;
            break;
        }
