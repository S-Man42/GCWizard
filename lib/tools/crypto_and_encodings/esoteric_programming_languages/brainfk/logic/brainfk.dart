...
const ERROR_BRAINFK_LOOPNOTCLOSED = 'common_programming_error_loopnotclosed';
const ERROR_BRAINFK_LOOPNOTOPENED = 'common_programming_error_loopnotopened';
      ...
      case '[':
        if (data[pointer] == 0) {
          ...
          while (nestedLoopCount > 0) {
            i++;
            if (i >= instructions.length) throw const FormatException(ERROR_BRAINFK_LOOPNOTCLOSED);
        ...
        break;
      case ']':
        if (loopStack.isEmpty) throw const FormatException(ERROR_BRAINFK_LOOPNOTOPENED);
