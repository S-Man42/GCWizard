...
import 'package:gc_wizard/tools/coords/karney/net.sf/logic/geo_math.dart';
import 'package:gc_wizard/tools/coords/karney/net.sf/logic/geodesic_data.dart';
import 'package:gc_wizard/tools/coords/karney/net.sf/logic/geodesic_line.dart';
import 'package:gc_wizard/tools/coords/karney/net.sf/logic/geodesic_mask.dart';
import 'package:gc_wizard/tools/coords/karney/net.sf/logic/math.dart';
import 'package:gc_wizard/tools/coords/karney/net.sf/logic/pair.dart';
...
class Geodesic {
  ...
  _InverseData _inverseInt(double lat1, double lon1, double lat2, double lon2, int outmask) {
    ...
    if (!meridian &&
      ...
      m12x = b * sin(sig12);
      if ((outmask & GeodesicMask.GEODESICSCALE) != 0) r.M12 = r.M21 = cos(sig12);
      a12 = lon12 / f1;
    } else if (!meridian) {
    ...
    if ((outmask & GeodesicMask.DISTANCE) != 0) r.s12 = 0 + s12x; // Convert -0 to 0

    if ((outmask & GeodesicMask.REDUCEDLENGTH) != 0) r.m12 = 0 + m12x; // Convert -0 to 0
  ...
  _InverseStartV _InverseStart(
    ...
    if (shortline && ssig12 < _etol2) {
      ...
      if (f >= 0) {
        ...
        // Inverse.
        _Lengths(v, _n, pi + bet12a, sbet1, -cbet1, dn1, sbet2, cbet2, dn2, cbet1, cbet2, GeodesicMask.REDUCEDLENGTH,
            C1a, C2a);
        m12b = v._m12b;
        m0 = v._m0;
