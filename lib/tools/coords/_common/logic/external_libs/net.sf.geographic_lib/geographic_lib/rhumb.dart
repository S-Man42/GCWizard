 ...
 * @hideinitializer
 **********************************************************************/
const int _MASK_NONE = 0;
/**
 * Calculate latitude \e lat2.
 * @hideinitializer
 **********************************************************************/
const int _MASK_LATITUDE = 1<<7;
/**
 * Calculate longitude \e lon2.
 * @hideinitializer
 **********************************************************************/
const int _MASK_LONGITUDE = 1<<8;
/**
 * Calculate azimuth \e azi12.
 * @hideinitializer
 **********************************************************************/
const int _MASK_AZIMUTH = 1<<9;
/**
 * Calculate distance \e s12.
 * @hideinitializer
 **********************************************************************/
const int _MASK_DISTANCE = 1<<10;
/**
 * Calculate area \e S12.
 * @hideinitializer
 **********************************************************************/
const int _MASK_AREA = 1<<14;
/**
 * Unroll \e lon2 in the direct calculation.
 * @hideinitializer
 **********************************************************************/
const int _MASK_LONG_UNROLL = 1<<15;
/**
 * Calculate everything.  (LONG_UNROLL is not included in this mask.)
 * @hideinitializer
 **********************************************************************/
const int _MASK_ALL = 0x7F80;
...
// private:
// typedef Math::double real;
// friend class Rhumb;
// const Rhumb& _rh;
// double _lat1, _lon1, _azi12, _salp, _calp, _mu1, _psi1, _r1;
// // copy assignment not allowed
// RhumbLine& operator=(const RhumbLine&) = delete;
// RhumbLine(const Rhumb& rh, double lat1, double lon1, double azi12);
// public:
// /**
...
//  * \e S12).
//  **********************************************************************/
// void Position(double s12, real& lat2, real& lon2, real& S12) const {
...
//  **********************************************************************/
// void Position(double s12, real& lat2, real& lon2) const {
// double t;
...
//  * \e S12).
//  **********************************************************************/
// void GenPosition(double s12, unsigned outmask,
// real& lat2, real& lon2, real& S12) const;
//
// /** \name Inspector functions
//  **********************************************************************/
