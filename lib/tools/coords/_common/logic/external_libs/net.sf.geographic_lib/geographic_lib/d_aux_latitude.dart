...
class _DAuxLatitude extends _AuxLatitude {
  ...
  double DIsometric(_AuxAngle phi1, _AuxAngle phi2) {
    ...
    return tphi1.isNaN || tphi2.isNaN ? double.nan :
    (tphi1.isInfinite || tphi2.isInfinite ? double.infinity :
  ...
  double Datanhee(double x, double y) {
    ...
    Dasinh(_e1 * _AuxLatitude.sn(_fm1 * x),
    _e1 * _AuxLatitude.sn(_fm1 * y)) *
    Dsn(_fm1 * x, _fm1 * y);
  }
  ...
  double DE(_AuxAngle X, _AuxAngle Y) {
    ...
    Xn._y = Xn.y().abs();
    Yn._y = Yn.y().abs();
    double x = Xn.radians0(), y = Yn.radians0(), d = y - x,
  ...
  static double Dlam(double x, double y) {
    return x == y ? _AuxLatitude.sc(x) :
    (x.isNaN || y.isNaN ? double.nan :
    (x.isInfinite || y.isInfinite ? double.infinity :
