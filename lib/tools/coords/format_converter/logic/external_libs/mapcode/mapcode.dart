// ported from https://github.com/mapcode-foundation/mapcode-js/tree/master
...
function getTerritoryNumber(String territoryAlphaCode,  contextTerritory) {
    if (contextTerritory) {
