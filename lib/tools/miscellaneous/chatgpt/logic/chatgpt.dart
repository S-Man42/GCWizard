...
class ChatGPTgetChatJobData {
  ...
  ChatGPTgetChatJobData({required this.chatgpt_api_key, required this.chatgpt_model, required this.chatgpt_prompt, required this.chatgpt_temperature, required this.chatgpt_image_url});
}
