...
import 'package:gc_wizard/tools/science_and_technology/spelling_alphabets/spelling_alphabets_list/widget/spelling_alphabets_crypt.dart';
...
void initializeRegistry(BuildContext context) {
  registeredTools = [
    ...
    GCWTool(tool: const SpellingAlphabetsList(), id: 'spelling_alphabets_list', categories: const [
      ToolCategory.SCIENCE_AND_TECHNOLOGY
    ], searchKeys: const [
      'spelling_alphabets',
    ]),
