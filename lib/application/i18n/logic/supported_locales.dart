...
final Map<Locale, Map<String, Object>> SUPPORTED_LOCALES = {
  ...
  const Locale('fr'): {'name_native': '🇫🇷 Français', 'percent_translated': 78},
  const Locale('it'): {'name_native': '🇮🇹 Italiano', 'percent_translated': 8},
  const Locale('ko'): {'name_native': '🇰🇷 한국어', 'percent_translated': 98},
  ...
  const Locale('sv'): {'name_native': '🇸🇪 Svenska', 'percent_translated': 95},
