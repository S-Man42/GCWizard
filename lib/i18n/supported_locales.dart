...
final Map<Locale, Map<String, dynamic>> SUPPORTED_LOCALES = {
  ...
  Locale('fi'): {'name_native': '🇫🇮 Suomi', 'percent_translated': 57},
  ...
  Locale('pl'): {'name_native': '🇵🇱 Polski', 'percent_translated': 49},
  ...
  Locale('sv'): {'name_native': '🇸🇪 Svenska', 'percent_translated': 87},
