...
showFormulaReplaceDialog(BuildContext context, Formula formula, {Widget contentWidget, int dialogHeight, Function onOkPressed}) {
...
class GCWFormulaReplaceState extends State<GCWFormulaReplace> {
  ...
  String _buildNewFormula(String formula) {
    ...
    if (_curentValueMultiply)
      output = output.replaceAll('x', '*');
    if (_curentValueDivide)
