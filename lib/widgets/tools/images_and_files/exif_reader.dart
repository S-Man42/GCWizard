...
class _ExifReaderState extends State<ExifReader> {
  ...
  Future<void> _readFile(local.GWCFile _file) async {
    Image.Image _image;
  ...
  ///
  void _decorateFileTypeSpecific(List<Widget> widgets, local.GWCFile platformFile) {
  ...
  /// Section file
  ///
  void _decorateFile(List<Widget> widgets, local.GWCFile platformFile) {
  ...
  Future<Image.Image> _completeImageMetadata(local.GWCFile platformFile) async {
...
openInMetadataViewer(BuildContext context, local.GWCFile file) {
  Navigator.push(
      context,
