...
class ImageColorCorrectionsState extends State<ImageColorCorrections> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        ...
        if (_currentPreview != null)
          GCWImageView(
            imageData: _originalData == null ? null : GCWImageViewData(GWCFile(bytes: _imageBytes())),
  ...
  _adjustToFullPicture() async {
    ...
    return GWCFile(bytes: _convertedOutputImage);
  }
...
openInColorCorrections(BuildContext context, GWCFile file) {
  Navigator.push(
      context,
