  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: <Widget>[
        ...
        if ([3,4].contains(_currentNumberBands)) _resistorBandDropDownButton_fourBands_first,
        if ([3,4].contains(_currentNumberBands)) _resistorBandDropDownButton_fourBands_second,
        if ([3,4].contains(_currentNumberBands)) _resistorBandDropDownButton_fourBands_multiplier,
        if ([4].contains(_currentNumberBands)) _resistorBandDropDownButton_fourBands_tolerance,
        if ([5,6].contains(_currentNumberBands)) _resistorBandDropDownButton_sixBands_first,
        if ([5,6].contains(_currentNumberBands)) _resistorBandDropDownButton_sixBands_second,
        if ([5,6].contains(_currentNumberBands)) _resistorBandDropDownButton_sixBands_third,
        if ([5,6].contains(_currentNumberBands)) _resistorBandDropDownButton_sixBands_multiplier,
        if ([5,6].contains(_currentNumberBands)) _resistorBandDropDownButton_sixBands_tolerance,
        if ([6].contains(_currentNumberBands)) _resistorBandDropDownButton_sixBands_temperatureCoefficient,
        _buildOutput()
      ],
    );
  }
