...
class NumberSequenceMersennePrimesCheckNumber extends NumberSequenceCheckNumber {
  NumberSequenceMersennePrimesCheckNumber() : super(mode: NumberSequencesMode.MERSENNE_PRIMES, maxIndex: 11);
}
...
class NumberSequenceMersennePrimesRange extends NumberSequenceRange {
  NumberSequenceMersennePrimesRange() : super(mode: NumberSequencesMode.MERSENNE_PRIMES, maxIndex: 11);
}

class NumberSequenceMersennePrimesNthNumber extends NumberSequenceNthNumber {
  NumberSequenceMersennePrimesNthNumber() : super(mode: NumberSequencesMode.MERSENNE_PRIMES, maxIndex: 11);
}

class NumberSequenceMersennePrimesContainsDigits extends NumberSequenceContainsDigits {
  NumberSequenceMersennePrimesContainsDigits() : super(mode: NumberSequencesMode.MERSENNE_PRIMES, maxIndex: 11);
}