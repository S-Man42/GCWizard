...
class SevenSegmentDisplayState extends State<SevenSegmentDisplay> {
  ...
  var _segments = <String, bool>{'a1': false, 'a2': false, 'b': false, 'c': false, 'd1': false, 'd2': false, 'e': false, 'f': false, 'g1': false, 'g2': false, 'h': false, 'i': false, 'j': false, 'k': false, 'l': false, 'm': false};
...
class SevenSegmentPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
   var _touchCanvas = TouchyCanvas(context, canvas);
    ...
    var paint = Paint();
    paint.color = segments['a1'] ? colorOn : colorOff;
    print('A1' + paint.color.toString());
    paint.strokeWidth = 0;
    ...
    paint.color = segments['a2'] ? colorOn : colorOff;
    var pathA2 = Path();
    ...
    paint.color = segments['b'] ? colorOn : colorOff;
    var pathB = Path();
   ...
   paint.color = segments['c'] ? colorOn : colorOff;
    var pathC = Path();
   ...
   paint.color = segments['d1'] ? colorOn : colorOff;
    var pathD1 = Path();
   ...
   paint.color = segments['d2'] ? colorOn : colorOff;
    var pathD2 = Path();
   ...
   paint.color = segments['e'] ? colorOn : colorOff;
    var pathE = Path();
   ...
   paint.color = segments['f'] ? colorOn : colorOff;
    var pathF = Path();
   ...
   paint.color = segments['g1'] ? colorOn : colorOff;
    var pathG1 = Path();
   ...
   paint.color = segments['g2'] ? colorOn : colorOff;
    var pathG2 = Path();
   ...
   paint.color = segments['h'] ? colorOn : colorOff;
    var pathH = Path();
   ...
   paint.color = segments['i'] ? colorOn : colorOff;
    var pathI = Path();
   ...
   paint.color = segments['j'] ? colorOn : colorOff;
    var pathJ = Path();
   ...
   paint.color = segments['k'] ? colorOn : colorOff;
    var pathK = Path();
   ...
   paint.color = segments['l'] ? colorOn : colorOff;
    var pathL = Path();
   ...
   paint.color = segments['m'] ? colorOn : colorOff;
    var pathM = Path();
