...
class PrussiaTelegraphSegmentDisplay extends NSegmentDisplay {
  ...
  PrussiaTelegraphSegmentDisplay({Key key, this.segments, this.readOnly: false, this.onChanged, this.tapeStyle: false})
      ...
      customPaint: (GCWTouchCanvas canvas, Size size, Map<String, bool> currentSegments, Function setSegmentState, Color segment_color_on, Color segment_color_off) {
        ...
        var pathC1 = Path();
        pathC1.moveTo(size.width / _PRUSSIA_RELATIVE_DISPLAY_WIDTH * 60, size.width / _PRUSSIA_RELATIVE_DISPLAY_HEIGHT * 50);
        pathC1.lineTo(size.width / _PRUSSIA_RELATIVE_DISPLAY_WIDTH * 60, size.width / _PRUSSIA_RELATIVE_DISPLAY_HEIGHT * 40);
        ...
        var pathC2 = Path();
        pathC2.moveTo(size.width / _PRUSSIA_RELATIVE_DISPLAY_WIDTH *  60, size.width / _PRUSSIA_RELATIVE_DISPLAY_HEIGHT * 50);
        pathC2.lineTo(size.width / _PRUSSIA_RELATIVE_DISPLAY_WIDTH * 100, size.width / _PRUSSIA_RELATIVE_DISPLAY_HEIGHT * 50);
        ...
        var pathC3 = Path();
        pathC3.moveTo(size.width / _PRUSSIA_RELATIVE_DISPLAY_WIDTH * 60, size.width / _PRUSSIA_RELATIVE_DISPLAY_HEIGHT * 60);
        pathC3.lineTo(size.width / _PRUSSIA_RELATIVE_DISPLAY_WIDTH * 90, size.width / _PRUSSIA_RELATIVE_DISPLAY_HEIGHT * 80);
        ...
        var pathC4 = Path();
        pathC4.moveTo(size.width / _PRUSSIA_RELATIVE_DISPLAY_WIDTH * 50, size.width / _PRUSSIA_RELATIVE_DISPLAY_HEIGHT * 60);
        pathC4.lineTo(size.width / _PRUSSIA_RELATIVE_DISPLAY_WIDTH * 50, size.width / _PRUSSIA_RELATIVE_DISPLAY_HEIGHT * 70);
        ...
        var pathC5 = Path();
        pathC5.moveTo(size.width / _PRUSSIA_RELATIVE_DISPLAY_WIDTH * 10, size.width / _PRUSSIA_RELATIVE_DISPLAY_HEIGHT * 50);
        pathC5.lineTo(size.width / _PRUSSIA_RELATIVE_DISPLAY_WIDTH * 50, size.width / _PRUSSIA_RELATIVE_DISPLAY_HEIGHT * 50);
        ...
        var pathC6 = Path();
        pathC6.moveTo(size.width / _PRUSSIA_RELATIVE_DISPLAY_WIDTH * 50, size.width / _PRUSSIA_RELATIVE_DISPLAY_HEIGHT * 50);
        pathC6.lineTo(size.width / _PRUSSIA_RELATIVE_DISPLAY_WIDTH * 20, size.width / _PRUSSIA_RELATIVE_DISPLAY_HEIGHT * 30);
        pathC6.lineTo(size.width / _PRUSSIA_RELATIVE_DISPLAY_WIDTH * 30, size.width / _PRUSSIA_RELATIVE_DISPLAY_HEIGHT * 20);
        ...
        var pathA1 = Path();
        pathA1.moveTo(size.width / _PRUSSIA_RELATIVE_DISPLAY_WIDTH * 60, size.width / _PRUSSIA_RELATIVE_DISPLAY_HEIGHT * 210);
        pathA1.lineTo(size.width / _PRUSSIA_RELATIVE_DISPLAY_WIDTH * 60, size.width / _PRUSSIA_RELATIVE_DISPLAY_HEIGHT * 200);
        ...
        var pathA2 = Path();
        pathA2.moveTo(size.width / _PRUSSIA_RELATIVE_DISPLAY_WIDTH *  60, size.width / _PRUSSIA_RELATIVE_DISPLAY_HEIGHT * 210);
        pathA2.lineTo(size.width / _PRUSSIA_RELATIVE_DISPLAY_WIDTH * 100, size.width / _PRUSSIA_RELATIVE_DISPLAY_HEIGHT * 210);
        ...
        var pathA3 = Path();
        pathA3.moveTo(size.width / _PRUSSIA_RELATIVE_DISPLAY_WIDTH * 60, size.width / _PRUSSIA_RELATIVE_DISPLAY_HEIGHT * 220);
        pathA3.lineTo(size.width / _PRUSSIA_RELATIVE_DISPLAY_WIDTH * 90, size.width / _PRUSSIA_RELATIVE_DISPLAY_HEIGHT * 240);
        ...
        var pathA4 = Path();
        pathA4.moveTo(size.width / _PRUSSIA_RELATIVE_DISPLAY_WIDTH * 50, size.width / _PRUSSIA_RELATIVE_DISPLAY_HEIGHT * 220);
        pathA4.lineTo(size.width / _PRUSSIA_RELATIVE_DISPLAY_WIDTH * 50, size.width / _PRUSSIA_RELATIVE_DISPLAY_HEIGHT * 230);
        ...
        var pathA5 = Path();
        pathA5.moveTo(size.width / _PRUSSIA_RELATIVE_DISPLAY_WIDTH * 10, size.width / _PRUSSIA_RELATIVE_DISPLAY_HEIGHT * 210);
        pathA5.lineTo(size.width / _PRUSSIA_RELATIVE_DISPLAY_WIDTH * 50, size.width / _PRUSSIA_RELATIVE_DISPLAY_HEIGHT * 210);
        ...
        var pathA6 = Path();
        pathA6.moveTo(size.width / _PRUSSIA_RELATIVE_DISPLAY_WIDTH * 50, size.width / _PRUSSIA_RELATIVE_DISPLAY_HEIGHT * 210);
        pathA6.lineTo(size.width / _PRUSSIA_RELATIVE_DISPLAY_WIDTH * 20, size.width / _PRUSSIA_RELATIVE_DISPLAY_HEIGHT * 190);
        pathA6.lineTo(size.width / _PRUSSIA_RELATIVE_DISPLAY_WIDTH * 30, size.width / _PRUSSIA_RELATIVE_DISPLAY_HEIGHT * 180);
