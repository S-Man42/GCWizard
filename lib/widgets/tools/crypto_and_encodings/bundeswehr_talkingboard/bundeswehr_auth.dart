...
class BundeswehrTalkingBoardAuthentificationState extends State<BundeswehrTalkingBoardAuthentification> {
                ...
                : Column(
                    children: <Widget>[
                      GCWTextField(
                        ...
                        onChanged: (text) {
                          setState(() {
                            _currentNumeralCodeXaxisCustom = (text == null || text == '') ? '' : _numeralCodeXAxisCodeMaskFormatter.getMaskedText();
                          });
                        },
                      ),
                      GCWTextField(
  ...
  Widget _calculateOutput(BuildContext context) {
    ...
    if (_currentMode == GCWSwitchPosition.right) {
      ...
      if (output.ResponseCode == BUNDESWEHR_TALKINGBOARD_AUTH_RESPONSE_OK) {
        return Column(
          children: <Widget>[
  ...
  bool _buildAuthTable(BuildContext context, {bool custom, String authTable}) {
  ...
  bool _buildNumeralCode(BuildContext context, {bool custom, String xAxis, String yAxis}) {
