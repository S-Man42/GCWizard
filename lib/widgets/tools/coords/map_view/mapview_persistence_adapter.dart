...
class MapViewPersistenceAdapter {
  ...
  _initializeMapView() {
    ...
    if (_mapViewDAO.points == null) _mapViewDAO.points = List<MapPointDAO>();
    if (mapWidget.points == null) mapWidget.points = List<GCWMapPoint>();
    ...
    if (_mapViewDAO.polylines == null) _mapViewDAO.polylines = List<MapPolylineDAO>();
    if (mapWidget.polylines == null) mapWidget.polylines = List<GCWMapPolyline>();
