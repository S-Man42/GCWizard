...
class Registry {
  ...
  static initialize(BuildContext context) {
    toolList = [
      ...
      GCWSymbolTableTool(symbolKey: 'flags_uk_howe', symbolSearchStrings: [
        SEARCHSTRING_COMMON_SYMBOL_FLAGS,
        SEARCHSTRING_DE_SYMBOL_FLAGS,
        SEARCHSTRING_EN_SYMBOL_FLAGS,
        SEARCHSTRING_FR_SYMBOL_FLAGS,
        SEARCHSTRING_COMMON_SYMBOL_FLAGS_UK_HOWE,
        SEARCHSTRING_DE_SYMBOL_FLAGS_UK_HOWE,
        SEARCHSTRING_EN_SYMBOL_FLAGS_UK_HOWE,
        SEARCHSTRING_FR_SYMBOL_FLAGS_UK_HOWE
      ]),
