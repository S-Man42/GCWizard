...
class Registry {
  ...
  static final SEARCHSTRING_ASTRONOMY =
      'astronomy astronomie stars sterne planets planeten astronomisches astronomical ';
  static final SEARCHSTRING_ASTRONOMY_RISESET =
      'rise set transit noon aufgang aufgaenge untergang untergaenge dawn dusk mittag culmination kulmination ';
  static final SEARCHSTRING_ASTRONOMY_POSITION =
  ...
  static final SEARCHSTRING_BCD =
      SEARCHSTRING_BINARY + 'bcd binary coded decimal binaer codierte dezimalzahlen hamming distance hamming-distanz';
  static final SEARCHSTRING_BEAUFORT =
      'beaufortskala windforce beaufortscale beaufort-skala windstaerke windspeed knots knoten storm hurricanes orkane windboeen brisen windgeschwindigkeit ';
  ...
  static final SEARCHSTRING_CCITT2 = SEARCHSTRING_CCITT +
      'ccitt2 ccitt-2 donald murray lochstreifen lochkarten konrad zuse z-22 z22 punchedpapertape cards baudot-murray-code ';
  static final SEARCHSTRING_CIPHERWHEEL =
      'dechiffrierscheiben decipherwheels drehscheiben stages decipherdisks decipherdiscs ';
  static final SEARCHSTRING_CISTERCIAN =
      'cistercian zisterzienser monastic order monk moenchsorden moenche zahlen numbers ';
  static final SEARCHSTRING_CODEBREAKER =
      'solver loeser universal universeller codebreaker codebrecher codeknacker cracker textersetzung replacement';
  static final SEARCHSTRING_COMBINATORICS = 'mathematics mathematik kombinatorik combinatorics ';
  static final SEARCHSTRING_COMBINATORICS_COMBINATION =
      SEARCHSTRING_COMBINATORICS + 'combinations kombinationen untergruppen subgroups ';
  static final SEARCHSTRING_COMBINATORICS_PERMUTATION =
      SEARCHSTRING_COMBINATORICS + 'permutationen permutations anordnungen reihenfolgen arrangements orders ';
  static final SEARCHSTRING_COORDINATES =
      'coordinates dec dms utm mgrs degrees minutes seconds koordinaten grad minuten sekunden ';
  static final SEARCHSTRING_COORDINATES_COMPASSROSE =
      'compassrose kompassrose himmelsrichtungen windrichtungen intercardinaldirections ';
  static final SEARCHSTRING_CROSSSUMS =
      'crosssums digits alternated crosstotals iterated iteriert products quersummen produkte alternierend alterniert iterierend digitalroot digitroot ';
  static final SEARCHSTRING_DATES = 'dates datum tage days ';
  static final SEARCHSTRING_DNA =
      'code-sonne codesonne codesun dna mrna desoxyribonucleicacid desoxyribonukleinsaeure dns mrns genetisches genetik genetics genes genomes gattaca nucleotide nukleotid sequence sequenz thymine uracile cytosine adenine guanine ';
  ...
  static final SEARCHSTRING_LANGUAGEGAMES =
      'spielsprachen gamelanguages secretlanguagegames geheimsprachen kindersprachen ';
  static final SEARCHSTRING_HASHES =
      'hashes message digests onewayencryptions einwegverschluesselungen hashvalues hashwerte ';
  ...
  static final SEARCHSTRING_IRRATIONALNUMBERS =
      'irrational number irrationale zahlen fraction decimal digit nachkommastelle ';
  static final SEARCHSTRING_MAYANUMBERS = 'mayas majas zahlen ziffern numbers numerals vigesimalsystem 20 ';
  static final SEARCHSTRING_NUMERALWORDS =
      'numeralwords zahlwoerter numberwords zaehlwort zahlwort zaehlwoerter numerals';
  ...
  static final SEARCHSTRING_PHI = SEARCHSTRING_IRRATIONALNUMBERS +
      'phi goldener schnitt golden ratio fibonacci 1,6180339887 1.6180339887 0,6180339887 0.6180339887 ' +
      [934, 966, 981].map((char) => String.fromCharCode(char)).join(' ');
  static final SEARCHSTRING_PI = SEARCHSTRING_IRRATIONALNUMBERS +
      'pi circle kreis 3,1415926535 3.1415926535 ' +
      [928, 960].map((char) => String.fromCharCode(char)).join(' ');
  ...
  static final SEARCHSTRING_RSA = SEARCHSTRING_PRIMES +
      'rsa ronald rivest adi shamir leonard adleman asymmetry asymmetric asymmetrie asymmetrisches public private key oeffentlicher privater schluessel phi ';
  static final SEARCHSTRING_SEGMENTDISPLAY = 'led segments segmente display segmentanzeige ';
  static final SEARCHSTRING_SYMBOLTABLES =
      'symbols symbole tabelle zeichen signs tables tabellen codes bilder images pictures fonts schriften ';
  ...
  static final SEARCHSTRING_SYMBOLTABLES_ILLUMINATI =
      SEARCHSTRING_SYMBOLTABLES_FREEMASONS + 'illuminati illuminatus illuminaten 23 ';
  ...
  static final SEARCHSTRING_SYMBOLTABLES_OPTICALFIBER =
      'lwl llk lichtwellenleiter lichtleitkabel opticalfiber glasfaserkabel ';
  static final SEARCHSTRING_SYMBOLTABLES_SIGNLANGUAGE =
      'gebaarental deafmute deaf-mute deafblind hearing loss deaf-blind taub-stummes hands haende fingers daumen thumbs signs signlanguage gebaerdensprache deafblind gehoerloses taubstummes ';
  static final SEARCHSTRING_TOMTOM = 'a-tom-tom atomtom ';
  static final SEARCHSTRING_VANITY =
      'telefontasten telephone keys buttons numbers ziffern telefonnummern vanity keypad sms mobile cellphone handy phoneword tasten tastatur ';
  ...
  static initialize(BuildContext context) {
    toolList = [
      ...
      GCWTool(
          ...
          searchStrings: 'abaddon abbaddon abbadon yen renminbi mi thorn ternaer gc11eky ' +
      ...
      GCWTool(tool: Affine(), i18nPrefix: 'affine', category: ToolCategory.CRYPTOGRAPHY, searchStrings: 'affine'),
      GCWTool(
          tool: AlphabetValues(),
          i18nPrefix: 'alphabetvalues',
          category: ToolCategory.CRYPTOGRAPHY,
          searchStrings:
              'buchstabenwortwerte bww alphabetvalues russian russisch kyrillisch cyrillic greek griechisch spanish spanisch deutsch german polish polnisch alphanumeric lettervalues checksums crosssums digits alternate buchstabenwerte quersummen alphanumerisch produkt alternierend'),
      GCWTool(
          tool: Amsco(),
          i18nPrefix: 'amsco',
          category: ToolCategory.CRYPTOGRAPHY,
      ...
      GCWTool(
          ...
          category: ToolCategory.CRYPTOGRAPHY,
          searchStrings:
              'bookcipher buchcode word wort position zeile row line absatz section letter buchstabe buechercode buchchiffre buecherchiffre'),
      GCWTool(
          tool: BurrowsWheeler(),
      ...
      GCWTool(
          ...
          category: ToolCategory.SCIENCE_AND_TECHNOLOGY,
          searchStrings:
              'colors colours pal ntsc farben rgb hexcode hsl hsi hsv yuv yiq ypbpr ycbcr shorthexcode picker red green blue yellow black key magenta orange cyan luminanz hellwert farbwert helligkeit saettigung luminance chrominanz chrominance saturation lightness hue cmyk luma chroma'),
      GCWTool(
          tool: CombinatoricsSelection(),
          i18nPrefix: 'combinatorics_selection',
          category: ToolCategory.SCIENCE_AND_TECHNOLOGY,
          searchStrings: SEARCHSTRING_COMBINATORICS),
      GCWTool(tool: CoordsSelection(), i18nPrefix: 'coords_selection', searchStrings: SEARCHSTRING_COORDINATES),
      GCWTool(
      ...
      GCWTool(
          ...
          searchStrings:
              'cryptography verschluesselung entschluesselung verschluesseln entschluesseln codes encoding decoding encode decode encryption encrypt decrypt decryption kryptographie kryptografie'),
      GCWTool(
          tool: DatesSelection(),
      ...
      GCWTool(
          ...
          category: ToolCategory.SCIENCE_AND_TECHNOLOGY,
          searchStrings:
              'dual-tone multi-frequency dualtonemultifrequency touchtone mehrfrequenzwahlverfahren mfwv mfv tonwahl dtmf mehrfrequenzton tonwahlverfahren mfc mf4'),
      GCWTool(
          tool: EnclosedAreas(),
          i18nPrefix: 'enclosedareas',
          category: ToolCategory.CRYPTOGRAPHY,
          searchStrings:
              'enclosedareas eingeschlosseneflaechen countholes countingholes zaehleloecherzaehlen zaehleloch anzahlloecher numberholes'),
      GCWTool(
          tool: ESelection(),
      ...
      GCWTool(
          tool: FormulaSolverFormulaGroups(), i18nPrefix: 'formulasolver', searchStrings: SEARCHSTRING_FORMULASOLVER),
      GCWTool(tool: GamesSelection(), i18nPrefix: 'games_selection', searchStrings: 'games spiele'),
      GCWTool(tool: Gade(), i18nPrefix: 'gade', category: ToolCategory.CRYPTOGRAPHY, searchStrings: 'gade'),
      GCWTool(
          tool: GCCode(),
          i18nPrefix: 'gccode',
          category: ToolCategory.CRYPTOGRAPHY,
      ...
      GCWTool(
          ...
          category: ToolCategory.CRYPTOGRAPHY,
          searchStrings:
              'they killed kenny sie haben kenny getoetet kennys kenny\'s code southpark mpf mfp fmp fpm pmf pfm'),
      GCWTool(
          tool: Keyboard(),
          i18nPrefix: 'keyboard',
          category: ToolCategory.SCIENCE_AND_TECHNOLOGY,
      ...
      GCWTool(
          ...
          category: ToolCategory.CRYPTOGRAPHY,
          searchStrings:
              'dvorak keyboard keys tasten azerty tastatur layout qwertz qwerty neo colemak ristome sprachen languages'),
      GCWTool(
      ...
      GCWTool(
          ...
          category: ToolCategory.SCIENCE_AND_TECHNOLOGY,
          searchStrings: SEARCHSTRING_BINARY +
              'radix numeral systems zahlenbasis zahlenbasen zahlensysteme octal octenary oktal dual hexadecimal hexadezimal'),
      GCWTool(
      ...
      GCWTool(
          ...
          category: ToolCategory.CRYPTOGRAPHY,
          searchStrings:
              'railfence lattenzaun jaegerzaun zigzag redefence zig-zag palisadenzaun gartenzaun transposition'),
      GCWTool(
          tool: RC4(),
          i18nPrefix: 'rc4',
          category: ToolCategory.CRYPTOGRAPHY,
      ...
      GCWTool(
          ...
          category: ToolCategory.CRYPTOGRAPHY,
          searchStrings:
              'reversed backwards umkehren umgekehrt rueckwaerts inversed inverted invertieren invertierung invertiert inverse '),
      GCWTool(
      ...
      GCWTool(
          ...
          searchStrings:
              'science technology naturwissenschaften technologien technik maths mathematics mathematik physics physik chemistry chemie electronics elektronik '),
      GCWTool(
          tool: Scrabble(),
          i18nPrefix: 'scrabble',
      ...
      GCWTool(
          ...
          category: ToolCategory.CRYPTOGRAPHY,
          searchStrings:
              'solitaire solitaer carddeck cardgame joker kartenspiel kartendeck cryptonomicon pontifex bruceschneier stromchiffrierung streamcipher nealstephenson'),
      GCWTool(
          tool: Substitution(),
      ...
      GCWTool(
          ...
          category: ToolCategory.GENERAL_CODEBREAKERS,
          searchStrings: SEARCHSTRING_CODEBREAKER +
              'substitution monoalphabetische monoalphabetic ersetzen replacements alphabet change austauschen change switch '),
      GCWTool(
          tool: SudokuSolver(),
      ...
      GCWTool(tool: Z22(), i18nPrefix: 'z22', category: ToolCategory.CRYPTOGRAPHY, searchStrings: SEARCHSTRING_CCITT2),
      ...
      GCWTool(
          ...
          i18nPrefix: 'humidex',
          searchStrings:
              SEARCHSTRING_APPARENTTEMPERATURE + 'humidity luftfeuchtigkeit canadian canada humidex dewpoint'),
      GCWTool(
      ...
      GCWTool(
          ...
          searchStrings: SEARCHSTRING_ASTRONOMY +
              SEARCHSTRING_ASTRONOMY_RISESET +
              'solar sun sonne twilight morning evening morgendaemmerung abenddaemmerung nautical astronomical civil zivile buergerliche astronomische nautische '),
      GCWTool(
          tool: SunPosition(),
      ...
      GCWTool(
          ...
          searchStrings: SEARCHSTRING_ASTRONOMY +
              SEARCHSTRING_ASTRONOMY_POSITION +
              'lunar mond moon eclipticlatitude ekliptischebreite moonphase mondphase moonage mondalter mondzeichen moonsign illumination beleuchtung beleuchtet illuminated '),
      GCWTool(tool: EasterSelection(), i18nPrefix: 'astronomy_easter_selection', searchStrings: SEARCHSTRING_EASTER),
      GCWTool(
        tool: Seasons(),
        i18nPrefix: 'astronomy_seasons',
        searchStrings:
            'seasons jahreszeiten spring summer winter autumn fall herbst fruehling sommer aphelion perihelion sonnennaechster sonnenaehester sonnennahster sonnennahester sonnenfernster nearest closest farthest furthest ',
      ),

      //BaseSelection **************************************************************************************************
      GCWTool(tool: Base16(), i18nPrefix: 'base_base16', searchStrings: SEARCHSTRING_BASE + 'base16'),
      GCWTool(tool: Base32(), i18nPrefix: 'base_base32', searchStrings: SEARCHSTRING_BASE + 'base32'),
      GCWTool(tool: Base64(), i18nPrefix: 'base_base64', searchStrings: SEARCHSTRING_BASE + 'base64'),
      GCWTool(tool: Base85(), i18nPrefix: 'base_base85', searchStrings: SEARCHSTRING_BASE + 'base85 ascii85'),

      //BCD selection **************************************************************************************************
      GCWTool(tool: BCDOriginal(), i18nPrefix: 'bcd_original', searchStrings: SEARCHSTRING_BCD),
      GCWTool(tool: BCDAiken(), i18nPrefix: 'bcd_aiken', searchStrings: SEARCHSTRING_BCD + 'aiken'),
      GCWTool(tool: BCDGlixon(), i18nPrefix: 'bcd_glixon', searchStrings: SEARCHSTRING_BCD + 'glixon'),
      GCWTool(tool: BCDGray(), i18nPrefix: 'bcd_gray', searchStrings: SEARCHSTRING_BCD + 'gray'),
      GCWTool(
          tool: BCDLibawCraig(),
          i18nPrefix: 'bcd_libawcraig',
          searchStrings: SEARCHSTRING_BCD + 'libaw-craig libawcraig'),
      GCWTool(tool: BCDOBrien(), i18nPrefix: 'bcd_obrien', searchStrings: SEARCHSTRING_BCD + 'o\'brien obrien'),
      GCWTool(tool: BCDPetherick(), i18nPrefix: 'bcd_petherick', searchStrings: SEARCHSTRING_BCD + 'petherick'),
      GCWTool(tool: BCDStibitz(), i18nPrefix: 'bcd_stibitz', searchStrings: SEARCHSTRING_BCD + 'stibitz'),
      GCWTool(tool: BCDTompkins(), i18nPrefix: 'bcd_tompkins', searchStrings: SEARCHSTRING_BCD + 'tompkins'),
      GCWTool(tool: BCDHamming(), i18nPrefix: 'bcd_hamming', searchStrings: SEARCHSTRING_BCD + 'hamming'),
      GCWTool(
          tool: BCDBiquinary(), i18nPrefix: 'bcd_biquinary', searchStrings: SEARCHSTRING_BCD + 'biquinaer biquinary'),
      GCWTool(
          tool: BCD2of5Planet(),
          i18nPrefix: 'bcd_2of5planet',
          searchStrings:
              SEARCHSTRING_BCD + 'planet 2of5 2aus5 twooffive zweiausfuenf united states postal service usps barcode'),
      GCWTool(
          tool: BCD2of5Postnet(),
          i18nPrefix: 'bcd_2of5postnet',
          searchStrings:
              SEARCHSTRING_BCD + 'postnet 2of5 2aus5 twooffive zweiausfuenf united states postal service usps barcode'),
      GCWTool(
          tool: BCD2of5(),
          i18nPrefix: 'bcd_2of5',
      ...
      // Beaufort Selection *******************************************************************************************
      GCWTool(tool: Beaufort(), i18nPrefix: 'beaufort', searchStrings: SEARCHSTRING_BEAUFORT),

      //CCITT*Selection **********************************************************************************************
      GCWTool(tool: CCITT1(), i18nPrefix: 'ccitt1', searchStrings: SEARCHSTRING_CCITT1),
      GCWTool(tool: CCITT2(), i18nPrefix: 'ccitt2', searchStrings: SEARCHSTRING_CCITT2),

      //Cistercian Selection *****************************************************************************************
      GCWTool(tool: CistercianNumbers(), i18nPrefix: 'cistercian', searchStrings: SEARCHSTRING_CISTERCIAN),
      ...
      GCWTool(
          ...
          searchStrings: SEARCHSTRING_COORDINATES +
              SEARCHSTRING_COORDINATES_COMPASSROSE +
              'winkel angles waypointprojections bearings wegpunktprojektionen wegpunktpeilungen cardinaldirections richtungen reverse projections rueckwaertspeilung kompassrose compassrose himmelsrichtungen '),
      GCWTool(
          ...
          category: ToolCategory.COORDINATES,
          searchStrings: SEARCHSTRING_COORDINATES +
              'angles winkel bearings distances distanzen entfernungen abstand abstaende directions richtungen'),
      GCWTool(
      ...
      GCWTool(
          ...
          category: ToolCategory.COORDINATES,
          searchStrings:
              SEARCHSTRING_COORDINATES + 'mapview kartenansicht freiekarte openmap measurement messen messungen '),
      GCWTool(
      ...
      GCWTool(
          ...
          category: ToolCategory.COORDINATES,
          searchStrings:
              SEARCHSTRING_COORDINATES + 'midpoint center centre middle mittelpunkt zentrum zwei two 2 points punkte'),
      GCWTool(
          ...
          category: ToolCategory.COORDINATES,
          searchStrings: SEARCHSTRING_COORDINATES +
              'midpoint center centre middle mittelpunkt zentrum three drei 3 umkreis circumcircle circumscribed points punkte seitenhalbierende medians '),
      GCWTool(
          tool: SegmentLine(),
          ...
          category: ToolCategory.COORDINATES,
          searchStrings: SEARCHSTRING_COORDINATES +
              'segments segmentlines unterteilen einteilen teilungen abschnitte gleichmaessig regularly bisectors'),
      GCWTool(
          ...
          category: ToolCategory.COORDINATES,
          searchStrings: SEARCHSTRING_COORDINATES +
              'segments segmentbearings unterteilen einteilen teilungen abschnitte gleichmaessig regularly angles winkel peilungen bearings courses winkelhalbierende bisectors'),
      GCWTool(
          tool: CrossBearing(),
          ...
          category: ToolCategory.COORDINATES,
          searchStrings:
              SEARCHSTRING_COORDINATES + 'bearings angles intersections winkel kreuzpeilungen directions richtungen'),
      GCWTool(
          ...
          searchStrings: SEARCHSTRING_COORDINATES +
              SEARCHSTRING_COORDINATES_COMPASSROSE +
              'bearings angles winkel intersections winkel peilung'),
      GCWTool(
          ...
          category: ToolCategory.COORDINATES,
          searchStrings: SEARCHSTRING_COORDINATES +
              'bearings richtungen directions lines arcs crossing intersection linien kreuzung four vier 4 points punkte'),
      GCWTool(
          ...
          searchStrings: SEARCHSTRING_COORDINATES +
              SEARCHSTRING_COORDINATES_COMPASSROSE +
              'bearings angles distances circles arcs intersection distanzen entfernungen abstand abstaende winkel kreisbogen kreise'),
      GCWTool(
          ...
          category: ToolCategory.COORDINATES,
          searchStrings: SEARCHSTRING_COORDINATES +
              'multilateration bilateration distances intersection distanzen entfernungen abstand abstaende two zwei 2 circles kreise'),
      GCWTool(
          ...
          category: ToolCategory.COORDINATES,
          searchStrings: SEARCHSTRING_COORDINATES +
              'multilateration trilateration distances intersection distanzen entfernungen abstand abstaende drei three 3 circles kreise'),
      GCWTool(
          tool: Antipodes(),
      ...
      GCWTool(
          ...
          category: ToolCategory.COORDINATES,
          searchStrings: SEARCHSTRING_COORDINATES +
              'intersection 2 angles bearings directions richtungen vorwaertseinschnitt vorwaertseinschneiden vorwaertsschnitt vorwaertsschneiden'),
      GCWTool(
          tool: Resection(),
          ...
          category: ToolCategory.COORDINATES,
          searchStrings: SEARCHSTRING_COORDINATES +
              'resection 2 two zwei angles winkel directions richtungen bearings 3 three drei rueckwaertseinschnitt rueckwaertseinschneiden rueckwaertsschnitt rueckwaertsschneiden'),
      GCWTool(
      ...
      GCWTool(
          ...
          category: ToolCategory.COORDINATES,
          searchStrings: SEARCHSTRING_COORDINATES +
              'rotationsellipsoids rotationsellipsoiden converter converting konverter konvertieren umwandeln bessel 1841 bessel krassowski krasowksi krasovsky krassovsky 1950 airy 1830 modified potsdam dhdn2001 dhdn1995 pulkowo mgi lv95 ed50 clarke 1866 osgb36 date datum wgs84'),

      //CrossSumSelection *******************************************************************************************
      GCWTool(tool: CrossSum(), i18nPrefix: 'crosssum_crosssum', searchStrings: SEARCHSTRING_CROSSSUMS),
      GCWTool(tool: CrossSumRange(), i18nPrefix: 'crosssum_range', searchStrings: SEARCHSTRING_CROSSSUMS),
      GCWTool(
          tool: IteratedCrossSumRange(), i18nPrefix: 'crosssum_range_iterated', searchStrings: SEARCHSTRING_CROSSSUMS),
      GCWTool(
      ...
      GCWTool(tool: Weekday(), i18nPrefix: 'dates_weekday', searchStrings: 'weekdays wochentage'),
      ...
      GCWTool(
          ...
          searchStrings: SEARCHSTRING_DNA +
              'nucleicacid sequence nukleotidsequenz nukleitide nukleinsaeure basenpaare basepairs alleles'),
      GCWTool(
          tool: DNAAminoAcids(),
      ...
      //E Selection *************************************************************************************************
      GCWTool(tool: ENthDecimal(), i18nPrefix: 'irrationalnumbers_nthdecimal'),
      GCWTool(tool: EDecimalRange(), i18nPrefix: 'irrationalnumbers_decimalrange'),
      GCWTool(tool: ESearch(), i18nPrefix: 'irrationalnumbers_search'),
      ...
      GCWTool(
        ...
        i18nPrefix: 'chef',
        searchStrings: SEARCHSTRING_ESOTERICPROGRAMMINGLANGUAGE +
            'chef chefkoch kochrezepte rezepte kochen zutaten ingredients cooking cook recipes',
      ),
      GCWTool(
        tool: Beatnik(),
        i18nPrefix: 'beatnik',
      ...
      GCWTool(tool: Brainfk(), i18nPrefix: 'brainfk', searchStrings: SEARCHSTRING_BRAINFK),
      GCWTool(
          tool: Deadfish(),
          i18nPrefix: 'deadfish',
      ...
      GCWTool(
          ...
          searchStrings: SEARCHSTRING_BRAINFK +
              'ook terry pratchett monkeys apes dots punkte questionsmarks exclamationmarks fragezeichen ausrufezeichen affen orang-utans orangutans'),
      GCWTool(
      ...
      GCWTool(
          ...
          category: ToolCategory.GENERAL_CODEBREAKERS,
          searchStrings: SEARCHSTRING_HASHES +
              SEARCHSTRING_CODEBREAKER +
              'hashbreaker hashsolver hashloeser hashknacker hashcracker'),
      GCWTool(tool: MD5(), i18nPrefix: 'hashes_md5', searchStrings: SEARCHSTRING_HASHES + 'md5 md-5'),
      GCWTool(tool: SHA1(), i18nPrefix: 'hashes_sha1', searchStrings: SEARCHSTRING_HASHES_SHA + 'sha1 sha-1 160bits'),
      GCWTool(
          tool: SHA224(),
      ...
      GCWTool(
          ...
          searchStrings:
              SEARCHSTRING_HASHES_SHA2 + 'sha512t sha-512t sha2-512t 224bits sha512/224 sha-512/224 sha2-512/224'),
      GCWTool(
          tool: SHA512_256(),
          i18nPrefix: 'hashes_sha512.256',
          searchStrings:
              SEARCHSTRING_HASHES_SHA2 + 'sha512t sha-512t sha2-512t 256bits sha512/256 sha-512/256 sha2-512/256'),
      GCWTool(
          tool: SHA3_224(),
      ...
      GCWTool(
          tool: RIPEMD_128(), i18nPrefix: 'hashes_ripemd128', searchStrings: SEARCHSTRING_HASHES_RIPEMD + '128bits'),
      GCWTool(
          tool: RIPEMD_160(), i18nPrefix: 'hashes_ripemd160', searchStrings: SEARCHSTRING_HASHES_RIPEMD + '160bits'),
      GCWTool(
          tool: RIPEMD_256(), i18nPrefix: 'hashes_ripemd256', searchStrings: SEARCHSTRING_HASHES_RIPEMD + '256bits'),
      GCWTool(
          tool: RIPEMD_320(), i18nPrefix: 'hashes_ripemd320', searchStrings: SEARCHSTRING_HASHES_RIPEMD + '320bits'),
      GCWTool(tool: MD2(), i18nPrefix: 'hashes_md2', searchStrings: SEARCHSTRING_HASHES + 'md2 md-2'),
      GCWTool(tool: MD4(), i18nPrefix: 'hashes_md4', searchStrings: SEARCHSTRING_HASHES + 'md4 md-4'),
      GCWTool(
          tool: Tiger_192(), i18nPrefix: 'hashes_tiger192', searchStrings: SEARCHSTRING_HASHES + 'tiger192 tiger-192'),
      GCWTool(
          tool: Whirlpool_512(),
          i18nPrefix: 'hashes_whirlpool512',
          searchStrings: SEARCHSTRING_HASHES + 'whirlpool512 whirlpool-512'),
      GCWTool(
          tool: BLAKE2b_160(), i18nPrefix: 'hashes_blake2b160', searchStrings: SEARCHSTRING_HASHES_BLAKE2B + '160bits'),
      GCWTool(
          tool: BLAKE2b_224(), i18nPrefix: 'hashes_blake2b224', searchStrings: SEARCHSTRING_HASHES_BLAKE2B + '224bits'),
      GCWTool(
          tool: BLAKE2b_224(), i18nPrefix: 'hashes_blake2b256', searchStrings: SEARCHSTRING_HASHES_BLAKE2B + '256bits'),
      GCWTool(
          tool: BLAKE2b_224(), i18nPrefix: 'hashes_blake2b384', searchStrings: SEARCHSTRING_HASHES_BLAKE2B + '384bits'),
      GCWTool(
          tool: BLAKE2b_224(), i18nPrefix: 'hashes_blake2b512', searchStrings: SEARCHSTRING_HASHES_BLAKE2B + '512bits'),
      ...
      GCWTool(tool: DuckSpeak(), i18nPrefix: 'duckspeak', searchStrings: 'entensprache duck speak nak entisch duckish'),
      GCWTool(
          tool: PigLatin(),
          i18nPrefix: 'piglatin',
      ...
      GCWTool(
          ...
          searchStrings:
              SEARCHSTRING_LANGUAGEGAMES + 'robberlanguage raeubersprache rotwelsch astrid lindgren rovarspraket'),
      GCWTool(
          tool: SpoonLanguage(),
      ...
      GCWTool(tool: MayaNumbers(), i18nPrefix: 'mayanumbers', searchStrings: SEARCHSTRING_MAYANUMBERS),
      ...
      GCWTool(
        ...
        searchStrings:
            SEARCHSTRING_NUMBERSEQUENCES + 'superperfect numbers superperfekte vollkommene zahlen oeis A000396',
      ),
      GCWTool(
        tool: NumberSequencePrimaryPseudoPerfectNumbersSelection(),
        i18nPrefix: 'numbersequence_primarypseudoperfectnumbers',
        searchStrings: SEARCHSTRING_NUMBERSEQUENCES +
            'primarypseudoperfect numbers primaerpseudoperfekte vollkommene zahlen oeis A054377',
      ),
      GCWTool(
      ...
      GCWTool(tool: PeriodicTable(), i18nPrefix: 'periodictable', searchStrings: SEARCHSTRING_PERIODICTABLE),
      GCWTool(
      ...
      //PrimesSelection **********************************************************************************************
      GCWTool(
          tool: NthPrime(), i18nPrefix: 'primes_nthprime', searchStrings: SEARCHSTRING_PRIMES + 'positions positionen'),
      GCWTool(
          tool: IsPrime(),
      ...
      GCWTool(
          ...
          searchStrings:
              SEARCHSTRING_PRIMES + 'integer factorizations factors faktorisierung primfaktorzerlegungen faktoren'),
      ...
      GCWTool(
          tool: ResistorEIA96(), i18nPrefix: 'resistor_eia96', searchStrings: SEARCHSTRING_RESISTOR + 'eia96 eia-96'),

      //RomanNumbersSelection **********************************************************************************************
      GCWTool(tool: RomanNumbers(), i18nPrefix: 'romannumbers', searchStrings: SEARCHSTRING_ROMAN_NUMBERS),
      GCWTool(
          tool: Chronogram(),
      ...
      //RotationSelection **********************************************************************************************
      GCWTool(tool: Rot13(), i18nPrefix: 'rotation_rot13', searchStrings: SEARCHSTRING_ROTATION + 'rot13 rot-13'),
      GCWTool(tool: Rot5(), i18nPrefix: 'rotation_rot5', searchStrings: SEARCHSTRING_ROTATION + 'rot5 rot-5'),
      GCWTool(tool: Rot18(), i18nPrefix: 'rotation_rot18', searchStrings: SEARCHSTRING_ROTATION + 'rot18 rot-18'),
      GCWTool(tool: Rot47(), i18nPrefix: 'rotation_rot47', searchStrings: SEARCHSTRING_ROTATION + 'rot47 rot-47'),
      GCWTool(tool: RotationGeneral(), i18nPrefix: 'rotation_general', searchStrings: SEARCHSTRING_ROTATION),

      // RSA *******************************************************************************************************
      GCWTool(tool: RSA(), i18nPrefix: 'rsa_rsa', searchStrings: SEARCHSTRING_RSA),
      GCWTool(tool: RSAEChecker(), i18nPrefix: 'rsa_e.checker', searchStrings: SEARCHSTRING_RSA),
      GCWTool(tool: RSADChecker(), i18nPrefix: 'rsa_d.checker', searchStrings: SEARCHSTRING_RSA),
      GCWTool(tool: RSADCalculator(), i18nPrefix: 'rsa_d.calculator', searchStrings: SEARCHSTRING_RSA),
      GCWTool(tool: RSANCalculator(), i18nPrefix: 'rsa_n.calculator', searchStrings: SEARCHSTRING_RSA),
      GCWTool(tool: RSAPhiCalculator(), i18nPrefix: 'rsa_phi.calculator', searchStrings: SEARCHSTRING_RSA),
      ...
      GCWSymbolTableTool(
          symbolKey: 'adlam',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'adlam fulani alkule dandayde lenol mulugol west africa ibrahima abdoulaye barry guinea nigeria liberia'),
      GCWSymbolTableTool(
          symbolKey: 'alchemy', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'alchemy alchemie elements elemente '),
      GCWSymbolTableTool(symbolKey: 'alchemy_alphabet', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'alchemie alchemy '),
      GCWSymbolTableTool(
          symbolKey: 'angerthas_cirth',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'angerthas cirth runen runes zwerge dwarfs derherrderringe elben elbisch elves elvish thelordoftherings j.r.r. jrr tolkien'),
      GCWSymbolTableTool(
      ...
      GCWSymbolTableTool(symbolKey: 'antiker', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'antiker stargate '),
      GCWSymbolTableTool(
          symbolKey: 'arabic_indian_numerals',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'arabisches indisches arabic indian arabian arabien indien zahlen ziffern numbers numerals'),
      GCWSymbolTableTool(
          symbolKey: 'arcadian',
          searchStrings: SEARCHSTRING_SYMBOLTABLES + 'skies of arcadia arcadian greek arkadischer arkadien '),
      GCWSymbolTableTool(symbolKey: 'ath', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'ath baronh '),
      GCWSymbolTableTool(
          symbolKey: 'atlantean',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
      ...
      GCWSymbolTableTool(
          ...
          searchStrings:
              SEARCHSTRING_SYMBOLTABLES + SEARCHSTRING_SYMBOLTABLES_SIGNLANGUAGE + 'australian australisches auslan '),
      GCWSymbolTableTool(
          symbolKey: 'babylonian_numerals',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              ' babylonisches babylonian zahlen ziffern numbers numerals keilschrift cuneiform'),
      GCWSymbolTableTool(
          symbolKey: 'ballet',
      ...
      GCWSymbolTableTool(
          symbolKey: 'barbier',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'charles barbier nachtschrift militaer military army armee lautschrift dots points punkte tactiles blindenschrift'),
      GCWSymbolTableTool(
          symbolKey: 'barcode39',
          searchStrings: SEARCHSTRING_SYMBOLTABLES + SEARCHSTRING_SYMBOLTABLES_BARCODES + 'barcode39'),
      GCWSymbolTableTool(symbolKey: 'baudot', searchStrings: SEARCHSTRING_SYMBOLTABLES + SEARCHSTRING_CCITT1),
      GCWSymbolTableTool(
          symbolKey: 'birds_on_a_wire',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'birdsonawire voegel vogel auf der leine strippe leitung kabel birds-on-a-wire '),
      GCWSymbolTableTool(symbolKey: 'blox', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'blox semitic semitische '),
      GCWSymbolTableTool(
          symbolKey: 'brahmi_numerals',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'brahmi indisches indian zahlen ziffern numbers numerals aramaeisch kharoshthi hieratisch hieratic aramaic'),
      GCWSymbolTableTool(
          symbolKey: 'braille',
      ...
      GCWSymbolTableTool(
          ...
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              SEARCHSTRING_SYMBOLTABLES_SIGNLANGUAGE +
              'grossbritannien grossbritanien bsl greatbritain british grossbritisch englisch english'),
      GCWSymbolTableTool(
          symbolKey: 'chappe_v1', searchStrings: SEARCHSTRING_SYMBOLTABLES + SEARCHSTRING_SYMBOLTABLES_CHAPPE),
      GCWSymbolTableTool(
          symbolKey: 'chappe_v2', searchStrings: SEARCHSTRING_SYMBOLTABLES + SEARCHSTRING_SYMBOLTABLES_CHAPPE),
      GCWSymbolTableTool(
          symbolKey: 'chappe_v3', searchStrings: SEARCHSTRING_SYMBOLTABLES + SEARCHSTRING_SYMBOLTABLES_CHAPPE),
      GCWSymbolTableTool(
          symbolKey: 'cherokee',
      ...
      GCWSymbolTableTool(symbolKey: 'cistercian', searchStrings: SEARCHSTRING_SYMBOLTABLES + SEARCHSTRING_CISTERCIAN),
      GCWSymbolTableTool(
          symbolKey: 'color_code',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'colorcode colourcode rgb farbcode farben colors red green blue rot gruen blau colours '),
      GCWSymbolTableTool(
          symbolKey: 'color_honey',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'colorhoney color-honey farbcode farben colors six bees honeycombs bienenwaben colours colourcode colourhoney colour-honey '),
      GCWSymbolTableTool(
          symbolKey: 'color_tokki',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'colortokki color-tokki farbcode woven carpet webteppich gewebter farben colors six colourtokki colours colour-tokko '),
      GCWSymbolTableTool(
          symbolKey: 'cyrillic',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'cyrillic kyrillisches russisches russian slawisch slavian slavic cyrl saloniki '),
      GCWSymbolTableTool(
          symbolKey: 'cyrillic_numbers',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'cyrillic kyrillisches russisches russian slawisch slavian slavic cyrl saloniki '),
      GCWSymbolTableTool(symbolKey: 'daedric', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'daedric theelderscrolls '),
      GCWSymbolTableTool(symbolKey: 'dagger', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'dagger degen dolche '),
      GCWSymbolTableTool(
          symbolKey: 'dancing_men',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'dancingmen tanzende strichmaennchen sherlockholmes matchstickman arthurconandoyle arthurdoyle '),
      GCWSymbolTableTool(
          symbolKey: 'deafblind', searchStrings: SEARCHSTRING_SYMBOLTABLES + SEARCHSTRING_SYMBOLTABLES_SIGNLANGUAGE),
      GCWSymbolTableTool(
          symbolKey: 'devanagari_numerals',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'devanagari indisches indian indien sanskrit prakrit hindi marathi zahlen ziffern numbers numerals'),
      GCWSymbolTableTool(symbolKey: 'dni', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'dni d\'ni myst'),
      GCWSymbolTableTool(
          symbolKey: 'dni_colors', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'dni colours colors farben d\'ni myst'),
      GCWSymbolTableTool(
      ...
      GCWSymbolTableTool(
          symbolKey: 'doremi',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'doremifalamiresisol notesystem musictheory musiktheorie solmisation notensystem tonstufen degrees octal oktal'),
      GCWSymbolTableTool(
          symbolKey: 'dragon_language',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'theelderscrolls skyrim dragonish dragonlanguage drachenschrift dragontongue draconian simplydovah drachenschrift dragonsfont tamriel dragonborn dovahkiin dragonshouts fantasy'),
      GCWSymbolTableTool(
          symbolKey: 'dragon_runes',
          searchStrings:
              SEARCHSTRING_SYMBOLTABLES + 'dragonrunes drachenrunen dragonlords drunes d-runes drunen d-runen '),
      GCWSymbolTableTool(
          symbolKey: 'eastern_arabic_indian_numerals',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'oestliche ostarabische ostarabisch-indische eastern arabische indische arabic arabian arabien indian indien persisch persian urdu zahlen ziffern numbers numerals'),
      GCWSymbolTableTool(
          symbolKey: 'egyptian_numerals',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'altaegyptische eyptian numerals zahlen ziffern numbers hieroglyphs hieroglyphen '),
      GCWSymbolTableTool(
          symbolKey: 'elia',
      ...
      GCWSymbolTableTool(
          symbolKey: 'enochian',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'enochian henochisch john dee magische sprache magie language edward kelley henoic'),
      GCWSymbolTableTool(
          symbolKey: 'eurythmy',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'anthroposophisches anthroposophics eurythmics eurythmie waldorfschulen rudolfsteiner tanzdeinennamen danceyourname'),
      GCWSymbolTableTool(
          symbolKey: 'fakoo', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'fakoo alphabet blinde eyeless relief'),
      GCWSymbolTableTool(
          symbolKey: 'finger', searchStrings: SEARCHSTRING_SYMBOLTABLES + SEARCHSTRING_SYMBOLTABLES_SIGNLANGUAGE),
      GCWSymbolTableTool(
      ...
      GCWSymbolTableTool(
          ...
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'flags flaggen wimpel fahnen deutsche kriegsmarine german warnavy flaggenalphabet flagalphabet '),
      GCWSymbolTableTool(
          symbolKey: 'flags_nato',
          searchStrings:
              SEARCHSTRING_SYMBOLTABLES + 'flags flaggen wimpel fahnen nato army armee flaggenalphabet flagalphabet '),
      GCWSymbolTableTool(symbolKey: 'fonic', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'fonic talesoftheabyss '),
      GCWSymbolTableTool(
          symbolKey: 'four_triangles',
          searchStrings: SEARCHSTRING_SYMBOLTABLES + 'fourtriangles vierdreiecke punkte points dots'),
      GCWSymbolTableTool(symbolKey: 'freemason', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'freemasons freimaurer '),
      GCWSymbolTableTool(
          symbolKey: 'freemason_v2', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'freemasons freimaurer '),
      GCWSymbolTableTool(symbolKey: 'futurama', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'futurama mattgroening '),
      GCWSymbolTableTool(symbolKey: 'futurama_2', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'futurama mattgroening'),
      GCWSymbolTableTool(
          symbolKey: 'gallifreyan',
          searchStrings: SEARCHSTRING_SYMBOLTABLES + 'doctorwho timelords gallifreyan gallifreyisch drwho'),
      GCWSymbolTableTool(
          symbolKey: 'gargish', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'gargish gargisch ultimaonline '),
      GCWSymbolTableTool(symbolKey: 'genreich', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'genreich genrich '),
      GCWSymbolTableTool(
          symbolKey: 'glagolitic',
          searchStrings:
              SEARCHSTRING_SYMBOLTABLES + 'glagolitic glagolitisch glagoliza glagolitsa slawische slavic slavian '),
      GCWSymbolTableTool(
          symbolKey: 'gnommish',
      ...
      GCWSymbolTableTool(
          symbolKey: 'hazard',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'hazardsigns gefahren warningsigns gebotsschilder gebotszeichen verbotsschilder verbotszeichen warnschilder warnzeichen BGVA8 DINENISO7010 ASRA1.3'),
      GCWSymbolTableTool(
          symbolKey: 'hebrew', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'hebrew hebraeisches jews juden'),
      GCWSymbolTableTool(
          symbolKey: 'hebrew_v2', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'hebrew hebraeisches jews juden'),
      GCWSymbolTableTool(
          symbolKey: 'hexahue',
          searchStrings:
              SEARCHSTRING_SYMBOLTABLES + 'colours colors colorcodes colourcodes hexahue farben farbcodes pixel '),
      GCWSymbolTableTool(
          symbolKey: 'hieratic_numerals',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'hieratic numbers numerals zahlen ziffern hieratische altaegyptische egyptian hieroglyphs hieroglyphen '),
      GCWSymbolTableTool(
          symbolKey: 'hobbit_runes',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'hobbits halblinge dwarf dwarves zwerge altenglisch old english erebor mondrunen moonrunes derherrderringe thelordoftherings j.r.r. jrr tolkien'),
      GCWSymbolTableTool(symbolKey: 'hvd', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'hvd '),
      GCWSymbolTableTool(
      ...
      GCWSymbolTableTool(
          ...
          searchStrings:
              SEARCHSTRING_SYMBOLTABLES_HYLIAN + 'daemmerungsprinzessin twilightprincess gcn nintendo gamecube'),
      GCWSymbolTableTool(
      ...
      GCWSymbolTableTool(symbolKey: 'hymmnos', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'hymmnos artonelico '),
      GCWSymbolTableTool(
          symbolKey: 'iching',
          searchStrings: SEARCHSTRING_SYMBOLTABLES + 'iching itsching chinese chinesisches hexagramm '),
      GCWSymbolTableTool(
          symbolKey: 'illuminati_v1', searchStrings: SEARCHSTRING_SYMBOLTABLES + SEARCHSTRING_SYMBOLTABLES_ILLUMINATI),
      GCWSymbolTableTool(
          symbolKey: 'illuminati_v2', searchStrings: SEARCHSTRING_SYMBOLTABLES + SEARCHSTRING_SYMBOLTABLES_ILLUMINATI),
      GCWSymbolTableTool(
      ...
      GCWSymbolTableTool(
          symbolKey: 'iokharic',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'drachenrunen drachenschrift dungeons&dragons drachensprache dragonscript dragonlanguage mandarinstylizedrunictypeface dungeonsanddragons iokharic lokharic draconicgrates wizardsofthecoasts chromaticdragonsbook chinesischerstil runen elbisch)'),
      GCWSymbolTableTool(
      ...
      GCWSymbolTableTool(
          ...
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'boyscouts pfadfinder kabouter niederlaendisch kobolde cobolds netherlands dutch hollaendisch holland scouting nederlands bambilie bambiliaanse gnoms gnome'),
      GCWSymbolTableTool(
          symbolKey: 'kabouter_abc_1947',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'boyscouts pfadfinder kabouter niederlaendisch kobolde cobolds netherlands dutch hollaendisch holland scouting nederlands bambilie bambiliaanse gnoms gnome 1947'),
      GCWSymbolTableTool(
          symbolKey: 'kartrak',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              SEARCHSTRING_SYMBOLTABLES_BARCODES +
              'freighttrains freight gueter fracht coach waggon wagon wagen kartrak aci automaticcaridentification railway gueterzug colouredbarcode coloredbarcode farbigerstrichcode colours rfid gueterzuege '),
      GCWSymbolTableTool(
          symbolKey: 'kharoshthi',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'kharoshthi gandhari gandhara indian indien indisches pakistan afghanistan prakrit sanskrit'),
      GCWSymbolTableTool(
          symbolKey: 'klingon',
          searchStrings:
              SEARCHSTRING_SYMBOLTABLES + 'startrek klingonisch klingonen klingons klingonlanguageinstitute kli '),
      GCWSymbolTableTool(
          symbolKey: 'klingon_klinzhai',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'startrek klinzhai klingonen klingonisches mandelschrift ussenterprise u.s.s.enterprise officersmanual officer\'smanual'),
      GCWSymbolTableTool(
          symbolKey: 'krempel',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'ralfkrempel farbcode farben colorcode colourcode rot red gelb yellow gruen green blau blue boxes kastchen'),
      GCWSymbolTableTool(
          symbolKey: 'krypton', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'kryptonisch superman kryptonite '),
      GCWSymbolTableTool(
          symbolKey: 'lorm',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'blind tactiles blindenschrift lormen deafmute deaf-mute deafblind hearing loss deaf-blind taub-stumme taubstumme gehoerlose haende hands '),
      GCWSymbolTableTool(symbolKey: 'magicode', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'magicode '),
      GCWSymbolTableTool(symbolKey: 'marain', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'marain iain banks '),
      GCWSymbolTableTool(symbolKey: 'marain_v2', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'marain iain banks '),
      GCWSymbolTableTool(symbolKey: 'matoran', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'matoran lego bionicles '),
      GCWSymbolTableTool(
          symbolKey: 'maya_numerals', searchStrings: SEARCHSTRING_SYMBOLTABLES + SEARCHSTRING_MAYANUMBERS),
      GCWSymbolTableTool(symbolKey: 'maze', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'maze labyrinth irrgarten '),
      GCWSymbolTableTool(symbolKey: 'minimoys', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'minimoys arthur '),
      GCWSymbolTableTool(
          symbolKey: 'moon',
          searchStrings:
              SEARCHSTRING_SYMBOLTABLES + 'william moonalphabet reliefs mondalphabet reliefe eyeless blinded '),
      GCWSymbolTableTool(
          symbolKey: 'murray',
          searchStrings:
              SEARCHSTRING_SYMBOLTABLES + 'george murray telex shuttertelegraph klappentelegraph klappentelegraf '),
      GCWSymbolTableTool(symbolKey: 'murraybaudot', searchStrings: SEARCHSTRING_SYMBOLTABLES + SEARCHSTRING_CCITT2),
      GCWSymbolTableTool(
          symbolKey: 'musica',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'wcmusicabta christophe feray instruments instrumente piano klavier schlagzeug floete oboe bratsche trompete gitarre guitar drums posaune geige noten notes violin fleet fluegel'),
      GCWSymbolTableTool(
          symbolKey: 'new_zealand_sign_language',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              SEARCHSTRING_SYMBOLTABLES_SIGNLANGUAGE +
              ' newzealand neuseeland neuseelaendisches'),
      GCWSymbolTableTool(
          symbolKey: 'notes_doremi',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              SEARCHSTRING_SYMBOLTABLES_MUSIC_NOTES +
              'doremifalamiresisol notesystem solmisation notensystem tonstufen degrees octal oktal'),
      GCWSymbolTableTool(
          symbolKey: 'notes_names_altoclef',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              SEARCHSTRING_SYMBOLTABLES_MUSIC_NOTES +
              'notenames notennamen altoclef altschluessel tonleiter scale bassvorzeichen kreuzvorzeichen hashtag flat sharp'),
      GCWSymbolTableTool(
          symbolKey: 'notes_names_bassclef',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              SEARCHSTRING_SYMBOLTABLES_MUSIC_NOTES +
              'notenames notennamen bassclef bassschluessel tonleiter scale bassvorzeichen kreuzvorzeichen hashtag flat sharp'),
      GCWSymbolTableTool(
          symbolKey: 'notes_names_trebleclef',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              SEARCHSTRING_SYMBOLTABLES_MUSIC_NOTES +
              'notenames notennamen trebleclef violinschluessel tonleiter scale bassvorzeichen kreuzvorzeichen hashtag flat sharp'),
      GCWSymbolTableTool(
      ...
      GCWSymbolTableTool(symbolKey: 'pipeline', searchStrings: SEARCHSTRING_SYMBOLTABLES + '3d pipes pipelines rohre '),
      GCWSymbolTableTool(symbolKey: 'pixel', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'pixel '),
      GCWSymbolTableTool(
          symbolKey: 'planet',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              SEARCHSTRING_SYMBOLTABLES_BARCODES +
              'planet united states postal service usps '),
      GCWSymbolTableTool(symbolKey: 'pokemon_unown', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'pokemon unown'),
      GCWSymbolTableTool(
          symbolKey: 'postnet',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              SEARCHSTRING_SYMBOLTABLES_BARCODES +
              'postnet united states postal service usps '),
      GCWSymbolTableTool(symbolKey: 'puzzle', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'puzzles puzzleteile jigsaw '),
      GCWSymbolTableTool(
          symbolKey: 'quadoo',
          searchStrings: SEARCHSTRING_SYMBOLTABLES + 'quadoo blindenschrift tactiles reliefschrift '),
      GCWSymbolTableTool(symbolKey: 'reality', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'reality realitaet '),
      GCWSymbolTableTool(
          symbolKey: 'red_herring', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'roter hering red herring fische fish'),
      GCWSymbolTableTool(
          symbolKey: 'resistor', searchStrings: SEARCHSTRING_SYMBOLTABLES + SEARCHSTRING_RESISTOR_COLORCODE),
      GCWSymbolTableTool(
        symbolKey: 'rhesus_a',
        searchStrings: SEARCHSTRING_SYMBOLTABLES +
            'rhesusa tintenkleckse farbkleckse farbspritzer blutspritzer inkblots bloodsplatter blutgruppen bloodgroup bloodtype bluttropfen blutstropfen farbtropfen',
      ),
      GCWSymbolTableTool(
          symbolKey: 'rm4scc',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              SEARCHSTRING_SYMBOLTABLES_BARCODES +
              'rm4scc royalmail4statecustomercode cleanmail postcodes delivery point cbc kix klantindex england singapore niederlande netherlands singapur holland switzerland schweiz austria oesterreich denmark daenemark australia australien'),
      GCWSymbolTableTool(
          symbolKey: 'romulan', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'startrek romulans romulaner romulanisch '),
      GCWSymbolTableTool(symbolKey: 'runes', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'runes runen '),
      GCWSymbolTableTool(
          symbolKey: 'sanluca',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'ndrangheta mafia codic di san luca sanluca kalabrian kalabrien kalabrische cosa nostra lobardei piemont ligurien emilia romagna stele di rosetta stein'),
      GCWSymbolTableTool(
          symbolKey: 'sarati',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'thesaratiofrumil tirionsarati rumilofvalinor ardainthevalian thetengwarofrumil sarati lautschrift spokenlanguage schriftsystem j.r.r. jrr tolkien rumil quenya elves elvish elbisches elben thelordoftherings derherrderringe'),
      GCWSymbolTableTool(
          symbolKey: 'semaphore',
          searchStrings: SEARCHSTRING_SYMBOLTABLES + 'flags semaphores winkeralphabet flaggenalphabet'),
      GCWSymbolTableTool(
          symbolKey: 'sign', searchStrings: SEARCHSTRING_SYMBOLTABLES + SEARCHSTRING_SYMBOLTABLES_SIGNLANGUAGE),
      GCWSymbolTableTool(
          symbolKey: 'skullz',
          searchStrings:
              SEARCHSTRING_SYMBOLTABLES + 'skull skullz skulls totenkopf totenkoepfe schaedel pirates piraten'),
      GCWSymbolTableTool(
          symbolKey: 'slash_and_pipe', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'schraegstrich slash pipe'),
      GCWSymbolTableTool(
          symbolKey: 'solmisation',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'doremifalamiresisol notesystem musictheory musiktheorie solmisation notensystem tonstufen degrees octal oktal'),
      GCWSymbolTableTool(symbolKey: 'space_invaders', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'space invaders '),
      GCWSymbolTableTool(
          symbolKey: 'spintype', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'spintype boxes kaestchen kasten '),
      GCWSymbolTableTool(
      ...
      GCWSymbolTableTool(
          ...
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'suetterlin germanhandwritingscript schreibschrift ausgangsschrift kurrentschrift'),
      GCWSymbolTableTool(symbolKey: 'sunuz', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'sunuz tekumel '),
      GCWSymbolTableTool(
          symbolKey: 'tamil_numerals',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'tamil indisches indian indien dravidisch dravidian zahlen ziffern numbers numerals'),
      GCWSymbolTableTool(
          symbolKey: 'templers', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'templers tempelritter templeknights '),
      GCWSymbolTableTool(symbolKey: 'tenctonese', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'tenctonese aliennation '),
      GCWSymbolTableTool(
          symbolKey: 'tengwar_beleriand',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'thelordoftherings derherrderringe jrrtolkien j.r.r.tolkien quenya tengwar elben elves elbisches elvish mittelerde middleearth thirdera dritteszeitalter beleriand feanor'),
      GCWSymbolTableTool(
          symbolKey: 'tengwar_classic',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'thelordoftherings derherrderringe jrrtolkien j.r.r.tolkien quenya tengwar elben elves elbisches elvish mittelerde middleearth thirdera dritteszeitalter classices classic feabnor classical klassischer'),
      GCWSymbolTableTool(
          symbolKey: 'tengwar_general',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'thelordoftherings derherrderringe jrrtolkien j.r.r.tolkien quenya tengwar elben elves elbisches elvish mittelerde middleearth thirdera dritteszeitalter generale general feanor'),
      GCWSymbolTableTool(
          symbolKey: 'terzi',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'francesco lana de terzi alphabet square dots punkte points quadrat alphabet blindenschrift braille eyeless relief taktil tactiles'),
      GCWSymbolTableTool(
          symbolKey: 'theban',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'thebanisches hexenalphabet onorius witches witchalphabet engelsschrift angels wikka wicca wicka'),
      GCWSymbolTableTool(
      ...
      GCWSymbolTableTool(
          symbolKey: 'tines',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'gaunerzinken rotwelsch gaunersprache crook language tines prong fahrendes volk traveling people tramp'),
      GCWSymbolTableTool(symbolKey: 'tomtom', searchStrings: SEARCHSTRING_SYMBOLTABLES + SEARCHSTRING_TOMTOM),
      GCWSymbolTableTool(
          symbolKey: 'trafficsigns_germany',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'trafficsigns germany deutschland verkehrszeichen verkehrsschilder roadsigns strassenschilder'),
      GCWSymbolTableTool(
          symbolKey: 'ulog',
      ...
      GCWSymbolTableTool(
          symbolKey: 'utopian',
          searchStrings:
              SEARCHSTRING_SYMBOLTABLES + 'utopian utopisch utopiensiumalphabetum thomasmore vtopiensiumalphabetum'),
      GCWSymbolTableTool(
      ...
      GCWSymbolTableTool(
          symbolKey: 'vulcanian',
          searchStrings:
              SEARCHSTRING_SYMBOLTABLES + 'vulcanian startrek vulkanier misterspock mr.spock mrspock vulkanisch'),
      GCWSymbolTableTool(
          symbolKey: 'wakandan',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'wakandanisches wakandisches blackpanther marvel chadwickboseman schwarzerpanther '),
      GCWSymbolTableTool(
          symbolKey: 'webdings',
          searchStrings:
              SEARCHSTRING_SYMBOLTABLES + 'microsoftwindows ms systemschrift systemfont webdings wingdings windings'),
      GCWSymbolTableTool(
          symbolKey: 'windforce_beaufort', searchStrings: SEARCHSTRING_SYMBOLTABLES + SEARCHSTRING_BEAUFORT),
      GCWSymbolTableTool(
          symbolKey: 'windforce_knots', searchStrings: SEARCHSTRING_SYMBOLTABLES + SEARCHSTRING_BEAUFORT),
      GCWSymbolTableTool(
          symbolKey: 'window',
      ...
      GCWSymbolTableTool(
          symbolKey: 'wingdings',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'microsoftwindows ms systemschrift systemfont symbole symbols haende hands zahlenimkreis numbersincircle clock arrows pfeile stars sterne wingdings windings'),
      GCWSymbolTableTool(
          symbolKey: 'wingdings2',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'microsoftwindows ms systemschrift symbole buero haende hands zahlenimkreis numbersincircle clock stars sterne systemfont wingdings2 windings2'),
      GCWSymbolTableTool(
          symbolKey: 'wingdings3',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'microsoftwindows ms systemschrift systemfont symbole symbols arrows pfeile wingdings3 windings3'),
      GCWSymbolTableTool(symbolKey: 'yan_koryani', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'yankoryani tekumel '),
      GCWSymbolTableTool(
          symbolKey: 'yinyang',
          searchStrings: SEARCHSTRING_SYMBOLTABLES +
              'suedkorea flagge kolumbien columbia erikmoreno yinyang jingjing yingyang southkorea'),
      GCWSymbolTableTool(
          symbolKey: 'zentradi', searchStrings: SEARCHSTRING_SYMBOLTABLES + 'zentradi zentraedi robotech macross '),
      GCWSymbolTableTool(
      ...
      // TomTomSelection *********************************************************************************************
      GCWTool(tool: TomTom(), i18nPrefix: 'tomtom', searchStrings: SEARCHSTRING_TOMTOM),

      //VanitySelection **********************************************************************************************
      GCWTool(tool: VanitySingleNumbers(), i18nPrefix: 'vanity_singlenumbers', searchStrings: SEARCHSTRING_VANITY),
      GCWTool(tool: VanityMultipleNumbers(), i18nPrefix: 'vanity_multiplenumbers', searchStrings: SEARCHSTRING_VANITY),
      ...
      GCWTool(tool: Vigenere(), i18nPrefix: 'vigenere', searchStrings: SEARCHSTRING_VIGENERE),
      GCWTool(tool: Gronsfeld(), i18nPrefix: 'gronsfeld', searchStrings: SEARCHSTRING_VIGENERE + 'gronsfeld'),
      GCWTool(
          tool: Trithemius(),
