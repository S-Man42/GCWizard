...
class Registry {
  ...
  static final SEARCHSTRING_ROTATION = 'rotations rotx rotn rot-x rotationen ';
  ...
  static final SEARCHSTRING_VANITY = 'telefontasten telephone keys buttons numbers ziffern telefonnummern vanity keypad ';
