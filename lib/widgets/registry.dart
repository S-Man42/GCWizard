  ...
  static initialize(BuildContext context) {
    toolList = [
      ...
      GCWTool(
        ...
        category: ToolCategory.SCIENCE_AND_TECHNOLOGY,
        searchStrings: [
          SEARCHSTRING_COMMON_DECABIT, SEARCHSTRING_DE_DECABIT, SEARCHSTRING_EN_DECABIT, SEARCHSTRING_FR_DECABIT
        ]
      ),
      GCWTool(
        tool: DNASelection(),
      ...
      GCWTool(
        ...
        category: ToolCategory.SCIENCE_AND_TECHNOLOGY,
        searchStrings: [
          SEARCHSTRING_COMMON_DTMF, SEARCHSTRING_DE_DTMF, SEARCHSTRING_EN_DTMF, SEARCHSTRING_FR_DTMF
        ]
      ),
      GCWTool(
        tool: EnclosedAreas(),
        ...
        category: ToolCategory.CRYPTOGRAPHY,
        searchStrings: [
          SEARCHSTRING_COMMON_ENCLOSEDAREAS, SEARCHSTRING_DE_ENCLOSEDAREAS, SEARCHSTRING_EN_ENCLOSEDAREAS, SEARCHSTRING_FR_ENCLOSEDAREAS
        ]
      ),
      GCWTool(
        tool: ESelection(),
      ...
      GCWTool(
        ...
        category: ToolCategory.CRYPTOGRAPHY,
        searchStrings: [
          SEARCHSTRING_COMMON_GADE, SEARCHSTRING_DE_GADE, SEARCHSTRING_EN_GADE, SEARCHSTRING_FR_GADE
        ]
      ),
      GCWTool(
        tool: GCCode(),
        ...
        category: ToolCategory.CRYPTOGRAPHY,
        searchStrings: [
          SEARCHSTRING_COMMON_GCCODE, SEARCHSTRING_DE_GCCODE, SEARCHSTRING_EN_GCCODE, SEARCHSTRING_FR_GCCODE
        ]
      ),
      GCWTool(
      ...
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_BINARY, SEARCHSTRING_DE_BINARY, SEARCHSTRING_EN_BINARY, SEARCHSTRING_FR_BINARY,
          SEARCHSTRING_COMMON_GRAY, SEARCHSTRING_DE_GRAY, SEARCHSTRING_EN_GRAY, SEARCHSTRING_FR_GRAY
        ]
      ),
      GCWTool(
        tool: HashSelection(),
      ...
      GCWTool(
        ...
        category: ToolCategory.SCIENCE_AND_TECHNOLOGY,
        searchStrings: [
          SEARCHSTRING_COMMON_HEXADECIMAL, SEARCHSTRING_DE_HEXADECIMAL, SEARCHSTRING_EN_HEXADECIMAL, SEARCHSTRING_FR_HEXADECIMAL
        ]
      ),
      GCWTool(
        tool: Homophone(),
        ...
        category: ToolCategory.CRYPTOGRAPHY,
        searchStrings: [
          SEARCHSTRING_COMMON_HOMOPHONE, SEARCHSTRING_DE_HOMOPHONE, SEARCHSTRING_EN_HOMOPHONE, SEARCHSTRING_FR_HOMOPHONE
        ]
      ),
      GCWTool(
        tool: Kamasutra(),
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_ROTATION, SEARCHSTRING_DE_ROTATION, SEARCHSTRING_EN_ROTATION, SEARCHSTRING_FR_ROTATION,
          SEARCHSTRING_COMMON_KAMASUTRA, SEARCHSTRING_DE_KAMASUTRA, SEARCHSTRING_EN_KAMASUTRA, SEARCHSTRING_FR_KAMASUTRA
        ]
      ),
      GCWTool(
        tool: Kenny(),
        ...
        category: ToolCategory.CRYPTOGRAPHY,
        searchStrings: [
          SEARCHSTRING_COMMON_KENNY, SEARCHSTRING_DE_KENNY, SEARCHSTRING_EN_KENNY, SEARCHSTRING_FR_KENNY
        ]
      ),
      GCWTool(
        tool: Keyboard(),
        ...
        category: ToolCategory.SCIENCE_AND_TECHNOLOGY,
        searchStrings: [
          SEARCHSTRING_COMMON_KEYBOARD, SEARCHSTRING_DE_KEYBOARD, SEARCHSTRING_EN_KEYBOARD, SEARCHSTRING_FR_KEYBOARD
        ]
      ),
      GCWTool(
      ...
      GCWTool(
        ...
        category: ToolCategory.CRYPTOGRAPHY,
        searchStrings: [
          SEARCHSTRING_COMMON_MAYANUMBERS, SEARCHSTRING_DE_MAYANUMBERS, SEARCHSTRING_EN_MAYANUMBERS, SEARCHSTRING_FR_MAYANUMBERS
        ]
      ),
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_CIPHERWHEEL, SEARCHSTRING_DE_CIPHERWHEEL, SEARCHSTRING_EN_CIPHERWHEEL, SEARCHSTRING_FR_CIPHERWHEEL,
          SEARCHSTRING_COMMON_MEXICANARMYCIPHERWHEEL, SEARCHSTRING_DE_MEXICANARMYCIPHERWHEEL, SEARCHSTRING_EN_MEXICANARMYCIPHERWHEEL, SEARCHSTRING_FR_MEXICANARMYCIPHERWHEEL
        ]
      ),
      GCWTool(
        tool: Morse(),
        ...
        category: ToolCategory.CRYPTOGRAPHY,
        searchStrings: [
          SEARCHSTRING_COMMON_MORSE, SEARCHSTRING_DE_MORSE, SEARCHSTRING_EN_MORSE, SEARCHSTRING_FR_MORSE
        ]
      ),
      GCWTool(
        tool: MultiDecoder(),
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_MULTIDECODER, SEARCHSTRING_DE_MULTIDECODER, SEARCHSTRING_EN_MULTIDECODER, SEARCHSTRING_FR_MULTIDECODER
        ]
      ),
      GCWTool(
      ...
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_BINARY, SEARCHSTRING_DE_BINARY, SEARCHSTRING_EN_BINARY, SEARCHSTRING_FR_BINARY,
          SEARCHSTRING_COMMON_NUMERALBASES, SEARCHSTRING_DE_NUMERALBASES, SEARCHSTRING_EN_NUMERALBASES, SEARCHSTRING_FR_NUMERALBASES
        ]
      ),
      GCWTool(
        ...
        category: ToolCategory.CRYPTOGRAPHY,
        searchStrings: [
          SEARCHSTRING_COMMON_NUMERALWORDS, SEARCHSTRING_DE_NUMERALWORDS, SEARCHSTRING_EN_NUMERALWORDS, SEARCHSTRING_FR_NUMERALWORDS
        ]
      ),
      GCWTool(
        tool: OneTimePad(),
        ...
        category: ToolCategory.CRYPTOGRAPHY,
        searchStrings: [
          SEARCHSTRING_COMMON_ONETIMEPAD, SEARCHSTRING_DE_ONETIMEPAD, SEARCHSTRING_EN_ONETIMEPAD, SEARCHSTRING_FR_ONETIMEPAD
        ]
      ),
      GCWTool(
        ...
        category: ToolCategory.SCIENCE_AND_TECHNOLOGY,
        searchStrings: [
          SEARCHSTRING_COMMON_PERIODICTABLE, SEARCHSTRING_DE_PERIODICTABLE, SEARCHSTRING_EN_PERIODICTABLE, SEARCHSTRING_FR_PERIODICTABLE
        ]
      ),
      GCWTool(
        tool: PhiSelection(),
      ...
      GCWTool(
        ...
        category: ToolCategory.CRYPTOGRAPHY,
        searchStrings: [
          SEARCHSTRING_COMMON_PLAYFAIR, SEARCHSTRING_DE_PLAYFAIR, SEARCHSTRING_EN_PLAYFAIR, SEARCHSTRING_FR_PLAYFAIR
        ]
      ),
      GCWTool(
        tool: Polybios(),
        ...
        category: ToolCategory.CRYPTOGRAPHY,
        searchStrings: [
          SEARCHSTRING_COMMON_POLYBIOS, SEARCHSTRING_DE_POLYBIOS, SEARCHSTRING_EN_POLYBIOS, SEARCHSTRING_FR_POLYBIOS
        ]
      ),
      GCWTool(
      ...
      GCWTool(
        ...
        category: ToolCategory.SCIENCE_AND_TECHNOLOGY,
        searchStrings: [
          SEARCHSTRING_COMMON_PROJECTILES, SEARCHSTRING_DE_PROJECTILES, SEARCHSTRING_EN_PROJECTILES, SEARCHSTRING_FR_PROJECTILES
        ]
      ),
      GCWTool(
        tool: RailFence(),
      ...
      GCWTool(
        ...
        category: ToolCategory.SCIENCE_AND_TECHNOLOGY,
        searchStrings: [
          SEARCHSTRING_COMMON_UNITCONVERTER, SEARCHSTRING_DE_UNITCONVERTER, SEARCHSTRING_EN_UNITCONVERTER, SEARCHSTRING_FR_UNITCONVERTER
        ]
      ),
      GCWTool(
        ...
        category: ToolCategory.SCIENCE_AND_TECHNOLOGY,
        searchStrings: [
          SEARCHSTRING_COMMON_VANITY, SEARCHSTRING_DE_VANITY, SEARCHSTRING_EN_VANITY, SEARCHSTRING_FR_VANITY
        ]
      ),
      GCWTool(
      ...
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_CCITT2, SEARCHSTRING_DE_CCITT2, SEARCHSTRING_EN_CCITT2, SEARCHSTRING_FR_CCITT2,
          SEARCHSTRING_COMMON_Z22, SEARCHSTRING_DE_Z22, SEARCHSTRING_EN_Z22, SEARCHSTRING_FR_Z22
        ]
      ),
      ...
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_APPARENTTEMPERATURE, SEARCHSTRING_DE_APPARENTTEMPERATURE, SEARCHSTRING_EN_APPARENTTEMPERATURE, SEARCHSTRING_FR_APPARENTTEMPERATURE,
          SEARCHSTRING_COMMON_APPARENTTEMPERATURE_HEATINDEX, SEARCHSTRING_DE_APPARENTTEMPERATURE_HEATINDEX, SEARCHSTRING_EN_APPARENTTEMPERATURE_HEATINDEX, SEARCHSTRING_FR_APPARENTTEMPERATURE_HEATINDEX
        ]
      ),
      GCWTool(
        tool: Humidex(),
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_APPARENTTEMPERATURE, SEARCHSTRING_DE_APPARENTTEMPERATURE, SEARCHSTRING_EN_APPARENTTEMPERATURE, SEARCHSTRING_FR_APPARENTTEMPERATURE,
          SEARCHSTRING_COMMON_APPARENTTEMPERATURE_HUMIDEX, SEARCHSTRING_DE_APPARENTTEMPERATURE_HUMIDEX, SEARCHSTRING_EN_APPARENTTEMPERATURE_HUMIDEX, SEARCHSTRING_FR_APPARENTTEMPERATURE_HUMIDEX
        ]
      ),
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_APPARENTTEMPERATURE, SEARCHSTRING_DE_APPARENTTEMPERATURE, SEARCHSTRING_EN_APPARENTTEMPERATURE, SEARCHSTRING_FR_APPARENTTEMPERATURE,
          SEARCHSTRING_COMMON_APPARENTTEMPERATURE_SUMMERSIMMERINDEX, SEARCHSTRING_DE_APPARENTTEMPERATURE_SUMMERSIMMERINDEX, SEARCHSTRING_EN_APPARENTTEMPERATURE_SUMMERSIMMERINDEX, SEARCHSTRING_FR_APPARENTTEMPERATURE_SUMMERSIMMERINDEX
        ]
      ),
      GCWTool(
        tool: Windchill(),
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_APPARENTTEMPERATURE, SEARCHSTRING_DE_APPARENTTEMPERATURE, SEARCHSTRING_EN_APPARENTTEMPERATURE, SEARCHSTRING_FR_APPARENTTEMPERATURE,
          SEARCHSTRING_COMMON_APPARENTTEMPERATURE_WINDCHILL, SEARCHSTRING_DE_APPARENTTEMPERATURE_WINDCHILL, SEARCHSTRING_EN_APPARENTTEMPERATURE_WINDCHILL, SEARCHSTRING_FR_APPARENTTEMPERATURE_WINDCHILL
        ]
      ),
      ...
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_ASTRONOMY, SEARCHSTRING_DE_ASTRONOMY, SEARCHSTRING_EN_ASTRONOMY, SEARCHSTRING_FR_ASTRONOMY,
          SEARCHSTRING_COMMON_ASTRONOMY_RISESET, SEARCHSTRING_DE_ASTRONOMY_RISESET, SEARCHSTRING_EN_ASTRONOMY_RISESET, SEARCHSTRING_FR_ASTRONOMY_RISESET,
          SEARCHSTRING_COMMON_ASTRONOMY_SUN, SEARCHSTRING_DE_ASTRONOMY_SUN, SEARCHSTRING_EN_ASTRONOMY_SUN, SEARCHSTRING_FR_ASTRONOMY_SUN,
          SEARCHSTRING_COMMON_ASTRONOMY_SUNRISESET, SEARCHSTRING_DE_ASTRONOMY_SUNRISESET, SEARCHSTRING_EN_ASTRONOMY_SUNRISESET, SEARCHSTRING_FR_ASTRONOMY_SUNRISESET
        ]
      ),
      GCWTool(
        tool: SunPosition(),
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_ASTRONOMY, SEARCHSTRING_DE_ASTRONOMY, SEARCHSTRING_EN_ASTRONOMY, SEARCHSTRING_FR_ASTRONOMY,
          SEARCHSTRING_COMMON_ASTRONOMY_POSITION, SEARCHSTRING_DE_ASTRONOMY_POSITION, SEARCHSTRING_EN_ASTRONOMY_POSITION, SEARCHSTRING_FR_ASTRONOMY_POSITION,
          SEARCHSTRING_COMMON_ASTRONOMY_SUN, SEARCHSTRING_DE_ASTRONOMY_SUN, SEARCHSTRING_EN_ASTRONOMY_SUN, SEARCHSTRING_FR_ASTRONOMY_SUN
        ]
      ),
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_ASTRONOMY, SEARCHSTRING_DE_ASTRONOMY, SEARCHSTRING_EN_ASTRONOMY, SEARCHSTRING_FR_ASTRONOMY,
          SEARCHSTRING_COMMON_ASTRONOMY_RISESET, SEARCHSTRING_DE_ASTRONOMY_RISESET, SEARCHSTRING_EN_ASTRONOMY_RISESET, SEARCHSTRING_FR_ASTRONOMY_RISESET,
          SEARCHSTRING_COMMON_ASTRONOMY_MOON, SEARCHSTRING_DE_ASTRONOMY_MOON, SEARCHSTRING_EN_ASTRONOMY_MOON, SEARCHSTRING_FR_ASTRONOMY_MOON
        ]
      ),
      GCWTool(
        tool: MoonPosition(),
        ...
        searchStrings: [
          ...
          SEARCHSTRING_COMMON_ASTRONOMY_POSITION, SEARCHSTRING_DE_ASTRONOMY_POSITION, SEARCHSTRING_EN_ASTRONOMY_POSITION, SEARCHSTRING_FR_ASTRONOMY_POSITION,
          SEARCHSTRING_COMMON_ASTRONOMY_MOON, SEARCHSTRING_DE_ASTRONOMY_MOON, SEARCHSTRING_EN_ASTRONOMY_MOON, SEARCHSTRING_FR_ASTRONOMY_MOON,
          SEARCHSTRING_COMMON_ASTRONOMY_MOONPOSITION, SEARCHSTRING_DE_ASTRONOMY_MOONPOSITION, SEARCHSTRING_EN_ASTRONOMY_MOONPOSITION, SEARCHSTRING_FR_ASTRONOMY_MOONPOSITION
        ]
      ),
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_EASTER_DATE, SEARCHSTRING_DE_EASTER_DATE, SEARCHSTRING_EN_EASTER_DATE, SEARCHSTRING_FR_EASTER_DATE
        ]
      ),
      GCWTool(
        tool: Seasons(),
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_ASTRONOMY, SEARCHSTRING_DE_ASTRONOMY, SEARCHSTRING_EN_ASTRONOMY, SEARCHSTRING_FR_ASTRONOMY,
          SEARCHSTRING_COMMON_ASTRONOMY_SEASONS, SEARCHSTRING_DE_ASTRONOMY_SEASONS, SEARCHSTRING_EN_ASTRONOMY_SEASONS, SEARCHSTRING_FR_ASTRONOMY_SEASONS
        ]
      ),
      ...
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_EASTER_DATE, SEARCHSTRING_DE_EASTER_DATE, SEARCHSTRING_EN_EASTER_DATE, SEARCHSTRING_FR_EASTER_DATE,
          SEARCHSTRING_COMMON_EASTER_YEARS, SEARCHSTRING_DE_EASTER_YEARS, SEARCHSTRING_EN_EASTER_YEARS, SEARCHSTRING_FR_EASTER_YEARS
        ]
      ),
      ...
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_CHANGELOG, SEARCHSTRING_DE_CHANGELOG, SEARCHSTRING_EN_CHANGELOG, SEARCHSTRING_FR_CHANGELOG
        ]
      ),
      GCWTool(
        tool: About(),
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_ABOUT, SEARCHSTRING_DE_ABOUT, SEARCHSTRING_EN_ABOUT, SEARCHSTRING_FR_ABOUT
        ]
      ),
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_CALLFORCONTRIBUTION, SEARCHSTRING_DE_CALLFORCONTRIBUTION, SEARCHSTRING_EN_CALLFORCONTRIBUTION, SEARCHSTRING_FR_CALLFORCONTRIBUTION
        ]
      ),
      GCWTool(
        tool: Licenses(),
        i18nPrefix: 'licenses',
        searchStrings: [
          SEARCHSTRING_COMMON_LICENSES, SEARCHSTRING_DE_LICENSES, SEARCHSTRING_EN_LICENSES, SEARCHSTRING_FR_LICENSES
        ]
      ),
      ...
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_NUMBERSEQUENCE, SEARCHSTRING_DE_NUMBERSEQUENCE, SEARCHSTRING_EN_NUMBERSEQUENCE, SEARCHSTRING_FR_NUMBERSEQUENCE,
          SEARCHSTRING_COMMON_NUMBERSEQUENCE_PELLSELECTION, SEARCHSTRING_DE_NUMBERSEQUENCE_PELLSELECTION, SEARCHSTRING_EN_NUMBERSEQUENCE_PELLSELECTION, SEARCHSTRING_FR_NUMBERSEQUENCE_PELLSELECTION,
        ]
      ),
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_NUMBERSEQUENCE, SEARCHSTRING_DE_NUMBERSEQUENCE, SEARCHSTRING_EN_NUMBERSEQUENCE, SEARCHSTRING_FR_NUMBERSEQUENCE,
          SEARCHSTRING_COMMON_NUMBERSEQUENCE_LUCASSELECTION, SEARCHSTRING_DE_NUMBERSEQUENCE_LUCASSELECTION, SEARCHSTRING_EN_NUMBERSEQUENCE_LUCASSELECTION, SEARCHSTRING_FR_NUMBERSEQUENCE_LUCASSELECTION,
        ]
      ),
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_NUMBERSEQUENCE, SEARCHSTRING_DE_NUMBERSEQUENCE, SEARCHSTRING_EN_NUMBERSEQUENCE, SEARCHSTRING_FR_NUMBERSEQUENCE,
          SEARCHSTRING_COMMON_NUMBERSEQUENCE_PELLLUCASSELECTION, SEARCHSTRING_DE_NUMBERSEQUENCE_PELLLUCASSELECTION, SEARCHSTRING_EN_NUMBERSEQUENCE_PELLLUCASSELECTION, SEARCHSTRING_FR_NUMBERSEQUENCE_PELLLUCASSELECTION,
        ]
      ),
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_NUMBERSEQUENCE, SEARCHSTRING_DE_NUMBERSEQUENCE, SEARCHSTRING_EN_NUMBERSEQUENCE, SEARCHSTRING_FR_NUMBERSEQUENCE,
          SEARCHSTRING_COMMON_NUMBERSEQUENCE_JACOBSTHALSELECTION, SEARCHSTRING_DE_NUMBERSEQUENCE_JACOBSTHALSELECTION, SEARCHSTRING_EN_NUMBERSEQUENCE_JACOBSTHALSELECTION, SEARCHSTRING_FR_NUMBERSEQUENCE_JACOBSTHALSELECTION,
        ]
      ),
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_NUMBERSEQUENCE, SEARCHSTRING_DE_NUMBERSEQUENCE, SEARCHSTRING_EN_NUMBERSEQUENCE, SEARCHSTRING_FR_NUMBERSEQUENCE,
          SEARCHSTRING_COMMON_NUMBERSEQUENCE_JACOBSTHALLUCASSELECTION, SEARCHSTRING_DE_NUMBERSEQUENCE_JACOBSTHALLUCASSELECTION, SEARCHSTRING_EN_NUMBERSEQUENCE_JACOBSTHALLUCASSELECTION, SEARCHSTRING_FR_NUMBERSEQUENCE_JACOBSTHALLUCASSELECTION,
        ]
      ),
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_NUMBERSEQUENCE, SEARCHSTRING_DE_NUMBERSEQUENCE, SEARCHSTRING_EN_NUMBERSEQUENCE, SEARCHSTRING_FR_NUMBERSEQUENCE,
          SEARCHSTRING_COMMON_NUMBERSEQUENCE_JACOBSTHALOBLONGSELECTION, SEARCHSTRING_DE_NUMBERSEQUENCE_JACOBSTHALOBLONGSELECTION, SEARCHSTRING_EN_NUMBERSEQUENCE_JACOBSTHALOBLONGSELECTION, SEARCHSTRING_FR_NUMBERSEQUENCE_JACOBSTHALOBLONGSELECTION,
        ]
      ),
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_NUMBERSEQUENCE, SEARCHSTRING_DE_NUMBERSEQUENCE, SEARCHSTRING_EN_NUMBERSEQUENCE, SEARCHSTRING_FR_NUMBERSEQUENCE,
          SEARCHSTRING_COMMON_NUMBERSEQUENCE_CATALANSELECTION, SEARCHSTRING_DE_NUMBERSEQUENCE_CATALANSELECTION, SEARCHSTRING_EN_NUMBERSEQUENCE_CATALANSELECTION, SEARCHSTRING_FR_NUMBERSEQUENCE_CATALANSELECTION,
        ]
      ),
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_NUMBERSEQUENCE, SEARCHSTRING_DE_NUMBERSEQUENCE, SEARCHSTRING_EN_NUMBERSEQUENCE, SEARCHSTRING_FR_NUMBERSEQUENCE,
          SEARCHSTRING_COMMON_NUMBERSEQUENCE_RECAMANSELECTION, SEARCHSTRING_DE_NUMBERSEQUENCE_RECAMANSELECTION, SEARCHSTRING_EN_NUMBERSEQUENCE_RECAMANSELECTION, SEARCHSTRING_FR_NUMBERSEQUENCE_RECAMANSELECTION,
        ]
      ),
      ...
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_NUMBERSEQUENCE, SEARCHSTRING_DE_NUMBERSEQUENCE, SEARCHSTRING_EN_NUMBERSEQUENCE, SEARCHSTRING_FR_NUMBERSEQUENCE,
          SEARCHSTRING_COMMON_NUMBERSEQUENCE_FACTORIALSELECTION, SEARCHSTRING_DE_NUMBERSEQUENCE_FACTORIALSELECTION, SEARCHSTRING_EN_NUMBERSEQUENCE_FACTORIALSELECTION, SEARCHSTRING_FR_NUMBERSEQUENCE_FACTORIALSELECTION,
          SEARCHSTRING_COMMON_NUMBERSEQUENCE_NTHNUMBER, SEARCHSTRING_DE_NUMBERSEQUENCE_NTHNUMBER, SEARCHSTRING_EN_NUMBERSEQUENCE_NTHNUMBER, SEARCHSTRING_FR_NUMBERSEQUENCE_NTHNUMBER
        ]
      ),
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_NUMBERSEQUENCE, SEARCHSTRING_DE_NUMBERSEQUENCE, SEARCHSTRING_EN_NUMBERSEQUENCE, SEARCHSTRING_FR_NUMBERSEQUENCE,
          SEARCHSTRING_COMMON_NUMBERSEQUENCE_FACTORIALSELECTION, SEARCHSTRING_DE_NUMBERSEQUENCE_FACTORIALSELECTION, SEARCHSTRING_EN_NUMBERSEQUENCE_FACTORIALSELECTION, SEARCHSTRING_FR_NUMBERSEQUENCE_FACTORIALSELECTION,
          SEARCHSTRING_COMMON_NUMBERSEQUENCE_RANGE, SEARCHSTRING_DE_NUMBERSEQUENCE_RANGE, SEARCHSTRING_EN_NUMBERSEQUENCE_RANGE, SEARCHSTRING_FR_NUMBERSEQUENCE_RANGE
        ]
      ),
      GCWTool(
        ...
        searchStrings:[
          SEARCHSTRING_COMMON_NUMBERSEQUENCE, SEARCHSTRING_DE_NUMBERSEQUENCE, SEARCHSTRING_EN_NUMBERSEQUENCE, SEARCHSTRING_FR_NUMBERSEQUENCE,
          SEARCHSTRING_COMMON_NUMBERSEQUENCE_FACTORIALSELECTION, SEARCHSTRING_DE_NUMBERSEQUENCE_FACTORIALSELECTION, SEARCHSTRING_EN_NUMBERSEQUENCE_FACTORIALSELECTION, SEARCHSTRING_FR_NUMBERSEQUENCE_FACTORIALSELECTION,
          SEARCHSTRING_COMMON_NUMBERSEQUENCE_CHECKNUMBER, SEARCHSTRING_DE_NUMBERSEQUENCE_CHECKNUMBER, SEARCHSTRING_EN_NUMBERSEQUENCE_CHECKNUMBER, SEARCHSTRING_FR_NUMBERSEQUENCE_CHECKNUMBER
        ]
      ),
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_NUMBERSEQUENCE, SEARCHSTRING_DE_NUMBERSEQUENCE, SEARCHSTRING_EN_NUMBERSEQUENCE, SEARCHSTRING_FR_NUMBERSEQUENCE,
          SEARCHSTRING_COMMON_NUMBERSEQUENCE_FACTORIALSELECTION, SEARCHSTRING_DE_NUMBERSEQUENCE_FACTORIALSELECTION, SEARCHSTRING_EN_NUMBERSEQUENCE_FACTORIALSELECTION, SEARCHSTRING_FR_NUMBERSEQUENCE_FACTORIALSELECTION,
          SEARCHSTRING_COMMON_NUMBERSEQUENCE_DIGITS, SEARCHSTRING_DE_NUMBERSEQUENCE_DIGITS, SEARCHSTRING_EN_NUMBERSEQUENCE_DIGITS, SEARCHSTRING_FR_NUMBERSEQUENCE_DIGITS
        ]
      ),
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_NUMBERSEQUENCE, SEARCHSTRING_DE_NUMBERSEQUENCE, SEARCHSTRING_EN_NUMBERSEQUENCE, SEARCHSTRING_FR_NUMBERSEQUENCE,
          SEARCHSTRING_COMMON_NUMBERSEQUENCE_FACTORIALSELECTION, SEARCHSTRING_DE_NUMBERSEQUENCE_FACTORIALSELECTION, SEARCHSTRING_EN_NUMBERSEQUENCE_FACTORIALSELECTION, SEARCHSTRING_FR_NUMBERSEQUENCE_FACTORIALSELECTION,
          SEARCHSTRING_COMMON_NUMBERSEQUENCE_CONTAINSDIGITS, SEARCHSTRING_DE_NUMBERSEQUENCE_CONTAINSDIGITS, SEARCHSTRING_EN_NUMBERSEQUENCE_CONTAINSDIGITS, SEARCHSTRING_FR_NUMBERSEQUENCE_CONTAINSDIGITS
        ]
      ),
...
,          SEARCHSTRING_COMMON_NUMBERSEQUENCE_NTHNUMBER, SEARCHSTRING_DE_NUMBERSEQUENCE_NTHNUMBER, SEARCHSTRING_EN_NUMBERSEQUENCE_NTHNUMBER, SEARCHSTRING_FR_NUMBERSEQUENCE_NTHNUMBER
      ...
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_NUMERALWORDS, SEARCHSTRING_DE_NUMERALWORDS, SEARCHSTRING_EN_NUMERALWORDS, SEARCHSTRING_FR_NUMERALWORDS,
          SEARCHSTRING_COMMON_NUMERALWORDSTEXTSEARCH, SEARCHSTRING_DE_NUMERALWORDSTEXTSEARCH, SEARCHSTRING_EN_NUMERALWORDSTEXTSEARCH, SEARCHSTRING_FR_NUMERALWORDSTEXTSEARCH
        ]
      ),
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_NUMERALWORDS, SEARCHSTRING_DE_NUMERALWORDS, SEARCHSTRING_EN_NUMERALWORDS, SEARCHSTRING_FR_NUMERALWORDS,
          SEARCHSTRING_COMMON_NUMERALWORDSLISTS, SEARCHSTRING_DE_NUMERALWORDSLISTS, SEARCHSTRING_EN_NUMERALWORDSLISTS, SEARCHSTRING_FR_NUMERALWORDSLISTS
        ]
      ),
      ...
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_PERIODICTABLE, SEARCHSTRING_DE_PERIODICTABLE, SEARCHSTRING_EN_PERIODICTABLE, SEARCHSTRING_FR_PERIODICTABLE,
          SEARCHSTRING_COMMON_PERIODICTABLEDATAVIEW, SEARCHSTRING_DE_PERIODICTABLEDATAVIEW, SEARCHSTRING_EN_PERIODICTABLEDATAVIEW,SEARCHSTRING_FR_PERIODICTABLEDATAVIEW
        ]
      ),
      ...
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_PRIMES, SEARCHSTRING_DE_PRIMES, SEARCHSTRING_EN_PRIMES, SEARCHSTRING_FR_PRIMES,
          SEARCHSTRING_COMMON_PRIMES_NTHPRIME, SEARCHSTRING_DE_PRIMES_NTHPRIME, SEARCHSTRING_EN_PRIMES_NTHPRIME, SEARCHSTRING_FR_PRIMES_NTHPRIME
        ]
      ),
      GCWTool(
        tool: IsPrime(),
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_PRIMES, SEARCHSTRING_DE_PRIMES, SEARCHSTRING_EN_PRIMES, SEARCHSTRING_FR_PRIMES,
          SEARCHSTRING_COMMON_PRIMES_ISPRIME, SEARCHSTRING_DE_PRIMES_ISPRIME, SEARCHSTRING_EN_PRIMES_ISPRIME, SEARCHSTRING_FR_PRIMES_ISPRIME
        ]
      ),
      GCWTool(
        tool: NearestPrime(),
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_PRIMES, SEARCHSTRING_DE_PRIMES, SEARCHSTRING_EN_PRIMES, SEARCHSTRING_FR_PRIMES,
          SEARCHSTRING_COMMON_PRIMES_NEARESTPRIME, SEARCHSTRING_DE_PRIMES_NEARESTPRIME, SEARCHSTRING_EN_PRIMES_NEARESTPRIME, SEARCHSTRING_FR_PRIMES_NEARESTPRIME
        ]
      ),
      GCWTool(
        tool: PrimeIndex(),
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_PRIMES, SEARCHSTRING_DE_PRIMES, SEARCHSTRING_EN_PRIMES, SEARCHSTRING_FR_PRIMES,
          SEARCHSTRING_COMMON_PRIMES_PRIMEINDEX, SEARCHSTRING_DE_PRIMES_PRIMEINDEX, SEARCHSTRING_EN_PRIMES_PRIMEINDEX, SEARCHSTRING_FR_PRIMES_PRIMEINDEX
        ]
      ),
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_PRIMES, SEARCHSTRING_DE_PRIMES, SEARCHSTRING_EN_PRIMES, SEARCHSTRING_FR_PRIMES,
          SEARCHSTRING_COMMON_PRIMES_INTEGERFACTORIZATION, SEARCHSTRING_DE_PRIMES_INTEGERFACTORIZATION, SEARCHSTRING_EN_PRIMES_INTEGERFACTORIZATION, SEARCHSTRING_FR_PRIMES_INTEGERFACTORIZATION
        ]
      ),
      ...
      GCWSymbolTableTool(
        symbolKey: 'adlam',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_ADLAM, SEARCHSTRING_DE_SYMBOL_ADLAM, SEARCHSTRING_EN_SYMBOL_ADLAM, SEARCHSTRING_FR_SYMBOL_ADLAM
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'alchemy',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_ALCHEMY, SEARCHSTRING_DE_SYMBOL_ALCHEMY, SEARCHSTRING_EN_SYMBOL_ALCHEMY, SEARCHSTRING_FR_SYMBOL_ALCHEMY
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_ALCHEMY_ALPHABET, SEARCHSTRING_DE_SYMBOL_ALCHEMY_ALPHABET, SEARCHSTRING_EN_SYMBOL_ALCHEMY_ALPHABET, SEARCHSTRING_FR_SYMBOL_ALCHEMY_ALPHABET
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_ANGERTHAS_CIRTH, SEARCHSTRING_DE_SYMBOL_ANGERTHAS_CIRTH, SEARCHSTRING_EN_SYMBOL_ANGERTHAS_CIRTH, SEARCHSTRING_FR_SYMBOL_ANGERTHAS_CIRTH
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_ALPHABETUM_ARABUM, SEARCHSTRING_DE_SYMBOL_ALPHABETUM_ARABUM, SEARCHSTRING_EN_SYMBOL_ALPHABETUM_ARABUM, SEARCHSTRING_FR_SYMBOL_ALPHABETUM_ARABUM
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_ALPHABETUM_EGIPTIORUM, SEARCHSTRING_DE_SYMBOL_ALPHABETUM_EGIPTIORUM, SEARCHSTRING_EN_SYMBOL_ALPHABETUM_EGIPTIORUM, SEARCHSTRING_FR_SYMBOL_ALPHABETUM_EGIPTIORUM
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_ALPHABETUM_GOTHICUM, SEARCHSTRING_DE_SYMBOL_ALPHABETUM_GOTHICUM, SEARCHSTRING_EN_SYMBOL_ALPHABETUM_GOTHICUM, SEARCHSTRING_FR_SYMBOL_ALPHABETUM_GOTHICUM
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'antiker',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_ANTIKER, SEARCHSTRING_DE_SYMBOL_ANTIKER, SEARCHSTRING_EN_SYMBOL_ANTIKER, SEARCHSTRING_FR_SYMBOL_ANTIKER
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_ARABIC_INDIAN_NUMERALS, SEARCHSTRING_DE_SYMBOL_ARABIC_INDIAN_NUMERALS, SEARCHSTRING_EN_SYMBOL_ARABIC_INDIAN_NUMERALS, SEARCHSTRING_FR_SYMBOL_ARABIC_INDIAN_NUMERALS
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'arcadian',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_ARCADIAN, SEARCHSTRING_DE_SYMBOL_ARCADIAN, SEARCHSTRING_EN_SYMBOL_ARCADIAN, SEARCHSTRING_FR_SYMBOL_ARCADIAN
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'ath',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_ATH, SEARCHSTRING_DE_SYMBOL_ATH, SEARCHSTRING_EN_SYMBOL_ATH, SEARCHSTRING_FR_SYMBOL_ATH
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'atlantean',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_ATLANTEAN, SEARCHSTRING_DE_SYMBOL_ATLANTEAN, SEARCHSTRING_EN_SYMBOL_ATLANTEAN, SEARCHSTRING_FR_SYMBOL_ATLANTEAN
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'aurebesh',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_AUREBESH, SEARCHSTRING_DE_SYMBOL_AUREBESH, SEARCHSTRING_EN_SYMBOL_AUREBESH, SEARCHSTRING_FR_SYMBOL_AUREBESH
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_SIGNLANGUAGE, SEARCHSTRING_DE_SYMBOL_SIGNLANGUAGE, SEARCHSTRING_EN_SYMBOL_SIGNLANGUAGE, SEARCHSTRING_FR_SYMBOL_SIGNLANGUAGE,
          SEARCHSTRING_COMMON_SYMBOL_AUSTRALIAN_SIGN_LANGUAGE, SEARCHSTRING_DE_SYMBOL_AUSTRALIAN_SIGN_LANGUAGE, SEARCHSTRING_EN_SYMBOL_AUSTRALIAN_SIGN_LANGUAGE, SEARCHSTRING_FR_SYMBOL_AUSTRALIAN_SIGN_LANGUAGE
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_BABYLONIAN_NUMERALS, SEARCHSTRING_DE_BABYLONIAN_NUMERALS, SEARCHSTRING_EN_BABYLONIAN_NUMERALS, SEARCHSTRING_FR_BABYLONIAN_NUMERALS
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'ballet',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_BALLET, SEARCHSTRING_DE_SYMBOL_BALLET, SEARCHSTRING_EN_SYMBOL_BALLET, SEARCHSTRING_FR_SYMBOL_BALLET
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'barbier',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_BARBIER, SEARCHSTRING_DE_SYMBOL_BARBIER, SEARCHSTRING_EN_SYMBOL_BARBIER, SEARCHSTRING_FR_SYMBOL_BARBIER
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'barcode39',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_BARCODES, SEARCHSTRING_DE_SYMBOL_BARCODES, SEARCHSTRING_EN_SYMBOL_BARCODES, SEARCHSTRING_FR_SYMBOL_BARCODES,
          SEARCHSTRING_COMMON_BARCODE39, SEARCHSTRING_DE_BARCODE39, SEARCHSTRING_EN_BARCODE39, SEARCHSTRING_FR_BARCODE39
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'baudot',
        searchStrings: [
          ...
          SEARCHSTRING_COMMON_CCITT, SEARCHSTRING_DE_CCITT, SEARCHSTRING_EN_CCITT, SEARCHSTRING_FR_CCITT,
          SEARCHSTRING_COMMON_CCITT1, SEARCHSTRING_DE_CCITT1, SEARCHSTRING_EN_CCITT1, SEARCHSTRING_FR_CCITT1,
          SEARCHSTRING_COMMON_SYMBOL_BAUDOT, SEARCHSTRING_DE_SYMBOL_BAUDOT, SEARCHSTRING_EN_SYMBOL_BAUDOT, SEARCHSTRING_FR_SYMBOL_BAUDOT
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_BIRDS_ON_A_WIRE, SEARCHSTRING_DE_SYMBOL_BIRDS_ON_A_WIRE, SEARCHSTRING_EN_SYMBOL_BIRDS_ON_A_WIRE, SEARCHSTRING_FR_SYMBOL_BIRDS_ON_A_WIRE
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'blox',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_BLOX, SEARCHSTRING_DE_SYMBOL_BLOX, SEARCHSTRING_EN_SYMBOL_BLOX, SEARCHSTRING_FR_SYMBOL_BLOX
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_BRAHMI_NUMERALS, SEARCHSTRING_DE_SYMBOL_BRAHMI_NUMERALS, SEARCHSTRING_EN_SYMBOL_BRAHMI_NUMERALS, SEARCHSTRING_FR_SYMBOL_BRAHMI_NUMERALS
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'braille',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_BRAILLE, SEARCHSTRING_DE_BRAILLE, SEARCHSTRING_EN_BRAILLE, SEARCHSTRING_FR_BRAILLE
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_SIGNLANGUAGE, SEARCHSTRING_DE_SYMBOL_SIGNLANGUAGE, SEARCHSTRING_EN_SYMBOL_SIGNLANGUAGE, SEARCHSTRING_FR_SYMBOL_SIGNLANGUAGE,
          SEARCHSTRING_COMMON_SYMBOL_BRITISH_SIGN_LANGUAGE, SEARCHSTRING_DE_SYMBOL_BRITISH_SIGN_LANGUAGE, SEARCHSTRING_EN_SYMBOL_BRITISH_SIGN_LANGUAGE, SEARCHSTRING_FR_SYMBOL_BRITISH_SIGN_LANGUAGE
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'chappe_v1',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_CHAPPE, SEARCHSTRING_DE_SYMBOL_CHAPPE, SEARCHSTRING_EN_SYMBOL_CHAPPE, SEARCHSTRING_FR_SYMBOL_CHAPPE,
          SEARCHSTRING_COMMON_SYMBOL_CHAPPE_V1, SEARCHSTRING_DE_SYMBOL_CHAPPE_V1, SEARCHSTRING_EN_SYMBOL_CHAPPE_V1, SEARCHSTRING_FR_SYMBOL_CHAPPE_V1
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'chappe_v2',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_CHAPPE, SEARCHSTRING_DE_SYMBOL_CHAPPE, SEARCHSTRING_EN_SYMBOL_CHAPPE, SEARCHSTRING_FR_SYMBOL_CHAPPE,
          SEARCHSTRING_COMMON_SYMBOL_CHAPPE_V2, SEARCHSTRING_DE_SYMBOL_CHAPPE_V2, SEARCHSTRING_EN_SYMBOL_CHAPPE_V2, SEARCHSTRING_FR_SYMBOL_CHAPPE_V2
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'chappe_v3',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_CHAPPE, SEARCHSTRING_DE_SYMBOL_CHAPPE, SEARCHSTRING_EN_SYMBOL_CHAPPE, SEARCHSTRING_FR_SYMBOL_CHAPPE,
          SEARCHSTRING_COMMON_SYMBOL_CHAPPE_V3, SEARCHSTRING_DE_SYMBOL_CHAPPE_V3, SEARCHSTRING_EN_SYMBOL_CHAPPE_V3, SEARCHSTRING_FR_SYMBOL_CHAPPE_V3
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'cherokee',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_CHEROKEE, SEARCHSTRING_DE_SYMBOL_CHEROKEE, SEARCHSTRING_EN_SYMBOL_CHEROKEE, SEARCHSTRING_FR_SYMBOL_CHEROKEE
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_CHINESE_NUMERALS, SEARCHSTRING_DE_SYMBOL_CHINESE_NUMERALS, SEARCHSTRING_EN_SYMBOL_CHINESE_NUMERALS, SEARCHSTRING_FR_SYMBOL_CHINESE_NUMERALS
        ]
      ),
      GCWSymbolTableTool(
      ...
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_COLOR_CODE, SEARCHSTRING_DE_SYMBOL_COLOR_CODE, SEARCHSTRING_EN_SYMBOL_COLOR_CODE, SEARCHSTRING_FR_SYMBOL_COLOR_CODE
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_COLOR_HONEY, SEARCHSTRING_DE_SYMBOL_COLOR_HONEY, SEARCHSTRING_EN_SYMBOL_COLOR_HONEY, SEARCHSTRING_FR_SYMBOL_COLOR_HONEY
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_COLOR_TOKKI, SEARCHSTRING_DE_SYMBOL_COLOR_TOKKI, SEARCHSTRING_EN_SYMBOL_COLOR_TOKKI, SEARCHSTRING_FR_SYMBOL_COLOR_TOKKI
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'cyrillic',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_CYRILLIC, SEARCHSTRING_DE_SYMBOL_CYRILLIC, SEARCHSTRING_EN_SYMBOL_CYRILLIC, SEARCHSTRING_FR_SYMBOL_CYRILLIC
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_CYRILLIC_NUMBERS, SEARCHSTRING_DE_SYMBOL_CYRILLIC_NUMBERS, SEARCHSTRING_EN_SYMBOL_CYRILLIC_NUMBERS, SEARCHSTRING_FR_SYMBOL_CYRILLIC_NUMBERS
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'daedric',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_DAEDRIC, SEARCHSTRING_DE_SYMBOL_DAEDRIC, SEARCHSTRING_EN_SYMBOL_DAEDRIC, SEARCHSTRING_FR_SYMBOL_DAEDRIC
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'dagger',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_DAGGER, SEARCHSTRING_DE_SYMBOL_DAGGER, SEARCHSTRING_EN_SYMBOL_DAGGER, SEARCHSTRING_FR_SYMBOL_DAGGER
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_DANCING_MEN, SEARCHSTRING_DE_SYMBOL_DANCING_MEN, SEARCHSTRING_EN_SYMBOL_DANCING_MEN, SEARCHSTRING_FR_SYMBOL_DANCING_MEN
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'deafblind',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_SIGNLANGUAGE, SEARCHSTRING_DE_SYMBOL_SIGNLANGUAGE, SEARCHSTRING_EN_SYMBOL_SIGNLANGUAGE, SEARCHSTRING_FR_SYMBOL_SIGNLANGUAGE,
          SEARCHSTRING_COMMON_SYMBOL_DEAFBLIND, SEARCHSTRING_DE_SYMBOL_DEAFBLIND, SEARCHSTRING_EN_SYMBOL_DEAFBLIND, SEARCHSTRING_FR_SYMBOL_DEAFBLIND
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_DEVANAGARI_NUMERALS, SEARCHSTRING_DE_SYMBOL_DEVANAGARI_NUMERALS, SEARCHSTRING_EN_SYMBOL_DEVANAGARI_NUMERALS, SEARCHSTRING_FR_SYMBOL_DEVANAGARI_NUMERALS
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'dni',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_DNI, SEARCHSTRING_DE_SYMBOL_DNI, SEARCHSTRING_EN_SYMBOL_DNI, SEARCHSTRING_FR_SYMBOL_DNI
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_DNI_COLORS, SEARCHSTRING_DE_SYMBOL_DNI_COLORS, SEARCHSTRING_EN_SYMBOL_DNI_COLORS, SEARCHSTRING_FR_SYMBOL_DNI_COLORS
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_DNI_NUMBERS, SEARCHSTRING_DE_SYMBOL_DNI_NUMBERS, SEARCHSTRING_EN_SYMBOL_DNI_NUMBERS, SEARCHSTRING_FR_SYMBOL_DNI_NUMBERS
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'doremi',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_DOREMI, SEARCHSTRING_DE_SYMBOL_DOREMI, SEARCHSTRING_EN_SYMBOL_DOREMI, SEARCHSTRING_FR_SYMBOL_DOREMI
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_DRAGON_LANGUAGE, SEARCHSTRING_DE_SYMBOL_DRAGON_LANGUAGE, SEARCHSTRING_EN_SYMBOL_DRAGON_LANGUAGE, SEARCHSTRING_FR_SYMBOL_DRAGON_LANGUAGE
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_DRAGON_RUNES, SEARCHSTRING_DE_SYMBOL_DRAGON_RUNES, SEARCHSTRING_EN_SYMBOL_DRAGON_RUNES, SEARCHSTRING_FR_SYMBOL_DRAGON_RUNES
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_EASTERN_ARABIC_INDIAN_NUMERALS, SEARCHSTRING_DE_SYMBOL_EASTERN_ARABIC_INDIAN_NUMERALS, SEARCHSTRING_EN_SYMBOL_EASTERN_ARABIC_INDIAN_NUMERALS,SEARCHSTRING_FR_SYMBOL_EASTERN_ARABIC_INDIAN_NUMERALS
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_EGYPTIAN_NUMERALS, SEARCHSTRING_DE_SYMBOL_EGYPTIAN_NUMERALS, SEARCHSTRING_EN_SYMBOL_EGYPTIAN_NUMERALS, SEARCHSTRING_FR_SYMBOL_EGYPTIAN_NUMERALS
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'elia',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_ELIA, SEARCHSTRING_DE_ELIA, SEARCHSTRING_EN_ELIA, SEARCHSTRING_FR_ELIA
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'enochian',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_ENOCHIAN, SEARCHSTRING_DE_SYMBOL_ENOCHIAN, SEARCHSTRING_EN_SYMBOL_ENOCHIAN, SEARCHSTRING_FR_SYMBOL_ENOCHIAN
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'eurythmy',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_EURYTHMY, SEARCHSTRING_DE_SYMBOL_EURYTHMY, SEARCHSTRING_EN_SYMBOL_EURYTHMY, SEARCHSTRING_FR_SYMBOL_EURYTHMY
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'fakoo',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_FAKOO, SEARCHSTRING_DE_SYMBOL_FAKOO, SEARCHSTRING_EN_SYMBOL_FAKOO, SEARCHSTRING_FR_SYMBOL_FAKOO
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'finger',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_SIGNLANGUAGE, SEARCHSTRING_DE_SYMBOL_SIGNLANGUAGE, SEARCHSTRING_EN_SYMBOL_SIGNLANGUAGE, SEARCHSTRING_FR_SYMBOL_SIGNLANGUAGE,
          SEARCHSTRING_COMMON_SYMBOL_FINGER, SEARCHSTRING_DE_SYMBOL_FINGER, SEARCHSTRING_EN_SYMBOL_FINGER, SEARCHSTRING_FR_SYMBOL_FINGER
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_SIGNLANGUAGE, SEARCHSTRING_DE_SYMBOL_SIGNLANGUAGE, SEARCHSTRING_EN_SYMBOL_SIGNLANGUAGE, SEARCHSTRING_FR_SYMBOL_SIGNLANGUAGE,
          SEARCHSTRING_COMMON_SYMBOL_FINGER_NUMBERS, SEARCHSTRING_DE_SYMBOL_FINGER_NUMBERS, SEARCHSTRING_EN_SYMBOL_FINGER_NUMBERS, SEARCHSTRING_FR_SYMBOL_FINGER_NUMBERS
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'flags',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_FLAGS, SEARCHSTRING_DE_SYMBOL_FLAGS, SEARCHSTRING_EN_SYMBOL_FLAGS, SEARCHSTRING_FR_SYMBOL_FLAGS
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_FLAGS, SEARCHSTRING_DE_SYMBOL_FLAGS, SEARCHSTRING_EN_SYMBOL_FLAGS, SEARCHSTRING_FR_SYMBOL_FLAGS,
          SEARCHSTRING_COMMON_SYMBOL_FLAGS_GERMAN_KRIEGSMARINE, SEARCHSTRING_DE_SYMBOL_FLAGS_GERMAN_KRIEGSMARINE, SEARCHSTRING_EN_SYMBOL_FLAGS_GERMAN_KRIEGSMARINE, SEARCHSTRING_FR_SYMBOL_FLAGS_GERMAN_KRIEGSMARINE
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_FLAGS, SEARCHSTRING_DE_SYMBOL_FLAGS, SEARCHSTRING_EN_SYMBOL_FLAGS, SEARCHSTRING_FR_SYMBOL_FLAGS,
          SEARCHSTRING_COMMON_SYMBOL_FLAGS_NATO, SEARCHSTRING_DE_SYMBOL_FLAGS_NATO, SEARCHSTRING_EN_SYMBOL_FLAGS_NATO, SEARCHSTRING_FR_SYMBOL_FLAGS_NATO
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'fonic',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_FONIC, SEARCHSTRING_DE_SYMBOL_FONIC, SEARCHSTRING_EN_SYMBOL_FONIC, SEARCHSTRING_FR_SYMBOL_FONIC
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_FOUR_TRIANGLES, SEARCHSTRING_DE_SYMBOL_FOUR_TRIANGLES, SEARCHSTRING_EN_SYMBOL_FOUR_TRIANGLES, SEARCHSTRING_FR_SYMBOL_FOUR_TRIANGLES
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'freemason',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_FREEMASON, SEARCHSTRING_DE_SYMBOL_FREEMASON, SEARCHSTRING_EN_SYMBOL_FREEMASON, SEARCHSTRING_FR_SYMBOL_FREEMASON
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_FREEMASON_V2, SEARCHSTRING_DE_SYMBOL_FREEMASON_V2, SEARCHSTRING_EN_SYMBOL_FREEMASON_V2, SEARCHSTRING_FR_SYMBOL_FREEMASON_V2
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'futurama',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_FUTURAMA, SEARCHSTRING_DE_SYMBOL_FUTURAMA, SEARCHSTRING_EN_SYMBOL_FUTURAMA, SEARCHSTRING_FR_SYMBOL_FUTURAMA
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_FUTURAMA_2, SEARCHSTRING_DE_SYMBOL_FUTURAMA_2, SEARCHSTRING_EN_SYMBOL_FUTURAMA_2, SEARCHSTRING_FR_SYMBOL_FUTURAMA_2
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_GALLIFREYAN, SEARCHSTRING_DE_SYMBOL_GALLIFREYAN, SEARCHSTRING_EN_SYMBOL_GALLIFREYAN, SEARCHSTRING_FR_SYMBOL_GALLIFREYAN
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'gargish',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_GARGISH, SEARCHSTRING_DE_SYMBOL_GARGISH, SEARCHSTRING_EN_SYMBOL_GARGISH, SEARCHSTRING_FR_SYMBOL_GARGISH
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'genreich',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_GLAGOLITIC, SEARCHSTRING_DE_GLAGOLITIC, SEARCHSTRING_EN_GLAGOLITIC, SEARCHSTRING_FR_GLAGOLITIC
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_GNOMMISH, SEARCHSTRING_DE_SYMBOL_GNOMMISH, SEARCHSTRING_EN_SYMBOL_GNOMMISH, SEARCHSTRING_FR_SYMBOL_GNOMMISH
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'gnommish',
      ...
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_GREEK_NUMERALS, SEARCHSTRING_DE_SYMBOL_GREEK_NUMERALS, SEARCHSTRING_EN_SYMBOL_GREEK_NUMERALS, SEARCHSTRING_FR_SYMBOL_GREEK_NUMERALS
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'hazard',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_HAZARD, SEARCHSTRING_DE_SYMBOL_HAZARD, SEARCHSTRING_EN_SYMBOL_HAZARD, SEARCHSTRING_FR_SYMBOL_HAZARD
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'hebrew',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_HEBREW, SEARCHSTRING_DE_SYMBOL_HEBREW, SEARCHSTRING_EN_SYMBOL_HEBREW, SEARCHSTRING_FR_SYMBOL_HEBREW
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'hebrew_v2',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_HEBREW_V2, SEARCHSTRING_DE_SYMBOL_HEBREW_V2, SEARCHSTRING_EN_SYMBOL_HEBREW_V2, SEARCHSTRING_FR_SYMBOL_HEBREW_V2
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'hexahue',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_HEXAHUE, SEARCHSTRING_DE_SYMBOL_HEXAHUE, SEARCHSTRING_EN_SYMBOL_HEXAHUE, SEARCHSTRING_FR_SYMBOL_HEXAHUE
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_HIERATIC_NUMERALS, SEARCHSTRING_DE_SYMBOL_HIERATIC_NUMERALS, SEARCHSTRING_EN_SYMBOL_HIERATIC_NUMERALS, SEARCHSTRING_FR_SYMBOL_HIERATIC_NUMERALS
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_HOBBIT_RUNES, SEARCHSTRING_DE_SYMBOL_HOBBIT_RUNES, SEARCHSTRING_EN_SYMBOL_HOBBIT_RUNES, SEARCHSTRING_FR_SYMBOL_HOBBIT_RUNES
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'hvd',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_HVD, SEARCHSTRING_DE_SYMBOL_HVD, SEARCHSTRING_EN_SYMBOL_HVD, SEARCHSTRING_FR_SYMBOL_HVD
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_HYLIAN, SEARCHSTRING_DE_SYMBOL_HYLIAN, SEARCHSTRING_EN_SYMBOL_HYLIAN, SEARCHSTRING_FR_SYMBOL_HYLIAN,
          SEARCHSTRING_COMMON_SYMBOL_HYLIAN_SKYWARDSWORD, SEARCHSTRING_DE_SYMBOL_HYLIAN_SKYWARDSWORD, SEARCHSTRING_EN_SYMBOL_HYLIAN_SKYWARDSWORD, SEARCHSTRING_FR_SYMBOL_HYLIAN_SKYWARDSWORD
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_HYLIAN, SEARCHSTRING_DE_SYMBOL_HYLIAN, SEARCHSTRING_EN_SYMBOL_HYLIAN, SEARCHSTRING_FR_SYMBOL_HYLIAN,
          SEARCHSTRING_COMMON_SYMBOL_HYLIAN_TWILIGHTPRINCESS_GCN, SEARCHSTRING_DE_SYMBOL_HYLIAN_TWILIGHTPRINCESS_GCN, SEARCHSTRING_EN_SYMBOL_HYLIAN_TWILIGHTPRINCESS_GCN, SEARCHSTRING_FR_SYMBOL_HYLIAN_TWILIGHTPRINCESS_GCN
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_HYLIAN, SEARCHSTRING_DE_SYMBOL_HYLIAN, SEARCHSTRING_EN_SYMBOL_HYLIAN, SEARCHSTRING_FR_SYMBOL_HYLIAN,
          SEARCHSTRING_COMMON_SYMBOL_HYLIAN_TWILIGHTPRINCESS_WII, SEARCHSTRING_DE_SYMBOL_HYLIAN_TWILIGHTPRINCESS_WII, SEARCHSTRING_EN_SYMBOL_HYLIAN_TWILIGHTPRINCESS_WII, SEARCHSTRING_FR_SYMBOL_HYLIAN_TWILIGHTPRINCESS_WII
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_HYLIAN, SEARCHSTRING_DE_SYMBOL_HYLIAN, SEARCHSTRING_EN_SYMBOL_HYLIAN, SEARCHSTRING_FR_SYMBOL_HYLIAN,
          SEARCHSTRING_COMMON_SYMBOL_HYLIAN_WINDWAKER, SEARCHSTRING_DE_SYMBOL_HYLIAN_WINDWAKER, SEARCHSTRING_EN_SYMBOL_HYLIAN_WINDWAKER, SEARCHSTRING_FR_SYMBOL_HYLIAN_WINDWAKER
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'hymmnos',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_HYMMNOS, SEARCHSTRING_DE_SYMBOL_HYMMNOS, SEARCHSTRING_EN_SYMBOL_HYMMNOS, SEARCHSTRING_FR_SYMBOL_HYMMNOS
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'iching',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_ICHING, SEARCHSTRING_DE_SYMBOL_ICHING, SEARCHSTRING_EN_SYMBOL_ICHING, SEARCHSTRING_FR_SYMBOL_ICHING
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_ILLUMINATI, SEARCHSTRING_DE_SYMBOL_ILLUMINATI, SEARCHSTRING_EN_SYMBOL_ILLUMINATI, SEARCHSTRING_FR_SYMBOL_ILLUMINATI,
          SEARCHSTRING_COMMON_SYMBOL_ILLUMINATI_V1, SEARCHSTRING_DE_SYMBOL_ILLUMINATI_V1, SEARCHSTRING_EN_SYMBOL_ILLUMINATI_V1, SEARCHSTRING_FR_SYMBOL_ILLUMINATI_V1,
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_ILLUMINATI, SEARCHSTRING_DE_SYMBOL_ILLUMINATI, SEARCHSTRING_EN_SYMBOL_ILLUMINATI, SEARCHSTRING_FR_SYMBOL_ILLUMINATI,
          SEARCHSTRING_COMMON_SYMBOL_ILLUMINATI_V2, SEARCHSTRING_DE_SYMBOL_ILLUMINATI_V2, SEARCHSTRING_EN_SYMBOL_ILLUMINATI_V2, SEARCHSTRING_FR_SYMBOL_ILLUMINATI_V2,
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_INTERGALACTIC, SEARCHSTRING_DE_SYMBOL_INTERGALACTIC, SEARCHSTRING_EN_SYMBOL_INTERGALACTIC, SEARCHSTRING_FR_SYMBOL_INTERGALACTIC
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'iokharic',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_IOKHARIC, SEARCHSTRING_DE_SYMBOL_IOKHARIC, SEARCHSTRING_EN_SYMBOL_IOKHARIC, SEARCHSTRING_FR_SYMBOL_IOKHARIC
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_JAPANESE_NUMERALS, SEARCHSTRING_DE_JAPANESE_NUMERALS, SEARCHSTRING_EN_JAPANESE_NUMERALS, SEARCHSTRING_FR_JAPANESE_NUMERALS
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_KABOUTER_ABC, SEARCHSTRING_DE_SYMBOL_KABOUTER_ABC, SEARCHSTRING_EN_SYMBOL_KABOUTER_ABC, SEARCHSTRING_FR_SYMBOL_KABOUTER_ABC
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_KABOUTER_ABC_1947, SEARCHSTRING_DE_SYMBOL_KABOUTER_ABC_1947, SEARCHSTRING_EN_SYMBOL_KABOUTER_ABC_1947, SEARCHSTRING_FR_SYMBOL_KABOUTER_ABC_1947
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'kartrak',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_BARCODES, SEARCHSTRING_DE_SYMBOL_BARCODES, SEARCHSTRING_EN_SYMBOL_BARCODES, SEARCHSTRING_FR_SYMBOL_BARCODES,
          SEARCHSTRING_COMMON_SYMBOL_KARTRAK, SEARCHSTRING_DE_SYMBOL_KARTRAK, SEARCHSTRING_EN_SYMBOL_KARTRAK, SEARCHSTRING_FR_SYMBOL_KARTRAK
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_KHAROSHTHI, SEARCHSTRING_DE_SYMBOL_KHAROSHTHI, SEARCHSTRING_EN_SYMBOL_KHAROSHTHI, SEARCHSTRING_FR_SYMBOL_KHAROSHTHI
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'klingon',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_KLINGON, SEARCHSTRING_DE_SYMBOL_KLINGON, SEARCHSTRING_EN_SYMBOL_KLINGON, SEARCHSTRING_FR_SYMBOL_KLINGON
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_KLINGON_KLINZHAI, SEARCHSTRING_DE_SYMBOL_KLINGON_KLINZHAI, SEARCHSTRING_EN_SYMBOL_KLINGON_KLINZHAI, SEARCHSTRING_FR_SYMBOL_KLINGON_KLINZHAI
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'krempel',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_KREMPEL, SEARCHSTRING_DE_SYMBOL_KREMPEL, SEARCHSTRING_EN_SYMBOL_KREMPEL, SEARCHSTRING_FR_SYMBOL_KREMPEL
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'krypton',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_KRYPTON, SEARCHSTRING_DE_SYMBOL_KRYPTON, SEARCHSTRING_EN_SYMBOL_KRYPTON, SEARCHSTRING_FR_SYMBOL_KRYPTON
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'lorm',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_SIGNLANGUAGE, SEARCHSTRING_DE_SYMBOL_SIGNLANGUAGE, SEARCHSTRING_EN_SYMBOL_SIGNLANGUAGE, SEARCHSTRING_FR_SYMBOL_SIGNLANGUAGE,
          SEARCHSTRING_COMMON_SYMBOL_LORM, SEARCHSTRING_DE_SYMBOL_LORM, SEARCHSTRING_EN_SYMBOL_LORM, SEARCHSTRING_FR_SYMBOL_LORM
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'magicode',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_MAGICODE, SEARCHSTRING_DE_SYMBOL_MAGICODE, SEARCHSTRING_EN_SYMBOL_MAGICODE, SEARCHSTRING_FR_SYMBOL_MAGICODE
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'marain',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_MARAIN, SEARCHSTRING_DE_SYMBOL_MARAIN, SEARCHSTRING_EN_SYMBOL_MARAIN, SEARCHSTRING_FR_SYMBOL_MARAIN
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'marain_v2',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_MARAIN_V2, SEARCHSTRING_DE_SYMBOL_MARAIN_V2, SEARCHSTRING_EN_SYMBOL_MARAIN_V2, SEARCHSTRING_FR_SYMBOL_MARAIN_V2
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'matoran',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_MATORAN, SEARCHSTRING_DE_SYMBOL_MATORAN, SEARCHSTRING_EN_SYMBOL_MATORAN, SEARCHSTRING_FR_SYMBOL_MATORAN
        ]
      ),
      GCWSymbolTableTool(
      ...
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_MAZE, SEARCHSTRING_DE_SYMBOL_MAZE, SEARCHSTRING_EN_SYMBOL_MAZE, SEARCHSTRING_FR_SYMBOL_MAZE
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'minimoys',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_MINIMOYS, SEARCHSTRING_DE_SYMBOL_MINIMOYS, SEARCHSTRING_EN_SYMBOL_MINIMOYS, SEARCHSTRING_FR_SYMBOL_MINIMOYS
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'moon',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_MOON, SEARCHSTRING_DE_SYMBOL_MOON, SEARCHSTRING_EN_SYMBOL_MOON, SEARCHSTRING_FR_SYMBOL_MOON
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'murray',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_MURRAY, SEARCHSTRING_DE_SYMBOL_MURRAY, SEARCHSTRING_EN_SYMBOL_MURRAY, SEARCHSTRING_FR_SYMBOL_MURRAY
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_CCITT, SEARCHSTRING_DE_CCITT, SEARCHSTRING_COMMON_CCITT, SEARCHSTRING_FR_CCITT,
          SEARCHSTRING_COMMON_CCITT2, SEARCHSTRING_DE_CCITT2, SEARCHSTRING_COMMON_CCITT2, SEARCHSTRING_FR_CCITT2,
          SEARCHSTRING_COMMON_SYMBOL_MURRAYBAUDOT, SEARCHSTRING_DE_SYMBOL_MURRAYBAUDOT, SEARCHSTRING_EN_SYMBOL_MURRAYBAUDOT, SEARCHSTRING_FR_SYMBOL_MURRAYBAUDOT
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'musica',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_MUSICA, SEARCHSTRING_DE_SYMBOL_MUSICA, SEARCHSTRING_EN_SYMBOL_MUSICA, SEARCHSTRING_FR_SYMBOL_MUSICA
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_SIGNLANGUAGE, SEARCHSTRING_DE_SYMBOL_SIGNLANGUAGE, SEARCHSTRING_EN_SYMBOL_SIGNLANGUAGE, SEARCHSTRING_FR_SYMBOL_SIGNLANGUAGE,
          SEARCHSTRING_COMMON_SYMBOL_NEW_ZEALAND_SIGN_LANGUAGE, SEARCHSTRING_DE_SYMBOL_NEW_ZEALAND_SIGN_LANGUAGE, SEARCHSTRING_EN_SYMBOL_NEW_ZEALAND_SIGN_LANGUAGE, SEARCHSTRING_FR_SYMBOL_NEW_ZEALAND_SIGN_LANGUAGE
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_NOTES_DOREMI, SEARCHSTRING_DE_SYMBOL_NOTES_DOREMI, SEARCHSTRING_EN_SYMBOL_NOTES_DOREMI, SEARCHSTRING_FR_SYMBOL_NOTES_DOREMI
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_NOTES_NAMES_ALTOCLEF, SEARCHSTRING_DE_SYMBOL_NOTES_NAMES_ALTOCLEF, SEARCHSTRING_EN_SYMBOL_NOTES_NAMES_ALTOCLEF, SEARCHSTRING_FR_SYMBOL_NOTES_NAMES_ALTOCLEF
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_NOTES_NAMES_BASSCLEF, SEARCHSTRING_DE_SYMBOL_NOTES_NAMES_BASSCLEF, SEARCHSTRING_EN_SYMBOL_NOTES_NAMES_BASSCLEF, SEARCHSTRING_FR_SYMBOL_NOTES_NAMES_BASSCLEF
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_NOTES_NAMES_TREBLECLEF, SEARCHSTRING_DE_SYMBOL_NOTES_NAMES_TREBLECLEF, SEARCHSTRING_EN_SYMBOL_NOTES_NAMES_TREBLECLEF, SEARCHSTRING_FR_SYMBOL_NOTES_NAMES_TREBLECLEF
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_NOTES_NOTEVALUES, SEARCHSTRING_DE_SYMBOL_NOTES_NOTEVALUES, SEARCHSTRING_EN_SYMBOL_NOTES_NOTEVALUES, SEARCHSTRING_FR_SYMBOL_NOTES_NOTEVALUES
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_NOTES_RESTVALUES, SEARCHSTRING_DE_SYMBOL_NOTES_RESTVALUES, SEARCHSTRING_EN_SYMBOL_NOTES_RESTVALUES, SEARCHSTRING_FR_SYMBOL_NOTES_RESTVALUES
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'ogham',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_OGHAM, SEARCHSTRING_DE_SYMBOL_OGHAM, SEARCHSTRING_EN_SYMBOL_OGHAM, SEARCHSTRING_FR_SYMBOL_OGHAM
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_OPTICALFIBER, SEARCHSTRING_DE_SYMBOL_OPTICALFIBER, SEARCHSTRING_EN_SYMBOL_OPTICALFIBER, SEARCHSTRING_FR_SYMBOL_OPTICALFIBER,
          SEARCHSTRING_COMMON_SYMBOL_OPTICAL_FIBER_FOTAG, SEARCHSTRING_DE_SYMBOL_OPTICAL_FIBER_FOTAG, SEARCHSTRING_EN_SYMBOL_OPTICAL_FIBER_FOTAG,SEARCHSTRING_FR_SYMBOL_OPTICAL_FIBER_FOTAG
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_OPTICALFIBER, SEARCHSTRING_DE_SYMBOL_OPTICALFIBER, SEARCHSTRING_EN_SYMBOL_OPTICALFIBER, SEARCHSTRING_FR_SYMBOL_OPTICALFIBER,
          SEARCHSTRING_COMMON_SYMBOL_OPTICAL_FIBER_IEC60304, SEARCHSTRING_DE_SYMBOL_OPTICAL_FIBER_IEC60304, SEARCHSTRING_EN_SYMBOL_OPTICAL_FIBER_IEC60304, SEARCHSTRING_FR_SYMBOL_OPTICAL_FIBER_IEC60304
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_OPTICALFIBER, SEARCHSTRING_DE_SYMBOL_OPTICALFIBER, SEARCHSTRING_EN_SYMBOL_OPTICALFIBER, SEARCHSTRING_FR_SYMBOL_OPTICALFIBER,
          SEARCHSTRING_COMMON_OPTICAL_FIBER_SWISSCOM, SEARCHSTRING_DE_OPTICAL_FIBER_SWISSCOM, SEARCHSTRING_EN_OPTICAL_FIBER_SWISSCOM, SEARCHSTRING_FR_OPTICAL_FIBER_SWISSCOM
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_PHOENICIAN, SEARCHSTRING_DE_SYMBOL_PHOENICIAN, SEARCHSTRING_EN_SYMBOL_PHOENICIAN, SEARCHSTRING_FR_SYMBOL_PHOENICIAN
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'pipeline',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_PIPELINE, SEARCHSTRING_DE_SYMBOL_PIPELINE, SEARCHSTRING_EN_SYMBOL_PIPELINE, SEARCHSTRING_FR_SYMBOL_PIPELINE
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'pixel',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_PIXEL, SEARCHSTRING_DE_SYMBOL_PIXEL, SEARCHSTRING_EN_SYMBOL_PIXEL, SEARCHSTRING_FR_SYMBOL_PIXEL
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'planet',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_BARCODES, SEARCHSTRING_DE_SYMBOL_BARCODES, SEARCHSTRING_EN_SYMBOL_BARCODES, SEARCHSTRING_FR_SYMBOL_BARCODES,
          SEARCHSTRING_COMMON_SYMBOL_PLANET, SEARCHSTRING_DE_SYMBOL_PLANET, SEARCHSTRING_EN_SYMBOL_PLANET, SEARCHSTRING_FR_SYMBOL_PLANET
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_POKEMON_UNOWN, SEARCHSTRING_DE_SYMBOL_POKEMON_UNOWN, SEARCHSTRING_EN_SYMBOL_POKEMON_UNOWN, SEARCHSTRING_FR_SYMBOL_POKEMON_UNOWN
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'postnet',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_BARCODES, SEARCHSTRING_DE_SYMBOL_BARCODES, SEARCHSTRING_EN_SYMBOL_BARCODES, SEARCHSTRING_FR_SYMBOL_BARCODES,
          SEARCHSTRING_COMMON_SYMBOL_POSTNET, SEARCHSTRING_DE_SYMBOL_POSTNET, SEARCHSTRING_EN_SYMBOL_POSTNET, SEARCHSTRING_FR_SYMBOL_POSTNET
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'puzzle',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_PUZZLE, SEARCHSTRING_DE_SYMBOL_PUZZLE, SEARCHSTRING_EN_SYMBOL_PUZZLE, SEARCHSTRING_FR_SYMBOL_PUZZLE
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'quadoo',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_QUADOO, SEARCHSTRING_DE_SYMBOL_QUADOO, SEARCHSTRING_EN_SYMBOL_QUADOO, SEARCHSTRING_FR_SYMBOL_QUADOO
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'reality',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_REALITY, SEARCHSTRING_DE_SYMBOL_REALITY, SEARCHSTRING_EN_SYMBOL_REALITY, SEARCHSTRING_FR_SYMBOL_REALITY
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_RED_HERRING, SEARCHSTRING_DE_SYMBOL_RED_HERRING, SEARCHSTRING_EN_SYMBOL_RED_HERRING, SEARCHSTRING_FR_SYMBOL_RED_HERRING
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'resistor',
      ...
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_RHESUS_A, SEARCHSTRING_DE_SYMBOL_RHESUS_A, SEARCHSTRING_EN_SYMBOL_RHESUS_A, SEARCHSTRING_FR_SYMBOL_RHESUS_A
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'rm4scc',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_BARCODES, SEARCHSTRING_DE_SYMBOL_BARCODES, SEARCHSTRING_EN_SYMBOL_BARCODES, SEARCHSTRING_FR_SYMBOL_BARCODES,
          SEARCHSTRING_COMMON_SYMBOL_RM4SCC, SEARCHSTRING_DE_SYMBOL_RM4SCC, SEARCHSTRING_EN_SYMBOL_RM4SCC, SEARCHSTRING_FR_SYMBOL_RM4SCC
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'romulan',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_ROMULAN, SEARCHSTRING_DE_SYMBOL_ROMULAN, SEARCHSTRING_EN_SYMBOL_ROMULAN, SEARCHSTRING_FR_SYMBOL_ROMULAN
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'runes',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_RUNES, SEARCHSTRING_DE_SYMBOL_RUNES, SEARCHSTRING_EN_SYMBOL_RUNES, SEARCHSTRING_FR_SYMBOL_RUNES
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'sanluca',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_SANLUCA, SEARCHSTRING_DE_SYMBOL_SANLUCA, SEARCHSTRING_EN_SYMBOL_SANLUCA, SEARCHSTRING_FR_SYMBOL_SANLUCA
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'sarati',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_SARATI, SEARCHSTRING_DE_SYMBOL_SARATI, SEARCHSTRING_EN_SYMBOL_SARATI, SEARCHSTRING_FR_SYMBOL_SARATI
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'semaphore',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_SEMAPHORE, SEARCHSTRING_DE_SYMBOL_SEMAPHORE, SEARCHSTRING_EN_SYMBOL_SEMAPHORE, SEARCHSTRING_FR_SYMBOL_SEMAPHORE
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'sign',
      ...
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_SKULLZ, SEARCHSTRING_DE_SYMBOL_SKULLZ, SEARCHSTRING_EN_SYMBOL_SKULLZ, SEARCHSTRING_FR_SYMBOL_SKULLZ
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_SLASH_AND_PIPE, SEARCHSTRING_DE_SYMBOL_SLASH_AND_PIPE, SEARCHSTRING_EN_SYMBOL_SLASH_AND_PIPE, SEARCHSTRING_FR_SYMBOL_SLASH_AND_PIPE
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_SOLMISATION, SEARCHSTRING_DE_SYMBOL_SOLMISATION, SEARCHSTRING_EN_SYMBOL_SOLMISATION, SEARCHSTRING_FR_SYMBOL_SOLMISATION
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_SPACE_INVADERS, SEARCHSTRING_DE_SYMBOL_SPACE_INVADERS, SEARCHSTRING_EN_SYMBOL_SPACE_INVADERS, SEARCHSTRING_FR_SYMBOL_SPACE_INVADERS
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'spintype',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_SPINTYPE, SEARCHSTRING_DE_SYMBOL_SPINTYPE, SEARCHSTRING_EN_SYMBOL_SPINTYPE, SEARCHSTRING_FR_SYMBOL_SPINTYPE
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_STIPPELCODE, SEARCHSTRING_DE_SYMBOL_STIPPELCODE, SEARCHSTRING_EN_SYMBOL_STIPPELCODE, SEARCHSTRING_FR_SYMBOL_STIPPELCODE
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_SUETTERLIN, SEARCHSTRING_DE_SYMBOL_SUETTERLIN, SEARCHSTRING_EN_SYMBOL_SUETTERLIN, SEARCHSTRING_FR_SYMBOL_SUETTERLIN
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'sunuz',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_SUNUZ, SEARCHSTRING_DE_SYMBOL_SUNUZ, SEARCHSTRING_EN_SYMBOL_SUNUZ, SEARCHSTRING_FR_SYMBOL_SUNUZ
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_TAMIL_NUMERALS, SEARCHSTRING_DE_SYMBOL_TAMIL_NUMERALS, SEARCHSTRING_EN_SYMBOL_TAMIL_NUMERALS, SEARCHSTRING_FR_SYMBOL_TAMIL_NUMERALS
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'templers',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_TEMPLERS, SEARCHSTRING_DE_SYMBOL_TEMPLERS, SEARCHSTRING_EN_SYMBOL_TEMPLERS, SEARCHSTRING_FR_SYMBOL_TEMPLERS
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_TENCTONESE, SEARCHSTRING_DE_SYMBOL_TENCTONESE, SEARCHSTRING_EN_SYMBOL_TENCTONESE, SEARCHSTRING_FR_SYMBOL_TENCTONESE
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_TENGWAR_BELERIAND, SEARCHSTRING_DE_SYMBOL_TENGWAR_BELERIAND, SEARCHSTRING_EN_SYMBOL_TENGWAR_BELERIAND, SEARCHSTRING_FR_SYMBOL_TENGWAR_BELERIAND
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_TENGWAR_CLASSIC, SEARCHSTRING_DE_SYMBOL_TENGWAR_CLASSIC, SEARCHSTRING_EN_SYMBOL_TENGWAR_CLASSIC, SEARCHSTRING_FR_SYMBOL_TENGWAR_CLASSIC
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_TENGWAR_GENERAL, SEARCHSTRING_DE_SYMBOL_TENGWAR_GENERAL, SEARCHSTRING_EN_SYMBOL_TENGWAR_GENERAL, SEARCHSTRING_FR_SYMBOL_TENGWAR_GENERAL
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'terzi',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_TERZI, SEARCHSTRING_DE_SYMBOL_TERZI, SEARCHSTRING_EN_SYMBOL_TERZI, SEARCHSTRING_FR_SYMBOL_TERZI
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'theban',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_THEBAN, SEARCHSTRING_DE_SYMBOL_THEBAN, SEARCHSTRING_EN_SYMBOL_THEBAN, SEARCHSTRING_FR_SYMBOL_THEBAN
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_THREE_SQUARES, SEARCHSTRING_DE_SYMBOL_THREE_SQUARES, SEARCHSTRING_EN_SYMBOL_THREE_SQUARES, SEARCHSTRING_FR_SYMBOL_THREE_SQUARES
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'tines',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_TINES, SEARCHSTRING_DE_SYMBOL_TINES, SEARCHSTRING_EN_SYMBOL_TINES, SEARCHSTRING_FR_SYMBOL_TINES
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'tomtom',
      ...
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_TRAFFICSIGNS_GERMANY, SEARCHSTRING_DE_SYMBOL_TRAFFICSIGNS_GERMANY, SEARCHSTRING_EN_SYMBOL_TRAFFICSIGNS_GERMANY, SEARCHSTRING_FR_SYMBOL_TRAFFICSIGNS_GERMANY
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'ulog',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_ULOG, SEARCHSTRING_DE_SYMBOL_ULOG, SEARCHSTRING_EN_SYMBOL_ULOG, SEARCHSTRING_FR_SYMBOL_ULOG
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'utopian',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_UTOPIAN, SEARCHSTRING_DE_SYMBOL_UTOPIAN, SEARCHSTRING_EN_SYMBOL_UTOPIAN, SEARCHSTRING_FR_SYMBOL_UTOPIAN
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_VISITOR_1984, SEARCHSTRING_DE_SYMBOL_VISITOR_1984, SEARCHSTRING_EN_SYMBOL_VISITOR_1984, SEARCHSTRING_FR_SYMBOL_VISITOR_1984
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_VISITOR_2009, SEARCHSTRING_DE_SYMBOL_VISITOR_2009, SEARCHSTRING_EN_SYMBOL_VISITOR_2009, SEARCHSTRING_FR_SYMBOL_VISITOR_2009
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'vulcanian',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_VULCANIAN, SEARCHSTRING_DE_SYMBOL_VULCANIAN, SEARCHSTRING_EN_SYMBOL_VULCANIAN, SEARCHSTRING_FR_SYMBOL_VULCANIAN
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'wakandan',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_WAKANDAN, SEARCHSTRING_DE_SYMBOL_WAKANDAN, SEARCHSTRING_EN_SYMBOL_WAKANDAN, SEARCHSTRING_FR_SYMBOL_WAKANDAN
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'webdings',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_WEBDINGS, SEARCHSTRING_DE_SYMBOL_WEBDINGS, SEARCHSTRING_EN_SYMBOL_WEBDINGS, SEARCHSTRING_FR_SYMBOL_WEBDINGS
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_BEAUFORT, SEARCHSTRING_DE_BEAUFORT, SEARCHSTRING_EN_BEAUFORT, SEARCHSTRING_FR_BEAUFORT,
          SEARCHSTRING_COMMON_SYMBOL_WINDFORCE_BEAUFORT, SEARCHSTRING_DE_SYMBOL_WINDFORCE_BEAUFORT, SEARCHSTRING_EN_SYMBOL_WINDFORCE_BEAUFORT, SEARCHSTRING_FR_SYMBOL_WINDFORCE_BEAUFORT
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_BEAUFORT, SEARCHSTRING_DE_BEAUFORT, SEARCHSTRING_EN_BEAUFORT, SEARCHSTRING_FR_BEAUFORT,
          SEARCHSTRING_COMMON_SYMBOL_WINDFORCE_KNOTS, SEARCHSTRING_DE_SYMBOL_WINDFORCE_KNOTS, SEARCHSTRING_EN_SYMBOL_WINDFORCE_KNOTS, SEARCHSTRING_FR_SYMBOL_WINDFORCE_KNOTS
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'window',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_WINDOW, SEARCHSTRING_DE_WINDOW, SEARCHSTRING_EN_WINDOW, SEARCHSTRING_FR_WINDOW
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'wingdings',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_WINGDINGS, SEARCHSTRING_DE_SYMBOL_WINGDINGS, SEARCHSTRING_EN_SYMBOL_WINGDINGS, SEARCHSTRING_FR_SYMBOL_WINGDINGS
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_WINGDINGS2, SEARCHSTRING_DE_SYMBOL_WINGDINGS2, SEARCHSTRING_EN_SYMBOL_WINGDINGS2, SEARCHSTRING_FR_SYMBOL_WINGDINGS2
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_WINGDINGS3, SEARCHSTRING_DE_SYMBOL_WINGDINGS3, SEARCHSTRING_EN_SYMBOL_WINGDINGS3, SEARCHSTRING_FR_SYMBOL_WINGDINGS3
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_YAN_KORYANI, SEARCHSTRING_DE_SYMBOL_YAN_KORYANI, SEARCHSTRING_EN_SYMBOL_YAN_KORYANI, SEARCHSTRING_FR_SYMBOL_YAN_KORYANI
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'yinyang',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_YINYANG, SEARCHSTRING_DE_SYMBOL_YINYANG, SEARCHSTRING_EN_SYMBOL_YINYANG, SEARCHSTRING_FR_SYMBOL_YINYANG
        ]
      ),
      GCWSymbolTableTool(
        symbolKey: 'zentradi',
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_ZENTRADI, SEARCHSTRING_DE_SYMBOL_ZENTRADI, SEARCHSTRING_EN_SYMBOL_ZENTRADI, SEARCHSTRING_FR_SYMBOL_ZENTRADI
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_ZODIAC_Z340, SEARCHSTRING_DE_SYMBOL_ZODIAC_Z340, SEARCHSTRING_EN_SYMBOL_ZODIAC_Z340, SEARCHSTRING_FR_SYMBOL_ZODIAC_Z340
        ]
      ),
      GCWSymbolTableTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_SYMBOL, SEARCHSTRING_DE_SYMBOL, SEARCHSTRING_EN_SYMBOL,SEARCHSTRING_FR_SYMBOL,
          SEARCHSTRING_COMMON_SYMBOL_ZODIAC_Z408, SEARCHSTRING_DE_SYMBOL_ZODIAC_Z408, SEARCHSTRING_EN_SYMBOL_ZODIAC_Z408, SEARCHSTRING_FR_SYMBOL_ZODIAC_Z408
        ]
      ),
      ...
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_VANITY, SEARCHSTRING_DE_VANITY, SEARCHSTRING_EN_VANITY, SEARCHSTRING_FR_VANITY,
          SEARCHSTRING_COMMON_VANITYSINGLENUMBERS, SEARCHSTRING_DE_VANITYSINGLENUMBERS, SEARCHSTRING_EN_VANITYSINGLENUMBERS, SEARCHSTRING_FR_VANITYSINGLENUMBERS
        ]
      ),
      GCWTool(
        ...
        searchStrings: [
          SEARCHSTRING_COMMON_VANITY, SEARCHSTRING_DE_VANITY, SEARCHSTRING_EN_VANITY, SEARCHSTRING_FR_VANITY,
          SEARCHSTRING_COMMON_VANITYMULTIPLENUMBERS, SEARCHSTRING_DE_VANITYMULTIPLENUMBERS, SEARCHSTRING_EN_VANITYMULTIPLENUMBERS, SEARCHSTRING_FR_VANITYMULTIPLENUMBERS
        ]
      ),
