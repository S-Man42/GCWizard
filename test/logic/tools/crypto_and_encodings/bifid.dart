...
void main() {
  ...
  group("Bifid.encryptBifid:", () {
    List<Map<String, dynamic>> _inputsToExpected = [
      ...
      {'input' : 'THE QUICK BROWN FOX JUMPS OVER A LAZY DOGS BACK', 'key': '123456', 'mode': PolybiosMode.ZA90, 'alphabet': null, 'alphabetMode': BifidAlphabetMode.JToI, 'expectedOutput' : 'TCTBCPMPJOUSMG2CJABH2OQLQLRUDCW44GUAGQ'},
      {'input' : 'THE QUICK BROWN FOX JUMPS OVER A LAZY DOGS BACK', 'key': '123456', 'mode': PolybiosMode.CUSTOM, 'alphabet': 'BGWKZ0QPNDS2IOAXE4FCLUM6THYVR813579J', 'alphabetMode': BifidAlphabetMode.JToI, 'expectedOutput' : 'ROLFZISA7CNYYLZNGWFGTFDZNID7HHMYAYCSWD'},
    ];
  ...
  group("Bifid.decryptBifid:", () {
    List<Map<String, dynamic>> _inputsToExpected = [
      ...
      {'expectedOutput' : 'THEQUICKBROWNFOXJUMPSOVERALAZYDOGSBACK', 'key': '123456', 'mode': PolybiosMode.ZA90, 'alphabet': null, 'alphabetMode': BifidAlphabetMode.JToI, 'input' : 'TCTBCPMPJOUSMG2CJABH2OQLQLRUDCW44GUAGQ'},
      {'expectedOutput' : 'THEQUICKBROWNFOXJUMPSOVERALAZYDOGSBACK', 'key': '123456', 'mode': PolybiosMode.CUSTOM, 'alphabet': 'BGWKZ0QPNDS2IOAXE4FCLUM6THYVR813579J', 'alphabetMode': BifidAlphabetMode.JToI, 'input' : 'ROLFZISA7CNYYLZNGWFGTFDZNID7HHMYAYCSWD'},
