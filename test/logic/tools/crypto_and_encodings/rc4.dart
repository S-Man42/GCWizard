...
void main() {
  group("rc4.useRC4:", () {
    List<Map<String, dynamic>> _inputsToExpected = [
      ...
      {'input' : 'ABCDE', 'format' : InputFormat.AUTO, 'key' : 'FEDCBA', "keyFormat" : InputFormat.AUTO, 'expectedOutput' : 'ã-gàÏ', 'outputFormat' : OutputFormat.TEXT, 'errorCode' : ErrorCode.OK},

      {'input' : 'ABCDEF', 'format' : InputFormat.AUTO, 'key' : 'FEDCBA', "keyFormat" : InputFormat.AUTO, 'expectedOutput' : 'E3 2D 67 E0 CF FA', 'outputFormat' : OutputFormat.HEX, 'errorCode' : ErrorCode.OK},
      {'input' : 'ABCDEF', 'format' : InputFormat.AUTO, 'key' : 'FE', "keyFormat" : InputFormat.AUTO, 'expectedOutput' : '72 55 5C DD 7D 1E', 'outputFormat' : OutputFormat.HEX, 'errorCode' : ErrorCode.OK},
      {'input' : 'ABCDEF', 'format' : InputFormat.AUTO, 'key' : 'FE', "keyFormat" : InputFormat.AUTO, 'expectedOutput' : 'rU\\Ý}\x1E', 'outputFormat' : OutputFormat.TEXT, 'errorCode' : ErrorCode.OK},
    ...
    _inputsToExpected.forEach((elem) {
      test('input: ${elem['input']}', () {
        var _actual = useRC4(elem['input'], elem['format'], elem['key'], elem['keyFormat'], elem['outputFormat']);
