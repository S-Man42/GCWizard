...
void main() {
  ...
  group("Polybios.encryptPolybios:", () {
    List<Map<String, dynamic>> _inputsToExpected = [
      ...
      {'input' : 'AB CD.12 23 AB', 'key': 'ABCDE', 'mode': PolybiosMode.CUSTOM, 'alphabet': 'QWERTZUIOPA', 'expectedOutput' : 'CA CB CC CD CA CB'},
      {'input' : 'AB CD.12 23 AB', 'key': 'ABCDE', 'mode': PolybiosMode.CUSTOM, 'alphabet': 'AAAAAAAAAAAAAAAAAAAAAAAAA', 'expectedOutput' : 'AA AB AC AD AA AB'},
    ];
  ...
  group("Polybios.decryptPolybios:", () {
    List<Map<String, dynamic>> _inputsToExpected = [
      ...
      {'input' : 'AA AB AC AD AA AB', 'key': 'ABCDE', 'mode': PolybiosMode.CUSTOM, 'alphabet': 'AAAAAAAAAAAAAAAAAAAAAAAAA', 'expectedOutput' : 'ABCDAB'},
      {'input' : 'CA CB CC CD CA CB', 'key': 'ABCDE', 'mode': PolybiosMode.CUSTOM, 'alphabet': 'QWERTZUIOPA', 'expectedOutput' : 'ABCDAB'},
    ];
