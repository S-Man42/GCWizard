    ...
    _inputsToExpected
      ...
      .forEach((elem) {
        test('text: ${elem['text']}', () {
          ...
          expect((_actual.values.elementAt(0).toLatLng().latitude - elem['expectedOutput']['coordinate'].latitude).abs() < 1e-8, true);
          expect((_actual.values.elementAt(0).toLatLng().longitude - elem['expectedOutput']['coordinate'].longitude).abs() < 1e-8, true);
        });
      });
  });
