...
void main() {
  ...
  group("Resection.resection:", () {
    List<Map<String, Object?>> _inputsToExpected = [
      {'coord1': const LatLng(-41.129287, 70.378051), 'angle12': 67.9, 'coord2': const LatLng(-39.905793, 79.628539), 'angle23': 57.0, 'coord3': const LatLng(-45.182285, 84.698730),
        'expectedOutput': [
          const LatLng(-45.915268, 75.165365),
          const LatLng(45.611249, -105.280707)
        ]},
      {'coord1': const LatLng(49.6647, 10.7999), 'angle12': 28.5, 'coord2': const LatLng(49.6713, 10.8051), 'angle23': 22.5, 'coord3': const LatLng(49.6739, 10.8132),
        'expectedOutput': [
          const LatLng(49.660435, 10.821665),
          const LatLng(49.678865, 10.792505),
          const LatLng(-49.445364, -169.194801),
          const LatLng(-49.657084, -168.78753),
          const LatLng(-49.678912, -168.817342),
          const LatLng(-49.889824, -169.195246),
          const LatLng(-49.660435, -169.568451),
          const LatLng(-49.680072, -169.599516)
        ]
      },
      {'coord1': const LatLng(53.963431, 16.264892), 'angle12': 141.0, 'coord2': const LatLng(49.838948, 16.539551), 'angle23': 126.4, 'coord3': const LatLng(52.242173, 19.989258),
        'expectedOutput': [
          const LatLng(51.808181, 17.591589)
        ]},
      ...
      {'coord1': const LatLng(84.898956, 102.341728), 'angle12': 55.5, 'coord2': const LatLng(79.532344 ,-143.927803), 'angle23': 31.8, 'coord3': const LatLng(83.361472, -83.213752),
        'expectedOutput': [
          const LatLng(84.325817, 22.219325),
          const LatLng(-84.321398, -157.797258),
        ]},
      {'coord1': const LatLng(0.844036, 174.949591), 'angle12': 52.5, 'coord2': const LatLng(38.641149, -12.850702), 'angle23': 150.1, 'coord3': const LatLng(-11.277231, -178.876092),
        'expectedOutput': [
          const LatLng(-7.221408, -179.696681),
          const LatLng(5.292156, -0.384757)
        ]},
    ];

    for (var elem in _inputsToExpected) {
      test('coord1: ${elem['coord1']}, angle12: ${elem['angle12']}, coord2: ${elem['coord2']}, angle23: ${elem['angle23']}, coord3: ${elem['coord3']}', () {
        var actual = resection(elem['coord1'] as LatLng, elem['angle12'] as double, elem['coord2'] as LatLng, elem['angle23'] as double, elem['coord3'] as LatLng, Ellipsoid.WGS84);
