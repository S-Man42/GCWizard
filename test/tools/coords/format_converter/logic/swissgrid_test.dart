...
void main() {
  group("Parser.swissgrid.parseLatLon:", () {
    List<Map<String, Object?>> _inputsToExpected = [
      ...
      {'text': 'Y:1989048.7411670878 X:278659.94052181806', 'expectedOutput': {'format': CoordFormatKey.SWISS_GRID, 'coordinate': LatLng(46.2110174566, 025.598495717)}},
      {'text': 'Y:1989048.7411670878X:278659.94052181806', 'expectedOutput': {'format': CoordFormatKey.SWISS_GRID, 'coordinate': LatLng(46.2110174566, 025.598495717)}},
      {'text': 'Y1989048.7411670878X278659.94052181806', 'expectedOutput': {'format': CoordFormatKey.SWISS_GRID, 'coordinate': LatLng(46.2110174566, 025.598495717)}},
      {'text': 'y1989048.7411670878x278659.94052181806', 'expectedOutput': {'format': CoordFormatKey.SWISS_GRID, 'coordinate': LatLng(46.2110174566, 025.598495717)}},
    ];
  ...
  group("Parser.swissgrid_plus.parseLatLon:", () {
    List<Map<String, Object?>> _inputsToExpected = [
      ...
      {'text': 'Y:3989048.741167088 X:1278659.9405218181', 'expectedOutput': {'format': CoordFormatKey.SWISS_GRID, 'coordinate': LatLng(46.2110174566, 025.598495717)}},
      {'text': 'Y:3989048.741167088X:1278659.9405218181', 'expectedOutput': {'format': CoordFormatKey.SWISS_GRID, 'coordinate': LatLng(46.2110174566, 025.598495717)}},
      {'text': 'Y3989048.741167088X1278659.9405218181', 'expectedOutput': {'format': CoordFormatKey.SWISS_GRID, 'coordinate': LatLng(46.2110174566, 025.598495717)}},
      {'text': 'y3989048.741167088x1278659.9405218181', 'expectedOutput': {'format': CoordFormatKey.SWISS_GRID, 'coordinate': LatLng(46.2110174566, 025.598495717)}},
    ];
