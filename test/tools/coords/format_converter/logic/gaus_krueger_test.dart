...
void main() {
  group("Converter.gauss_krueger.parseLatLon:", () {
    List<Map<String, dynamic>> _inputsToExpected = [
      ...
      {'text': '9392110.611090261, 5120027.146589669', 'expectedOutput': {'format': CoordFormatKey.GAUSS_KRUEGER, 'coordinate': LatLng(46.211024251, 025.5985061856)}},
      {'text': '9392110.611090261 5120027.146589669', 'expectedOutput': {'format': CoordFormatKey.GAUSS_KRUEGER, 'coordinate': LatLng(46.211024251, 025.5985061856)}},
      {'text': 'R: 9392110.611090261\nH: 5120027.146589669', 'expectedOutput': {'format': CoordFormatKey.GAUSS_KRUEGER, 'coordinate': LatLng(46.211024251, 025.5985061856)}},
      {'text': 'r: 9392110.611090261\nh: 5120027.146589669', 'expectedOutput': {'format': CoordFormatKey.GAUSS_KRUEGER, 'coordinate': LatLng(46.211024251, 025.5985061856)}},
      {'text': 'R:9392110.611090261\nH:5120027.146589669', 'expectedOutput': {'format': CoordFormatKey.GAUSS_KRUEGER, 'coordinate': LatLng(46.211024251, 025.5985061856)}},
      {'text': 'R 9392110.611090261\nH 5120027.146589669', 'expectedOutput': {'format': CoordFormatKey.GAUSS_KRUEGER, 'coordinate': LatLng(46.211024251, 025.5985061856)}},
      {'text': 'R9392110.611090261\nH5120027.146589669', 'expectedOutput': {'format': CoordFormatKey.GAUSS_KRUEGER, 'coordinate': LatLng(46.211024251, 025.5985061856)}},
    ];
