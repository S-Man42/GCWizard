...
void main() {
  ...
  group("encrypt", () {
    ...
    _inputsToExpected.forEach((elem) {
      test('input: ${elem['input']}, key: ${elem['key']}, alphabetWord: ${elem['alphabetWord']}, columnOrder: ${elem['columnOrder']}, matrix4x10: ${elem['matrix4x10']}, mode: ${elem['mode']}, alphabet: ${elem['alphabet']}', () {
        StraddlingCheckerboardOutput _actual = encryptStraddlingCheckerboard(elem['input'] as String?, elem['key'], elem['alphabetWord'], elem['columnOrder'], elem['matrix4x10'], mode: elem['mode'], alphabet: elem['alphabet'] as String);
  ...
  group("decrypt", () {
    ...
    _inputsToExpected.forEach((elem) {
      test('input: ${elem['input']}, key: ${elem['key']}, alphabetWord: ${elem['alphabetWord']}, columnOrder: ${elem['columnOrder']}, matrix4x10: ${elem['matrix4x10']}, mode: ${elem['mode']}, alphabet: ${elem['alphabet']}', () {
        StraddlingCheckerboardOutput _actual = decryptStraddlingCheckerboard(elem['input'] as String?, elem['key'], elem['alphabetWord'], elem['columnOrder'], elem['matrix4x10'], mode: elem['mode'], alphabet: elem['alphabet'] as String);
        expect(_actual.output, elem['expectedOutput']);
      });
    });
  });
