...
void main() {
  group("Transposition.createTranspositionMatrix:", () {
    ...
    _inputsToExpected.forEach((elem) {
      test('input: ${elem['input']}, fillMode: ${elem['fillMode']}, countColumns: ${elem['countColumns']}, countRows: ${elem['countRows']}, countLettersPerCell: ${elem['countLettersPerCell']}', () {
        var _actual = createTranspositionMatrix(elem['input'] as String?, elem['fillMode'], countRows: elem['countRows'], countColumns: elem['countColumns'], countLettersPerCell: elem['countLettersPerCell']);
  ...
  group("Transposition.encryptTransposition:", () {
    ...
    _inputsToExpected.forEach((elem) {
      test('input: ${elem['input']}, countRows: ${elem['countRows']}, countColumns: ${elem['countColumns']}, countLettersPerCell: ${elem['countLettersPerCell']}', () {
        var _actual = encryptTransposition(elem['input'] as String?, countRows: elem['countRows'], countColumns: elem['countColumns'], countLettersPerCell: elem['countLettersPerCell']);
        expect(_actual, elem['expectedOutput']);
      });
    });
  });
  ...
  group("Transposition.decryptTransposition:", () {
    ...
    _inputsToExpected.forEach((elem) {
      test('input: ${elem['input']}, countRows: ${elem['countRows']}, countColumns: ${elem['countColumns']}, countLettersPerCell: ${elem['countLettersPerCell']}', () {
        var _actual = decryptTransposition(elem['input'] as String?, countRows: elem['countRows'], countColumns: elem['countColumns'], countLettersPerCell: elem['countLettersPerCell']);
        expect(_actual, elem['expectedOutput']);
      });
    });
  });
