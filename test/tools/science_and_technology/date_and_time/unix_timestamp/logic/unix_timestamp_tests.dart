...
void main() {
  ...
  group("UnixTimeStampToDate:", () {
    List<Map<String, Object?>> _inputsToExpected = [
      {'expectedOutput' : DateTime(2023, 6, 22, 19, 40, 31).toString(), 'UnixTimeSTamp' : 1687455631},
      {'expectedOutput' : DateTime(1994, 2, 11, 0, 0, 0).toString(), 'UnixTimeSTamp' : 760924800},
      {'expectedOutput' : DateTime(1970, 1, 1, 0, 0, 0).toString(), 'UnixTimeSTamp' : 0},
    ];
