...
List<Map<String, Object?>> _inputsMathToExpected = [
  ...
  //
  // {'code' : 'print SQR(0)', 'expectedOutput' : '0.0'},
  // {'code' : 'print SQR(1)', 'expectedOutput' : '1.0'},
  // {'code' : 'print SQR(2)', 'expectedOutput' : '4.0'},
  // {'code' : 'print SQR(-2)', 'expectedOutput' : '4.0'},
  ...
  // {'code' : 'print SQR( )', 'expectedOutput' : '0.0', 'error': 'gcwizard_script_casting_error'},
  // {'code' : 'print SQR(X)', 'expectedOutput' : '0.0', 'error': 'gcwizard_script_casting_error'},
  //
  ...
  {'code' : 'print POW(12, 3)', 'expectedOutput' : '1728.0'},
  {'code' : 'print POW(12.6, 3)', 'expectedOutput' : '2000.3759999999997'},
  {'code' : 'print POW(11, 3)', 'expectedOutput' : '1331.0'},
  {'code' : 'print POW(3, 11)', 'expectedOutput' : '177147.0'},
  {'code' : 'print POW(12.0, 3)', 'expectedOutput' : '1728.0'},
  {'code' : 'print POW(12.0, 3.0)', 'expectedOutput' : '1728.0'},
  {'code' : 'print POW(0, 3)', 'expectedOutput' : '0.0'},
  {'code' : 'print POW(12, 0)', 'expectedOutput' : '1.0'},
  ...
  {'input' : 'print CONVERT(42.42, 10, 2)', 'expectedOutput' : '101010.01101011100001010001111010111000010100011110101110'},
  {'input' : 'print CONVERT(42.42, 10, 3)', 'expectedOutput' : '1120.10210001121201222110102100011212012200021021220011'},
  {'input' : 'print CONVERT(42.42, 10, 4)', 'expectedOutput' : '222.122320110132232011013223201'},
  {'input' : 'print CONVERT(42.42, 10, 5)', 'expectedOutput' : '132.20222222222222222222222323441102400343013402001133'},
  {'input' : 'print CONVERT(42.42, 10, 6)', 'expectedOutput' : '110.23041530415304153041533020313211140055225054411010'},
  {'input' : 'print CONVERT(42.42, 10, 7)', 'expectedOutput' : '60.26402640264026402640351514150053441365564663223526'},
  {'input' : 'print CONVERT(42.42, 10, 8)', 'expectedOutput' : '52.327024365605075341'},
  {'input' : 'print CONVERT(42.42, 10, 9)', 'expectedOutput' : '46.37015518733701551465724800440338241104884421633301'},
  {'input' : 'print CONVERT(42.42, 10, 10)', 'expectedOutput' : '42.42'},
