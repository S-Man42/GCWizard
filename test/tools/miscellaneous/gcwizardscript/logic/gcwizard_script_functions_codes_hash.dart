...
List<Map<String, Object?>> _inputsHashToExpected = [
  {'code' : 'print HASH(2, 0, 0, "testkey", "test")', 'expectedOutput' : '', 'error': 'gcwizard_script_syntax_error'},
  {'code' : 'print HASH(2.0, 0, 0, "testkey", "test")', 'expectedOutput' : '', 'error': 'gcwizard_script_syntax_error'},
  {'code' : 'print HASH("MD2", "0", 0, "testkey", "test")', 'expectedOutput' : '', 'error': 'gcwizard_script_syntax_error'},
  {'code' : 'print HASH("MD2", 0, "0", "testkey", "test")', 'expectedOutput' : '', 'error': 'gcwizard_script_syntax_error'},
  {'code' : 'print HASH("MD2", 0, "0", 0, "test")', 'expectedOutput' : '', 'error': 'gcwizard_script_syntax_error'},
  {'code' : 'print HASH("MD2", 0, 0, 0, "test")', 'expectedOutput' : '', 'error': 'gcwizard_script_syntax_error'},
  {'code' : 'print HASH("MD2", 0, 0, "testkey", "test", 0)', 'expectedOutput' : 'dd34716876364a02d0195e2fb9ae2d1b', 'error': 'gcwizard_script_unbalanced_parentheses'},
  {'code' : 'print HASH("MD2", 0, 0, "testkey")', 'expectedOutput' : '', 'error': 'gcwizard_script_unbalanced_parentheses'},
  ...
  {'code' : 'print HASH("SHA", 0, 1, "test", "testkey")', 'expectedOutput' : '', 'error': 'gcwizard_script_syntax_error'},
  {'code' : 'print HASH("SHA", 0, 0, "test", "testkey")', 'expectedOutput' : '', 'error': 'gcwizard_script_syntax_error'},
  ...
  {'code' : 'print HASH("SHA3", 0, 1, "test", "testkey")', 'expectedOutput' : '', 'error': 'gcwizard_script_syntax_error'},
  {'code' : 'print HASH("SHA3", 0, 0, "test", "testkey")', 'expectedOutput' : '', 'error': 'gcwizard_script_syntax_error'},
  ...
  {'code' : 'print HASH("BLAKE2B", 0, 1, "test", "testkey")', 'expectedOutput' : '', 'error': 'gcwizard_script_syntax_error'},
  {'code' : 'print HASH("BLAKE2B", 0, 0, "test", "testkey")', 'expectedOutput' : '', 'error': 'gcwizard_script_syntax_error'},
  ...
  {'code' : 'print HASH("KECCAK", 0, 1, "test", "testkey")', 'expectedOutput' : '', 'error': 'gcwizard_script_syntax_error'},
  {'code' : 'print HASH("KECCAK", 0, 0, "test", "testkey")', 'expectedOutput' : '', 'error': 'gcwizard_script_syntax_error'},
  ...
  {'code' : 'print HASH("RIPEMD", 0, 1, "test", "testkey")', 'expectedOutput' : '', 'error': 'gcwizard_script_syntax_error'},
  {'code' : 'print HASH("RIPEMD", 0, 0, "test", "testkey")', 'expectedOutput' : '', 'error': 'gcwizard_script_syntax_error'},
