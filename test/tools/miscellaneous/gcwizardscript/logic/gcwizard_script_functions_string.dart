...
List<Map<String, Object?>> _inputsStringToExpected = [
  ...
  {'code' : 'print ASC(10)', 'expectedOutput' : '-1', 'error': 'gcwizard_script_casting_error'},
  {'code' : 'print ASC("A")', 'expectedOutput' : '65'},
  {'code' : 'print ASC(A)', 'expectedOutput' : '-1', 'error': 'gcwizard_script_casting_error'},
  ...
  {'code' : 'print MID(10)', 'expectedOutput' : '', 'error': 'gcwizard_script_unbalanced_parentheses'},
  {'code' : 'print MID(10, 5)', 'expectedOutput' : '', 'error': 'gcwizard_script_unbalanced_parentheses'},
