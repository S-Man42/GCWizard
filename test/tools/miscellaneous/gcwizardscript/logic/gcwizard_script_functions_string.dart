...
List<Map<String, Object?>> _inputsStringToExpected = [
  ...
  {'code' : 'print PADLEFT("PADTEST-L", "-", 12)', 'expectedOutput' : '---PADTEST-L'},
  {'code' : 'print PADRIGHT("PADTEST-R", "-", 12)', 'expectedOutput' : 'PADTEST-R---'},
  {'code' : 'print PADCENTER("PADTEST-C", "-", 12)', 'expectedOutput' : '--PADTEST-C-'},
