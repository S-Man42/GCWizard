...
void main() {
  ...
  group("formula_painter.paintFormula:", () {
    ...
    List<Map<String, Object?>> _inputsToExpected = [
     ...
     //  {'formula' : 'bww(xyz,xyz,xyz)', 'expectedOutput' : 'bbbbgggggggggggb'},
     //  {'formula' : 'bww(xyz)', 'expectedOutput' : 'bbbbgggb'},
     ...
     //
     //
     // {'formula' : '\'\'', 'values': <String, String>{}, 'expectedOutput' : 'gg'},
     // {'formula' : '""', 'values': <String, String>{}, 'expectedOutput' : 'gg'},
     // {'formula' : '"\'"', 'values': <String, String>{}, 'expectedOutput' : 'ggg'},
     // {'formula' : '\'"\'', 'values': <String, String>{}, 'expectedOutput' : 'ggg'},
     // {'formula' : '"\'', 'values': <String, String>{}, 'expectedOutput' : 'RR'},
     // {'formula' : '\'"', 'values': <String, String>{}, 'expectedOutput' : 'RR'},
     //
     // {'formula' : 'ABCD', 'values': <String, String>{}, 'expectedOutput' : 'RRRR'},
     // {'formula' : '\'ABCD\'', 'values': <String, String>{}, 'expectedOutput' : 'gggggg'},
     // {'formula' : '"ABCD"', 'values': <String, String>{}, 'expectedOutput' : 'gggggg'},
     // {'formula' : '"ABCD\'"', 'values': <String, String>{}, 'expectedOutput' : 'ggggggg'},
     // {'formula' : '\'ABCD"\'', 'values': <String, String>{}, 'expectedOutput' : 'ggggggg'},
     // {'formula' : '\'ABCD"', 'values': <String, String>{}, 'expectedOutput' : 'RRRRRR'},
     // {'formula' : '"ABCD\'', 'values': <String, String>{}, 'expectedOutput' : 'RRRRRR'},
     //
     // {'formula' : 'bww(\'\')', 'values': <String, String>{}, 'expectedOutput' : 'bbbbggb'},
     // {'formula' : 'bww("")', 'values': <String, String>{}, 'expectedOutput' : 'bbbbggb'},
     // {'formula' : 'bww(ABCD)', 'values': <String, String>{}, 'expectedOutput' : 'bbbbggggb'},
     // {'formula' : 'bww(\'ABCD\')', 'values': <String, String>{}, 'expectedOutput' : 'bbbbggggggb'},
     // {'formula' : 'bww("ABCD")', 'values': <String, String>{}, 'expectedOutput' : 'bbbbggggggb'},
     // {'formula' : 'bww("ABCD\'")', 'values': <String, String>{}, 'expectedOutput' : 'bbbbgggggggb'},
     // {'formula' : 'bww(\'ABCD"\')', 'values': <String, String>{}, 'expectedOutput' : 'bbbbgggggggb'},
     // {'formula' : 'bww(\'ABCD")', 'values': <String, String>{}, 'expectedOutput' : 'bbbbGGGGGGb'},
     // {'formula' : 'bww("ABCD\')', 'values': <String, String>{}, 'expectedOutput' : 'bbbbGGGGGGb'},
     //
     // {'formula' : 'bww(AB,CD)', 'values': <String, String>{}, 'expectedOutput' : 'xx'},
     // {'formula' : 'bww("AB",\'CD\')', 'values': <String, String>{}, 'expectedOutput' : 'bbbbgggggggggb'},
     // {'formula' : 'bww("AB, CD")', 'values': <String, String>{}, 'expectedOutput' : 'bbbbggggggggb'},
     {'formula' : 'bww("AB, CD)', 'values': <String, String>{}, 'expectedOutput' : 'bbbbGGGggRRb'},
     {'formula' : 'bww("AB, \'CD\')', 'values': <String, String>{}, 'expectedOutput' : 'bbbbGGGggggggb'},
